...
directory listings etc. SFtp class is derived from [^topic`:`/`/Core`/SSH`/src`/Upp`_Ssh`_Base`_ru`-ru`#Upp`:`:Ssh`:`:class^ S
sh] base class, and has pick semantics. See also [^topic`:`/`/Core`/SSH`/src`/Upp`_Ssh`_SFtp`_ru`-ru`#Upp`:`:SFtp`:`:DirEntry`:`:class^ S
Ftp`::DirEntry], [^topic`:`/`/Core`/SSH`/src`/Upp`_Ssh`_SFtp`_ru`-ru`#Upp`:`:SFtpFileSystemInfo`:`:class^ S
FtpFileSystemInfo], and [^topic`:`/`/Core`/SSH`/src`/Upp`_Ssh`_SFtpStream`_ru`-ru`#Upp`:`:SFtpStream`:`:class^ S
FtpStream]  classes.&]
[s0;#l288; &]
[s3;%- &]
...
See[^topic`:`/`/Core`/SSH`/src`/Upp`_Ssh`_SFtp`_ru`-ru`#Upp`:`:SFtpFileSystemInfo`:`:class^  
SFtpFileSystemInfo].&]
[s3;%- &]
[s4;%- &]
