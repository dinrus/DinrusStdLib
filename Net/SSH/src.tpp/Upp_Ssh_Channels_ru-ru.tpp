...
types.&]
[s2;  &]
[s2;i150;O9; -|[^topic`:`/`/Core`/SSH`/src`/Upp`_Ssh`_Channels`_ru`-ru`#Upp`:`:Scp`:`:class^ 1
. Secure data copy channel.]&]
[s2;i150;O9; -|[^topic`:`/`/Core`/SSH`/src`/Upp`_Ssh`_Channels`_ru`-ru`#Upp`:`:SshExec`:`:class^ 2
. Remote command execution channel.]&]
[s2;i150;O9; -|[^topic`:`/`/Core`/SSH`/src`/Upp`_Ssh`_Channels`_ru`-ru`#Upp`:`:SshTunnel`:`:class^ 3
. TCP`-IP and port forwarding (network proxy) channel.]&]
[s2;i150;O9; -|[^topic`:`/`/Core`/SSH`/src`/Upp`_Ssh`_Channels`_ru`-ru`#Upp`:`:SshShell`:`:class^ 4
. Real`-time, interactive remote shell (command line interface) 
channel.]&]
[s2;i150;O9; -|[^topic`:`/`/Core`/SSH`/src`/Upp`_Ssh`_Channels`_ru`-ru`#Upp`:`:SshShell`:`:class^ 5
...
line interface, you should consider using [^topic`:`/`/Core`/SSH`/src`/Upp`_Ssh`_Channels`_ru`-ru`#Upp`:`:SshShell`:`:class^ S
...
you should consider using [^topic`:`/`/Core`/SSH`/src`/Upp`_Ssh`_Channels`_ru`-ru`#Upp`:`:SshExec`:`:class^ S
...
with [^topic`:`/`/Core`/SSH`/src`/Upp`_Ssh`_Session`_ru`-ru`#Upp`:`:SshSession`:`:WhenX11^ S
