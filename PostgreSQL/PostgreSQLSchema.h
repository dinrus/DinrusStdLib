#define INT(x)                     COLUMN("integer", i32, x, 0, 0)
#define INT_ARRAY(x, items)        COLUMN_ARRAY("integer", i32, x, 0, 0, items)
#define INT_(x)                    COLUMN_("integer", i32, x, 0, 0)
#define INT_ARRAY_(x, items)       COLUMN_ARRAY_("integer", i32, x, 0, 0, items)

#define INT64(x)                   COLUMN("bigint", z64, x, 0, 0)
#define INT64_ARRAY(x, items)      COLUMN_ARRAY("bigint", z64, x, 0, 0, items)
#define INT64_(x)                  COLUMN_("bigint", z64, x, 0, 0)
#define INT64_ARRAY_(x, items)     COLUMN_ARRAY_("bigint", z64, x, 0, 0, items)

#define SERIAL(x)                  COLUMN("serial", z64, x, 0, 0) //i32 is not enough, as it is unsigned..
#define SERIAL_ARRAY(x, items)     COLUMN_ARRAY("serial", z64, x, 0, 0, items)
#define SERIAL_(x)                 COLUMN_("serial", z64, x, 0, 0)
#define SERIAL_ARRAY_(x, items)    COLUMN_ARRAY_("serial", z64, x, 0, 0, items)

#define ISERIAL(x)                 COLUMN("serial", i32, x, 0, 0) //..but we like to choose
#define ISERIAL_ARRAY(x, items)    COLUMN_ARRAY("serial", i32, x, 0, 0, items)
#define ISERIAL_(x)                COLUMN_("serial", i32, x, 0, 0)
#define ISERIAL_ARRAY_(x, items)   COLUMN_ARRAY_("serial", i32, x, 0, 0, items)

#define BIGSERIAL(x)               COLUMN("bigserial", z64, x, 0, 0)
#define BIGSERIAL_ARRAY(x, items)  COLUMN_ARRAY("bigserial", z64, x, 0, 0, items)
#define BIGSERIAL_(x)              COLUMN_("bigserial", z64, x, 0, 0)
#define BIGSERIAL_ARRAY_(x, items) COLUMN_ARRAY_("bigserial", z64, x, 0, 0, items)
...
#define TXT(x, n)               COLUMN("varchar(" #n ")", Txt, x, n, 0)
#define TXT_ARRAY(x, n, items)  COLUMN_ARRAY("varchar(" #n ")", Txt, x, n, 0, items)
#define TXT_(x, n)              COLUMN_("varchar(" #n ")", Txt, x, n, 0)
#define TXT_ARRAY_(x, n, items) COLUMN_ARRAY_("varchar(" #n ")", Txt, x, n, 0, items)
...
#define LONG(x)                    COLUMN("text", Txt, x, 0, 0)
#define LONG_(x)                   COLUMN_("text", Txt, x, 0, 0)

#define LONGRAW(x)                 COLUMN("bytea", Txt, x, 0, 0)
#define LONGRAW_(x)                COLUMN_("bytea", Txt, x, 0, 0)

#define BLOB(x)                    COLUMN("bytea", Txt, x, INT_MAX/2, 0)
#define BLOB_(x)                   COLUMN_("bytea", Txt, x, INT_MAX/2, 0)

#define CLOB(x)                    COLUMN("text", Txt, x, INT_MAX/2, 0)
#define CLOB_(x)                   COLUMN_("text", Txt, x, INT_MAX/2, 0)
