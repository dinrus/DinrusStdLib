#define BOOL(x)                    COLUMN("bool", i32, x, 0, 0)
#define BOOL_ARRAY(x, items)       COLUMN_ARRAY("bool", i32, x, 0, 0, items)
#define BOOL_(x)                   COLUMN_("bool", i32, x, 0, 0)
#define BOOL_ARRAY_(x, items)      COLUMN_ARRAY_("bool", i32, x, 0, 0, items)
...
#define TXT(x, n)               COLUMN(MySqlTextType(n), Txt, x, n, 0)
#define TXT_ARRAY(x, n, items)  COLUMN_ARRAY(MySqlTextType(n), Txt, x, n, 0, items)
#define TXT_(x, n)              COLUMN_(MySqlTextType(n), Txt, x, n, 0)
#define TXT_ARRAY_(x, n, items) COLUMN_ARRAY_(MySqlTextType(n), Txt, x, n, 0, items)

#define BLOB(x)                    COLUMN("longblob", Txt, x, INT_MAX/2, 0)
#define BLOB_(x)                   COLUMN_("longblob", Txt, x, INT_MAX/2, 0)
