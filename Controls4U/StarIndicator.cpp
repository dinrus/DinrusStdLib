 ...
 **********************************************************************************************/
	...
	if (m_bMouseInside || m_bAlwaysShowVal) {
		...
		i32 px = (sz.cx - psz.cx) / 2;
		i32 py = (sz.cy - psz.cy) / 2;
...
StarIndicator&	StarIndicator::SetVotes(i32 n)
/***********************************************************************************************
