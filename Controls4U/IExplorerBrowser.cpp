...
bool InternetExplorerBrowser::Browse(const Txt &strurl) {
...
bool InternetExplorerBrowser::ShowHTML(const Txt &html) {
	IIWebBrowser webBrowser(this);
	if (!webBrowser)
		return false;
...
Txt InternetExplorerBrowser::GetLocation() {
	IIWebBrowser webBrowser(this);
	if (!webBrowser)
		return "";
	...
	return pbstrLocationURL.ToTxt();
}

Txt InternetExplorerBrowser::GetTitle() {
	IIWebBrowser webBrowser(this);
	if (!webBrowser)
		return "";
...
Txt InternetExplorerBrowser::GetReadyState() {
	IIWebBrowser webBrowser(this);
	if (!webBrowser)
		return "";
