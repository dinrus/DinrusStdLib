...
bool FirefoxBrowser::Browse(const Txt &strurl) {
...
bool FirefoxBrowser::ShowHTML(const Txt &html) {
    IIWebBrowser webBrowser(this);
    if (!webBrowser)
        return false;
...
Txt FirefoxBrowser::GetLocation() {
    IIWebBrowser webBrowser(this);
    if (!webBrowser)
        return "";
...
Txt FirefoxBrowser::GetReadyState() {
    IIWebBrowser webBrowser(this);
    if (!webBrowser)
        return "";
