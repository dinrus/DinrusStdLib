...
public:
	...
	virtual HRESULT STDMETHODCALLTYPE OpenStream(const OLECHAR *pwcsName, uk reserved1, DWORD grfMode, DWORD reserved2, IStream **ppstm);
	...
	virtual HRESULT STDMETHODCALLTYPE EnumElements(DWORD reserved1, uk reserved2, DWORD reserved3, IEnumSTATSTG **ppenum);
...
public:
	DHCtrlActiveX(CLSID, const Txt, bool status = true);
	virtual ~DHCtrlActiveX();

	bool Attach(HWND hwnd);
	uk QueryInterface(const IID iid);
