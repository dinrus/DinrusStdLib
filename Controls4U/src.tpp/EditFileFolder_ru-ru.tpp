...
&]
[s0; &]
[s9; EditFileFolder `- поле для ввода пути к папке. 
Он используется косвенно подклассами 
[^topic`:`/`/Controls4U`/src`/EditFile`_ru`-ru`#EditFile`:`:class^ EditFile] 
и [^topic`:`/`/Controls4U`/src`/EditFolder`_ru`-ru`#EditFolder`:`:class^ EditFolde
r].&]
[s3; &]
[s3; &]
...
[s2; Инициализует EditFileFolder.&]
[s3; &]
[s0;%- &]
[ {{10000F(128)G(128)@1 [s0; [* Список Публичных Членов]]}}&]
[s4;%- &]
[s0;:Init`(`):%- [@(0.0.255) void]_[* Init]()&]
[s2; Инициализует данные EditFileFolde. Вызывается 
конструктором.&]
[s3;%- &]
[s3;%- &]
[s4;%- &]
[s5;:ClearTypes`(`):%- [@(0.0.255) void]_[* ClearTypes]()&]
[s2; Удаляет все типы файлов из FileSel.&]
[s3;%- &]
[s4;%- &]
[s0;:Type`(const char`*`,const char`*`):%- void_[* Type](const_char_`*[*@3 name], 
const_char_`*[*@3 ext])&]
[s2; Добавляет тип файла, отображаемый 
как [%-*@3 name]. [%-*@3 ext] содержит набор файловых 
масок, разделённых пробелами. Например: 
Type(`"Исходники`", `"`*.c `*.h`").&]
[s3; &]
[s4;%- &]
[s5;:ActiveType`(int`):%- [@(0.0.255) void]_[* ActiveType]([@(0.0.255) int]_[*@3 type])&]
[s2; Устанавливает активный тип файла 
[%-*@3 type] .&]
[s3; &]
[s4;%- &]
[s5;:AllFilesType`(`):%- [@(0.0.255) void]_[* AllFilesType]()&]
[s2; То же, что и Type(`"All files`", `"`*.`*`").&]
[s3;%- &]
[s4;%- &]
[s5;:ActiveDir`(const Upp`:`:String`&`):%- [@(0.0.255) void]_[* ActiveDir]([@(0.0.255) cons
t]_[_^String^ String][@(0.0.255) `&]_[*@3 d])&]
[s2; Устанавливает активную директорию 
файлвыборки (жиректория, в которой 
открывается файлвыборка).&]
[s3; &]
[s4;%- &]
[s5;:MkDirOption`(bool`):%- [@(0.0.255) void]_[* MkDirOption]([@(0.0.255) bool]_[*@3 b])&]
[s2; Делает кнопку `"Сделать директорию`" 
видимой. Дефолт равен true.&]
[s3; &]
[s4;%- &]
...
tring][@(0.0.255) `&]_[*@3 s])&]
[s2; Устанавливает путь в поле в [%-*@3 s].&]
[s3; &]
[s4;%- &]
