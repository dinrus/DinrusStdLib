...
EXTERN_C const IID IID_IVLCMessage;
    ...
    {
    public:
        virtual /* [propget][id] */ HRESULT STDMETHODCALLTYPE get__Val(
    ...
    typedef struct IVLCMessageVtbl
    {
        ...
        /* [propget][id] */ HRESULT ( STDMETHODCALLTYPE *get__Val )(
            IVLCMessage * This,
...
#define IVLCMessage_get__Val(This,message)    \
    ( (This)->lpVtbl -> get__Val(This,message) )
