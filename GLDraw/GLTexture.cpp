...
extern i32 sTextureCounter;

void GLTexture::Bind(i32 ii) const
{
	if(data) {
...
void GLBind(i32 ii, const Image& img, dword style)
{
	extern i32 sTextureCounter;
	glActiveTexture(GL_TEXTURE0 + ii);
...
//		#version 330 core
	...
	static i32 ialpha = program["alpha"];
	static i32 itscale = program["tscale"];
	static i32 itoffset = program["toffset"];
