                    ...
                    double width, Color color)
{
	...
	static i32 ioffset = program["offset"];
	static i32 iscale = program["scale"];
	static i32 iscale2 = program["scale2"];
	static i32 iwidth = program["width"];
	static i32 icolor = program["color"];
