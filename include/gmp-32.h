...
#define __GMP_CC "gcc -m32"
#define __GMP_CFLAGS "-mtune=generic -march=i686 -msse2 -g2 -O2 -pipe -fPIC -fno-plt -Wformat -Wformat-security  -fstack-protector-strong --param=ssp-buffer-size=32 -fasynchronous-unwind-tables -ftree-vectorize -feliminate-unused-debug-types -fno-omit-frame-pointer -mno-omit-leaf-frame-pointer -Wall -Wno-error -Wp,-D_REENTRANT"
