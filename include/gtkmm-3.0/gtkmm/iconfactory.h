...
using GtkIconFactory = struct _GtkIconFactory;
using GtkIconFactoryClass = struct _GtkIconFactoryClass;
#endif /* DOXYGEN_SHOULD_SKIP_THIS */


#ifndef DOXYGEN_SHOULD_SKIP_THIS
namespace Gtk
{ class GTKMM_API IconFactory_Class; } // namespace Gtk
#endif //DOXYGEN_SHOULD_SKIP_THIS
...
public:
  ...
  using CppClassType = IconFactory_Class;
