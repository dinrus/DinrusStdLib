...
class GTKMM_API IconSource
{
  public:
#ifndef DOXYGEN_SHOULD_SKIP_THIS
  using CppObjectType = IconSource;
  using BaseObjectType = GtkIconSource;
...
public:
   ...
   * Deprecated: 3.10: Use Gtk::IconTheme instead.
   * 
   * @return Icon size (Gtk::IconSize) this source matches.
   */
...
#ifndef DOXYGEN_SHOULD_SKIP_THIS
template <>
class GTKMM_API Value<Gtk::IconSource> : public Glib::Value_Boxed<Gtk::IconSource>
{};
#endif /* DOXYGEN_SHOULD_SKIP_THIS */
