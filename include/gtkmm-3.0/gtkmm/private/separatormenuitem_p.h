...
class GTKMM_API SeparatorMenuItem_Class : public Glib::Class
{
public:
#ifndef DOXYGEN_SHOULD_SKIP_THIS
  using CppObjectType = SeparatorMenuItem;
  using BaseObjectType = GtkSeparatorMenuItem;
  using BaseClassType = GtkSeparatorMenuItemClass;
