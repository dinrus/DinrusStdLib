...
class GTKMM_API RecentChooserWidget_Class : public Glib::Class
{
public:
#ifndef DOXYGEN_SHOULD_SKIP_THIS
  using CppObjectType = RecentChooserWidget;
  using BaseObjectType = GtkRecentChooserWidget;
  using BaseClassType = GtkRecentChooserWidgetClass;
