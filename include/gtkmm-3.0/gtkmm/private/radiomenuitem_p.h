...
class GTKMM_API RadioMenuItem_Class : public Glib::Class
{
public:
#ifndef DOXYGEN_SHOULD_SKIP_THIS
  using CppObjectType = RadioMenuItem;
  using BaseObjectType = GtkRadioMenuItem;
  using BaseClassType = GtkRadioMenuItemClass;
  using CppClassParent = Gtk::CheckMenuItem_Class;
  using BaseClassParent = GtkCheckMenuItemClass;
