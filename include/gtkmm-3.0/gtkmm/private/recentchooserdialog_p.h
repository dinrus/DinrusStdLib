...
class GTKMM_API RecentChooserDialog_Class : public Glib::Class
{
public:
#ifndef DOXYGEN_SHOULD_SKIP_THIS
  using CppObjectType = RecentChooserDialog;
  using BaseObjectType = GtkRecentChooserDialog;
  using BaseClassType = GtkRecentChooserDialogClass;
