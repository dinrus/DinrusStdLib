...
class GTKMM_API SeparatorToolItem_Class : public Glib::Class
{
public:
#ifndef DOXYGEN_SHOULD_SKIP_THIS
  using CppObjectType = SeparatorToolItem;
  using BaseObjectType = GtkSeparatorToolItem;
  using BaseClassType = GtkSeparatorToolItemClass;
