...
#ifndef DOXYGEN_SHOULD_SKIP_THIS
using GtkToolShell = struct _GtkToolShell;
using GtkToolShellClass = struct _GtkToolShellClass;
#endif /* DOXYGEN_SHOULD_SKIP_THIS */


#ifndef DOXYGEN_SHOULD_SKIP_THIS
namespace Gtk
{ class GTKMM_API ToolShell_Class; } // namespace Gtk
#endif // DOXYGEN_SHOULD_SKIP_THIS
...
public:
  ...
  using CppClassType = ToolShell_Class;
...
public:
   ...
   * @newin{2,14}
   * 
   * @return The current size (Gtk::IconSize) for icons of @a shell.
   */
