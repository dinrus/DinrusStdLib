...
template <>
class GTKMM_API Value<Gtk::PrintOperationResult> : public Glib::Value_Enum<Gtk::PrintOperationResult>
{
public:
  static GType value_type() G_GNUC_CONST;
};
...
template <>
class GTKMM_API Value<Gtk::PrintOperationAction> : public Glib::Value_Enum<Gtk::PrintOperationAction>
{
public:
  static GType value_type() G_GNUC_CONST;
};
...
class GTKMM_API PrintError : public Glib::Error
{
public:
  /**  @var Code GENERAL
