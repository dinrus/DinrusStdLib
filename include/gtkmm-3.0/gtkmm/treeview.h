...
template <>
class GTKMM_API Value<Gtk::TreeViewDropPosition> : public Glib::Value_Enum<Gtk::TreeViewDropPosition>
{
public:
...
template <>
class GTKMM_API Value<Gtk::TreeViewGridLines> : public Glib::Value_Enum<Gtk::TreeViewGridLines>
{
public:
  static GType value_type() G_GNUC_CONST;
};
...
private:
  friend class GTKMM_API TreeView_Class;
