...
template <>
class GTKMM_API Value<Gtk::FileChooserAction> : public Glib::Value_Enum<Gtk::FileChooserAction>
{
public:
...
template <>
class GTKMM_API Value<Gtk::FileChooserConfirmation> : public Glib::Value_Enum<Gtk::FileChooserConfirmation>
{
public:
  static GType value_type() G_GNUC_CONST;
};
 ...
 */
class GTKMM_API FileChooserError : public Glib::Error
{
public:
