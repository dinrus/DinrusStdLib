...
class EXIV2API TiffParser {
  ...
  */
  static ByteOrder decode(ExifData& exifData, IptcData& iptcData, XmpData& xmpData, const u8* pData, size_t size);
  /*!
  ...
  */
  static WriteMethod encode(BasicIo& io, const u8* pData, size_t size, ByteOrder byteOrder, ExifData& exifData,
