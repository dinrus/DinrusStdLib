...
class EXIV2API AsfVideo : public Image {
  ...
  */
   ...
   * array of 8 bytes.
   *
   * @note The u8 order of the GUID structure is in little endian.
   *
  ...
  class GUIDTag {
   ...
   public:
    ...
    GUIDTag(unsigned int data1, unsigned short data2, unsigned short data3, std::array<u8, 8> data4);

    // Constructor to create a GUID object from a u8 array
