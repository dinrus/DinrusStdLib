...
#      define KPACKAGE_EXPORT __declspec(dllexport)
#    else
        /* We are using this library */
#      define KPACKAGE_EXPORT __declspec(dllimport)
#    endif
#  endif
...
#  define KPACKAGE_DECL_DEPRECATED __declspec(deprecated)
#endif
...
#define KPACKAGE_DECL_DEPRECATED_TEXT(text) __attribute__ ((__deprecated__(text)))
...
#  define KPACKAGE_DISABLE_DEPRECATED_BEFORE_AND_AT 0x56e00
#endif
...
#  else
#    define KPACKAGE_DEPRECATED_WARNINGS_SINCE 0x56e00
#  endif
#endif
...
#if KPACKAGE_DEPRECATED_WARNINGS_SINCE >= 0x51500
#  define KPACKAGE_DEPRECATED_VERSION_5_21(text) KPACKAGE_DECL_DEPRECATED_TEXT(text)
#else
#  define KPACKAGE_DEPRECATED_VERSION_5_21(text)
#endif

#if KPACKAGE_DEPRECATED_WARNINGS_SINCE >= 0x55400
#  define KPACKAGE_DEPRECATED_VERSION_5_84(text) KPACKAGE_DECL_DEPRECATED_TEXT(text)
#else
#  define KPACKAGE_DEPRECATED_VERSION_5_84(text)
#endif

#if KPACKAGE_DEPRECATED_WARNINGS_SINCE >= 0x55500
#  define KPACKAGE_DEPRECATED_VERSION_5_85(text) KPACKAGE_DECL_DEPRECATED_TEXT(text)
#else
#  define KPACKAGE_DEPRECATED_VERSION_5_85(text)
#endif

#if KPACKAGE_DEPRECATED_WARNINGS_SINCE >= 0x55600
#  define KPACKAGE_DEPRECATED_VERSION_5_86(text) KPACKAGE_DECL_DEPRECATED_TEXT(text)
#else
#  define KPACKAGE_DEPRECATED_VERSION_5_86(text)
#endif

#if KPACKAGE_DEPRECATED_WARNINGS_SINCE >= 0x56a00
#  define KPACKAGE_DEPRECATED_VERSION_5_106(text) KPACKAGE_DECL_DEPRECATED_TEXT(text)
#else
#  define KPACKAGE_DEPRECATED_VERSION_5_106(text)
#endif
#define KPACKAGE_DEPRECATED_VERSION_5(minor, text)      KPACKAGE_DEPRECATED_VERSION_5_##minor(text)
#define KPACKAGE_DEPRECATED_VERSION(major, minor, text) KPACKAGE_DEPRECATED_VERSION_##major(minor, "Since "#major"."#minor". " text)
#define KPACKAGE_DEPRECATED_VERSION_BELATED(major, minor, textmajor, textminor, text) KPACKAGE_DEPRECATED_VERSION_##major(minor, "Since "#textmajor"."#textminor". " text)
#if defined(__cpp_enumerator_attributes) && __cpp_enumerator_attributes >= 201411
#  define KPACKAGE_ENUMERATOR_DEPRECATED_VERSION(major, minor, text) KPACKAGE_DEPRECATED_VERSION(major, minor, text)
#  define KPACKAGE_ENUMERATOR_DEPRECATED_VERSION_BELATED(major, minor, textmajor, textminor, text) KPACKAGE_DEPRECATED_VERSION_BELATED(major, minor, textmajor, textminor, text)
#else
#  define KPACKAGE_ENUMERATOR_DEPRECATED_VERSION(major, minor, text)
#  define KPACKAGE_ENUMERATOR_DEPRECATED_VERSION_BELATED(major, minor, textmajor, textminor, text)
#endif
