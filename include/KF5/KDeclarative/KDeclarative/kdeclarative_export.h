...
#      define KDECLARATIVE_EXPORT __declspec(dllexport)
#    else
        /* We are using this library */
#      define KDECLARATIVE_EXPORT __declspec(dllimport)
#    endif
#  endif
...
#  define KDECLARATIVE_DECL_DEPRECATED __declspec(deprecated)
#endif
...
#  define KDECLARATIVE_DISABLE_DEPRECATED_BEFORE_AND_AT 0x56e00
#endif
...
#  else
#    define KDECLARATIVE_DEPRECATED_WARNINGS_SINCE 0x56e00
#  endif
#endif
...
#  define KDECLARATIVE_ENABLE_DEPRECATED_SINCE(major, minor) (((major<<16)|(minor<<8)) > KDECLARATIVE_DISABLE_DEPRECATED_BEFORE_AND_AT)
#else
...
#if KDECLARATIVE_DEPRECATED_WARNINGS_SINCE >= 0x55f00
#  define KDECLARATIVE_DEPRECATED_VERSION_5_95(text) KDECLARATIVE_DECL_DEPRECATED_TEXT(text)
#else
#  define KDECLARATIVE_DEPRECATED_VERSION_5_95(text)
#endif

#if KDECLARATIVE_DEPRECATED_WARNINGS_SINCE >= 0x56200
#  define KDECLARATIVE_DEPRECATED_VERSION_5_98(text) KDECLARATIVE_DECL_DEPRECATED_TEXT(text)
#else
#  define KDECLARATIVE_DEPRECATED_VERSION_5_98(text)
#endif

#if KDECLARATIVE_DEPRECATED_WARNINGS_SINCE >= 0x56400
#  define KDECLARATIVE_DEPRECATED_VERSION_5_100(text) KDECLARATIVE_DECL_DEPRECATED_TEXT(text)
#else
#  define KDECLARATIVE_DEPRECATED_VERSION_5_100(text)
#endif
