...
#      define KGLOBALACCELPRIVATE_EXPORT __declspec(dllexport)
#    else
        /* We are using this library */
#      define KGLOBALACCELPRIVATE_EXPORT __declspec(dllimport)
#    endif
#  endif
...
#  define KGLOBALACCELPRIVATE_DECL_DEPRECATED __declspec(deprecated)
#endif
...
#  define KGLOBALACCELPRIVATE_DISABLE_DEPRECATED_BEFORE_AND_AT 0x56e00
#endif
...
#  else
#    define KGLOBALACCELPRIVATE_DEPRECATED_WARNINGS_SINCE 0x56e00
#  endif
#endif
...
#  define KGLOBALACCELPRIVATE_ENABLE_DEPRECATED_SINCE(major, minor) (((major<<16)|(minor<<8)) > KGLOBALACCELPRIVATE_DISABLE_DEPRECATED_BEFORE_AND_AT)
#else
...
#if KGLOBALACCELPRIVATE_DEPRECATED_WARNINGS_SINCE >= 0x55a00
#  define KGLOBALACCELPRIVATE_DEPRECATED_VERSION_5_90(text) KGLOBALACCELPRIVATE_DECL_DEPRECATED_TEXT(text)
#else
#  define KGLOBALACCELPRIVATE_DEPRECATED_VERSION_5_90(text)
#endif
#define KGLOBALACCELPRIVATE_DEPRECATED_VERSION_4(minor, text)      KGLOBALACCELPRIVATE_DEPRECATED_VERSION_4_##minor(text)
#define KGLOBALACCELPRIVATE_DEPRECATED_VERSION_5(minor, text)      KGLOBALACCELPRIVATE_DEPRECATED_VERSION_5_##minor(text)
