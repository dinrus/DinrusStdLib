...
#      define KTEXTWIDGETS_EXPORT __declspec(dllexport)
#    else
        /* We are using this library */
#      define KTEXTWIDGETS_EXPORT __declspec(dllimport)
#    endif
#  endif
...
#  define KTEXTWIDGETS_DECL_DEPRECATED __declspec(deprecated)
#endif
...
#  define KTEXTWIDGETS_DISABLE_DEPRECATED_BEFORE_AND_AT 0x56e00
#endif
...
#  else
#    define KTEXTWIDGETS_DEPRECATED_WARNINGS_SINCE 0x56e00
#  endif
#endif
...
#  define KTEXTWIDGETS_ENABLE_DEPRECATED_SINCE(major, minor) (((major<<16)|(minor<<8)) > KTEXTWIDGETS_DISABLE_DEPRECATED_BEFORE_AND_AT)
#else
...
#if KTEXTWIDGETS_DEPRECATED_WARNINGS_SINCE >= 0x56500
#  define KTEXTWIDGETS_DEPRECATED_VERSION_5_101(text) KTEXTWIDGETS_DECL_DEPRECATED_TEXT(text)
#else
#  define KTEXTWIDGETS_DEPRECATED_VERSION_5_101(text)
#endif
