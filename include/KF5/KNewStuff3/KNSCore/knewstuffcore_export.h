...
#      define KNEWSTUFFCORE_EXPORT __declspec(dllexport)
#    else
        /* We are using this library */
#      define KNEWSTUFFCORE_EXPORT __declspec(dllimport)
#    endif
#  endif
...
#  define KNEWSTUFFCORE_DECL_DEPRECATED __declspec(deprecated)
#endif
...
#  define KNEWSTUFFCORE_DISABLE_DEPRECATED_BEFORE_AND_AT 0x56e00
#endif
...
#  else
#    define KNEWSTUFFCORE_DEPRECATED_WARNINGS_SINCE 0x56e00
#  endif
#endif
...
#  define KNEWSTUFFCORE_ENABLE_DEPRECATED_SINCE(major, minor) (((major<<16)|(minor<<8)) > KNEWSTUFFCORE_DISABLE_DEPRECATED_BEFORE_AND_AT)
#else
