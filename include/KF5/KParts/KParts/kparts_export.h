...
#      define KPARTS_EXPORT __declspec(dllexport)
#    else
        /* We are using this library */
#      define KPARTS_EXPORT __declspec(dllimport)
#    endif
#  endif
...
#  define KPARTS_DECL_DEPRECATED __declspec(deprecated)
#endif
...
#  define KPARTS_DISABLE_DEPRECATED_BEFORE_AND_AT 0x56e00
#endif
...
#  else
#    define KPARTS_DEPRECATED_WARNINGS_SINCE 0x56e00
#  endif
#endif
...
#  define KPARTS_ENABLE_DEPRECATED_SINCE(major, minor) (((major<<16)|(minor<<8)) > KPARTS_DISABLE_DEPRECATED_BEFORE_AND_AT)
#else
...
#if KPARTS_DEPRECATED_WARNINGS_SINCE >= 0x54d00
#  define KPARTS_DEPRECATED_VERSION_5_77(text) KPARTS_DECL_DEPRECATED_TEXT(text)
#else
#  define KPARTS_DEPRECATED_VERSION_5_77(text)
#endif

#if KPARTS_DEPRECATED_WARNINGS_SINCE >= 0x54e00
#  define KPARTS_DEPRECATED_VERSION_5_78(text) KPARTS_DECL_DEPRECATED_TEXT(text)
#else
#  define KPARTS_DEPRECATED_VERSION_5_78(text)
#endif

#if KPARTS_DEPRECATED_WARNINGS_SINCE >= 0x55000
#  define KPARTS_DEPRECATED_VERSION_5_80(text) KPARTS_DECL_DEPRECATED_TEXT(text)
#else
#  define KPARTS_DEPRECATED_VERSION_5_80(text)
#endif

#if KPARTS_DEPRECATED_WARNINGS_SINCE >= 0x55100
#  define KPARTS_DEPRECATED_VERSION_5_81(text) KPARTS_DECL_DEPRECATED_TEXT(text)
#else
#  define KPARTS_DEPRECATED_VERSION_5_81(text)
#endif

#if KPARTS_DEPRECATED_WARNINGS_SINCE >= 0x55200
#  define KPARTS_DEPRECATED_VERSION_5_82(text) KPARTS_DECL_DEPRECATED_TEXT(text)
#else
#  define KPARTS_DEPRECATED_VERSION_5_82(text)
#endif

#if KPARTS_DEPRECATED_WARNINGS_SINCE >= 0x55300
#  define KPARTS_DEPRECATED_VERSION_5_83(text) KPARTS_DECL_DEPRECATED_TEXT(text)
#else
#  define KPARTS_DEPRECATED_VERSION_5_83(text)
#endif

#if KPARTS_DEPRECATED_WARNINGS_SINCE >= 0x55800
#  define KPARTS_DEPRECATED_VERSION_5_88(text) KPARTS_DECL_DEPRECATED_TEXT(text)
#else
#  define KPARTS_DEPRECATED_VERSION_5_88(text)
#endif

#if KPARTS_DEPRECATED_WARNINGS_SINCE >= 0x55a00
#  define KPARTS_DEPRECATED_VERSION_5_90(text) KPARTS_DECL_DEPRECATED_TEXT(text)
#else
#  define KPARTS_DEPRECATED_VERSION_5_90(text)
#endif

#if KPARTS_DEPRECATED_WARNINGS_SINCE >= 0x56700
#  define KPARTS_DEPRECATED_VERSION_5_103(text) KPARTS_DECL_DEPRECATED_TEXT(text)
#else
#  define KPARTS_DEPRECATED_VERSION_5_103(text)
#endif
...
#  define KPARTS_ENUMERATOR_DEPRECATED_VERSION(major, minor, text) KPARTS_DEPRECATED_VERSION(major, minor, text)
#  define KPARTS_ENUMERATOR_DEPRECATED_VERSION_BELATED(major, minor, textmajor, textminor, text) KPARTS_DEPRECATED_VERSION_BELATED(major, minor, textmajor, textminor, text)
#else
#  define KPARTS_ENUMERATOR_DEPRECATED_VERSION(major, minor, text)
#  define KPARTS_ENUMERATOR_DEPRECATED_VERSION_BELATED(major, minor, textmajor, textminor, text)
#endif
