...
#  define KCONFIGCORE_DECL_DEPRECATED __declspec(deprecated)
#endif
...
#  define KCONFIGCORE_DISABLE_DEPRECATED_BEFORE_AND_AT 0x56e00
#endif
...
#  else
#    define KCONFIGCORE_DEPRECATED_WARNINGS_SINCE 0x56e00
#  endif
#endif
...
#if KCONFIGCORE_DEPRECATED_WARNINGS_SINCE >= 0x55200
#  define KCONFIGCORE_DEPRECATED_VERSION_5_82(text) KCONFIGCORE_DECL_DEPRECATED_TEXT(text)
#else
#  define KCONFIGCORE_DEPRECATED_VERSION_5_82(text)
#endif

#if KCONFIGCORE_DEPRECATED_WARNINGS_SINCE >= 0x55900
#  define KCONFIGCORE_DEPRECATED_VERSION_5_89(text) KCONFIGCORE_DECL_DEPRECATED_TEXT(text)
#else
#  define KCONFIGCORE_DEPRECATED_VERSION_5_89(text)
#endif

#if KCONFIGCORE_DEPRECATED_WARNINGS_SINCE >= 0x56700
#  define KCONFIGCORE_DEPRECATED_VERSION_5_103(text) KCONFIGCORE_DECL_DEPRECATED_TEXT(text)
#else
#  define KCONFIGCORE_DEPRECATED_VERSION_5_103(text)
#endif
