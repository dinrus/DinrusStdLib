...
#      define KICONTHEMES_EXPORT __declspec(dllexport)
#    else
        /* We are using this library */
#      define KICONTHEMES_EXPORT __declspec(dllimport)
#    endif
#  endif
...
#  define KICONTHEMES_DECL_DEPRECATED __declspec(deprecated)
#endif
...
#  define KICONTHEMES_DISABLE_DEPRECATED_BEFORE_AND_AT 0x56e00
#endif
...
#  else
#    define KICONTHEMES_DEPRECATED_WARNINGS_SINCE 0x56e00
#  endif
#endif
...
#  define KICONTHEMES_ENABLE_DEPRECATED_SINCE(major, minor) (((major<<16)|(minor<<8)) > KICONTHEMES_DISABLE_DEPRECATED_BEFORE_AND_AT)
#else
...
#if KICONTHEMES_DEPRECATED_WARNINGS_SINCE >= 0x55200
#  define KICONTHEMES_DEPRECATED_VERSION_5_82(text) KICONTHEMES_DECL_DEPRECATED_TEXT(text)
#else
#  define KICONTHEMES_DEPRECATED_VERSION_5_82(text)
#endif

#if KICONTHEMES_DEPRECATED_WARNINGS_SINCE >= 0x56800
#  define KICONTHEMES_DEPRECATED_VERSION_5_104(text) KICONTHEMES_DECL_DEPRECATED_TEXT(text)
#else
#  define KICONTHEMES_DEPRECATED_VERSION_5_104(text)
#endif
...
#  define KICONTHEMES_ENUMERATOR_DEPRECATED_VERSION(major, minor, text) KICONTHEMES_DEPRECATED_VERSION(major, minor, text)
#  define KICONTHEMES_ENUMERATOR_DEPRECATED_VERSION_BELATED(major, minor, textmajor, textminor, text) KICONTHEMES_DEPRECATED_VERSION_BELATED(major, minor, textmajor, textminor, text)
#else
#  define KICONTHEMES_ENUMERATOR_DEPRECATED_VERSION(major, minor, text)
#  define KICONTHEMES_ENUMERATOR_DEPRECATED_VERSION_BELATED(major, minor, textmajor, textminor, text)
#endif
