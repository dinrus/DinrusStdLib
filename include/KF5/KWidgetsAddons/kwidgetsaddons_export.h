...
#      define KWIDGETSADDONS_EXPORT __declspec(dllexport)
#    else
        /* We are using this library */
#      define KWIDGETSADDONS_EXPORT __declspec(dllimport)
#    endif
#  endif
...
#  define KWIDGETSADDONS_DECL_DEPRECATED __declspec(deprecated)
#endif
...
#  define KWIDGETSADDONS_DISABLE_DEPRECATED_BEFORE_AND_AT 0x56e00
#endif
...
#  else
#    define KWIDGETSADDONS_DEPRECATED_WARNINGS_SINCE 0x56e00
#  endif
#endif
...
#  define KWIDGETSADDONS_ENABLE_DEPRECATED_SINCE(major, minor) (((major<<16)|(minor<<8)) > KWIDGETSADDONS_DISABLE_DEPRECATED_BEFORE_AND_AT)
#else
...
#if KWIDGETSADDONS_DEPRECATED_WARNINGS_SINCE >= 0x56400
#  define KWIDGETSADDONS_DEPRECATED_VERSION_5_100(text) KWIDGETSADDONS_DECL_DEPRECATED_TEXT(text)
#else
#  define KWIDGETSADDONS_DEPRECATED_VERSION_5_100(text)
#endif
