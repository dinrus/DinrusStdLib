...
#include <qt/QtRemoteObjects/qtremoteobjectglobal.h>
#include <qt/QtRemoteObjects/qremoteobjectregistry.h>
#include <qt/QtRemoteObjects/qremoteobjectdynamicreplica.h>
