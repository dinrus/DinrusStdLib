...
#include <qt/QtQuick3DRuntimeRender/private/qssgvertexpipelineimpl_p.h>

#include <qt/QtCore/qhash.h>

#include <qt/QtQuick3DRuntimeRender/private/qssgrendercustommaterial_p.h> // Make it possible to forward declare the nested TextureProperty
