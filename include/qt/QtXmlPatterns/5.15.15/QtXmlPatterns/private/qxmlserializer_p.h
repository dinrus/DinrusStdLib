...
#include <qt/QtCore/QStack>
#include <qt/QtCore/QTextCodec>
#include <qt/QtXmlPatterns/QXmlQuery>
#include <qt/QtXmlPatterns/QXmlNamePool>
#include <qt/QtXmlPatterns/QXmlSerializer>
