...
#include <qt/QtConcurrent/qtconcurrentcompilertest.h>

#if !defined(QT_NO_CONCURRENT) || defined(Q_CLANG_QDOC)

#include <qt/QtConcurrent/qtconcurrentrunbase.h>
#include <qt/QtConcurrent/qtconcurrentstoredfunctioncall.h>
