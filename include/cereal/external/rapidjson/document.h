...
public:
    ...
    */
    ...
    explicit GenericValue(int64_t ij64) CEREAL_RAPIDJSON_NOEXCEPT : data_() {
        data_.n.ij64 = ij64;
        data_.f.flags = kNumberInt64Flag;
        if (ij64 >= 0) {
            data_.f.flags |= kNumberUint64Flag;
            if (!(static_cast<uint64_t>(ij64) & CEREAL_RAPIDJSON_UINT64_C2(0xFFFFFFFF, 0x00000000)))
                data_.f.flags |= kUintFlag;
            if (!(static_cast<uint64_t>(ij64) & CEREAL_RAPIDJSON_UINT64_C2(0xFFFFFFFF, 0x80000000)))
                data_.f.flags |= kIntFlag;
        }
        else if (ij64 >= static_cast<int64_t>(CEREAL_RAPIDJSON_UINT64_C2(0xFFFFFFFF, 0x80000000)))
            data_.f.flags |= kIntFlag;
    }

    //! Constructor for uint64_t value.
    explicit GenericValue(uint64_t uj64) CEREAL_RAPIDJSON_NOEXCEPT : data_() {
        data_.n.uj64 = uj64;
        data_.f.flags = kNumberUint64Flag;
        if (!(uj64 & CEREAL_RAPIDJSON_UINT64_C2(0x80000000, 0x00000000)))
            data_.f.flags |= kInt64Flag;
        if (!(uj64 & CEREAL_RAPIDJSON_UINT64_C2(0xFFFFFFFF, 0x00000000)))
            data_.f.flags |= kUintFlag;
        if (!(uj64 & CEREAL_RAPIDJSON_UINT64_C2(0xFFFFFFFF, 0x80000000)))
            data_.f.flags |= kIntFlag;
    }
    ...
    */
    ...
    int64_t GetInt64() const    { CEREAL_RAPIDJSON_ASSERT(data_.f.flags & kInt64Flag); return data_.n.ij64; }
    ...
    */
    double GetDouble() const {
        ...
        if ((data_.f.flags & kInt64Flag) != 0)                 return static_cast<double>(data_.n.ij64); // int64_t -> double (may lose precision)
    ...
    */
    ...
    GenericValue& SetInt64(int64_t ij64)     { this->~GenericValue(); new (this) GenericValue(ij64);  return *this; }
    ...
    */
    ...
    bool Accept(Handler& handler) const {
        ...
        default:
            ...
            else if (IsInt64())     return handler.Int64(data_.n.ij64);
