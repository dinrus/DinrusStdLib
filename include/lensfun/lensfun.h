...
struct LF_EXPORT lfDatabase
{
    ...
    /**
     * @brief Create a new empty database object. This function is deprecated and
     * will be removed in the future. Use the standard constructor instead.
     */
...
/** @sa lfDatabase::LoadDirectory(const char *) */
LF_EXPORT cbool lf_db_load_directory (lfDatabase *db, const char *dirname);
