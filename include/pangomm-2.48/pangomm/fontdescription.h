 ...
 * replaced by smaller variants of the capital characters. @newin{1,50}
 * 
 *  @var Variant::PETITE_CAPS
 * A font with the lower case characters
 * replaced by smaller variants of the capital characters.
 * Petite Caps can be even smaller than Small Caps. @newin{1,50}
 * 
 ...
 * replaced by smaller variants of the capital letters. @newin{1,50}
 * 
 *  @var Variant::TITLE_CAPS
 * A font with capital letters that
 * are more suitable for all-uppercase titles. @newin{1,50}
 */
...
public:
  /** 
   *  @var Weight THIN
   * The thin weight (= 100) @newin{1,24}
   * 
   ...
   * The semilight weight (= 350) @newin{1,36,7}
   * 
   *  @var Weight BOOK
   ...
   * 
   *  @var Weight MEDIUM
   * The medium weight (= 500) @newin{1,24}
   * 
   *  @var Weight SEMIBOLD
   ...
   * The ultraheavy weight (= 1000) @newin{1,24}
   */
...
public:
   ...
   * font description, or <tt>nullptr</tt> if not previously set. This has the same
   ...
   */
  void set_features(const Glib::ustring& features);
   ...
   */
  Glib::ustring get_features() const;
