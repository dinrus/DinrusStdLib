 ...
 * the interpretation of `Pango::Alignment` values.
 *
...
public:
  ...
  */
   ...
   * entire width of the layout.
   * 
   * This only has an effect if set_justify() has
   * been called as well.
   * 
   * The default value is <tt>false</tt>.
   * 
  ...
  /** Gets the text direction at the given character position in @a layout.
   * 
   * @newin{2,54}
   * 
   * @param index The byte index of the char.
   * @return The text direction at @a index.
   */
   ...
   * strong and weak cursors if the insertion point is at that index.
   * 
   * This is a variant of get_cursor_pos() that applies
