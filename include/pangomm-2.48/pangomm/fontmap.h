...
public:
  ...
  /** Returns a new font that is like @a font, except that its size
   * is multiplied by @a scale, its backend-dependent configuration
   * (e.g.\ cairo font options) is replaced by the one in @a context,
   * and its variations are replaced by @a variations.
   * 
   * @newin{1,52}
   * 
   * @param font A font in @a fontmap.
