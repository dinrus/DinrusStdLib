...
template <>
class GDKMM_API Value<Gdk::PixbufAlphaMode> : public Glib::Value_Enum<Gdk::PixbufAlphaMode>
{
public:
  static GType value_type() G_GNUC_CONST;
};
...
template <>
class GDKMM_API Value<Gdk::PixbufRotation> : public Glib::Value_Enum<Gdk::PixbufRotation>
{
public:
  static GType value_type() G_GNUC_CONST;
};
 ...
 */
class GDKMM_API PixbufError : public Glib::Error
{
public:
