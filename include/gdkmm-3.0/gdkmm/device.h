...
template <>
class GDKMM_API Value<Gdk::EventMask> : public Glib::Value_Flags<Gdk::EventMask>
{
public:
...
template <>
class GDKMM_API Value<Gdk::InputMode> : public Glib::Value_Enum<Gdk::InputMode>
{
public:
  static GType value_type() G_GNUC_CONST;
};
...
template <>
class GDKMM_API Value<Gdk::DeviceType> : public Glib::Value_Enum<Gdk::DeviceType>
{
public:
  static GType value_type() G_GNUC_CONST;
};
...
template <>
class GDKMM_API Value<Gdk::GrabOwnership> : public Glib::Value_Enum<Gdk::GrabOwnership>
{
public:
  static GType value_type() G_GNUC_CONST;
};
...
template <>
class GDKMM_API Value<Gdk::GrabStatus> : public Glib::Value_Enum<Gdk::GrabStatus>
{
public:
  static GType value_type() G_GNUC_CONST;
};
