...
#      define _OgreFreeImageCodecExport __declspec(dllexport)
#    else
        /* We are using this library */
#      define _OgreFreeImageCodecExport __declspec(dllimport)
#    endif
#  endif
...
#  define CODEC_FREEIMAGE_DEPRECATED __declspec(deprecated)
#endif
