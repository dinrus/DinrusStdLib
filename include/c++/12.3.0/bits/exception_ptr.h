...
namespace std
{
  ...
  void rethrow_exception(exception_ptr ex) __attribute__ ((__noreturn__));
  ...
  namespace __exception_ptr
  {
    ...
    class exception_ptr
    {
      ...
      inline void _M_addref() noexcept {count++;}
      inline void _M_release() noexcept {count--;}
    ...
    inline exception_ptr::exception_ptr() _GLIBCXX_USE_NOEXCEPT
    : _M_exception_object(0)
    { }

    _GLIBCXX_EH_PTR_USED
    inline exception_ptr::exception_ptr(const exception_ptr& __other)
    _GLIBCXX_USE_NOEXCEPT
    : _M_exception_object(__other._M_exception_object)
    {
      if (_M_exception_object)
	     _M_addref(); //отсутствует в библиотеке!!!
    }
    ...
    _GLIBCXX_EH_PTR_USED
    inline exception_ptr&  exception_ptr::operator=(const exception_ptr& __other) _GLIBCXX_USE_NOEXCEPT
    {
