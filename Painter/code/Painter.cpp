...
void PaintCharacter(Painter& sw, const Pointf& p, i32 chr, Font font)
{
...
Painter& Painter::Fill(double x1, double y1, const RGBA& color1, double x2, double y2, const RGBA& color2, i32 style)
{
...
Painter& Painter::Fill(double fx, double fy, const RGBA& color1, double cx, double cy, double r, const RGBA& color2, i32 style)
{
	return Fill(Pointf(fx, fy), color1, Pointf(cx, cy), r, color2, style);
}

Painter& Painter::Fill(const Pointf& c, const RGBA& color1, double r, const RGBA& color2, i32 style)
{
	return Fill(c, color1, c, r, color2, style);
}

Painter& Painter::Fill(double x, double y, const RGBA& color1, double r, const RGBA& color2, i32 style)
{
	return Fill(Pointf(x, y), color1, r, color2, style);
}

Painter& Painter::Fill(const Pointf& f, const RGBA& color1, const RGBA& color2, const Xform2D& transsrc, i32 style)
{
	FillOp(f, color1, color2, transsrc, style);
	return *this;
}

Painter& Painter::Stroke(double width, const Pointf& f, const RGBA& color1, const RGBA& color2, const Xform2D& transsrc, i32 style)
{
...
Painter& Painter::Stroke(double width, double x1, double y1, const RGBA& color1, double x2, double y2, const RGBA& color2, i32 style)
{
...
Painter& Painter::Stroke(double width, double fx, double fy, const RGBA& color1, double cx, double cy, double r, const RGBA& color2, i32 style)
{
	return Stroke(width, Pointf(fx, fy), color1, Pointf(cx, cy), r, color2, style);
}

Painter& Painter::Stroke(double width, const Pointf& c, const RGBA& color1, double r, const RGBA& color2, i32 style)
{
	return Stroke(width, c, color1, c, r, color2, style);
}

Painter& Painter::Stroke(double width, double x, double y, const RGBA& color1, double r, const RGBA& color2, i32 style)
{
...
Vec<double> TxtToDash(const Txt& dash, double& start)
{
	Vec<double> d;
	CParser p(dash);
	try {
...
void Painter::DashOp(const Txt& dash, double start)
{
	Vec<double> h = TxtToDash(dash, start);
	DashOp(h, start);
}

Painter& Painter::Character(double x, double y, i32 ch, Font fnt)
{
	return Character(Pointf(x, y), ch, fnt);
}

void Painter::TextOp(const Pointf& p, wtukk text, Font fnt, i32 n, const double *dx)
{
	if(n == 0) {
		Move(0, 0);
		return;
...
Painter& Painter::Text(double x, double y, wtukk text, Font fnt, i32 n, const double *dx)
{
	return Text(Pointf(x, y), text, fnt, n < 0 ? strlen__(text) : n, dx);
}

Painter& Painter::Text(const Pointf& p, const WTxt& s, Font fnt, const double *dx)
{
	return Text(p, ~s, fnt, s.GetLength(), dx);
}

Painter& Painter::Text(double x, double y, const WTxt& s, Font fnt, const double *dx)
{
	return Text(Pointf(x, y), s, fnt, dx);
}

Painter& Painter::Text(const Pointf& p, const Txt& s, Font fnt, const double *dx)
{
	return Text(p, s.ToWTxt(), fnt, dx);
}

Painter& Painter::Text(double x, double y, const Txt& s, Font fnt, const double *dx)
{
	return Text(Pointf(x, y), s, fnt, dx);
}

Painter& Painter::Text(const Pointf& p, tukk text, Font fnt, i32 n, const double *dx)
{
	WTxt s = ToUtf32(text, n);
	return Text(p, s, fnt, n < 0 ? s.GetCount() : n, dx);
}

Painter& Painter::Text(double x, double y, tukk text, Font fnt, i32 n, const double *dx)
{
...
void NilPainter::FillOp(const RGBA& color1, const RGBA& color2, const Xform2D& transsrc, i32 style) {}
void NilPainter::FillOp(const Pointf& p1, const RGBA& color1, const Pointf& p2, const RGBA& color2, i32 style) {}
void NilPainter::FillOp(const Pointf& f, const RGBA& color1, const Pointf& c, double r, const RGBA& color2, i32 style) {}
void NilPainter::FillOp(const Pointf& f, const RGBA& color1, const RGBA& color2, const Xform2D& transsrc, i32 style) {}
...
void NilPainter::StrokeOp(double width, const RGBA& color1, const RGBA& color2, const Xform2D& transsrc, i32 style) {}
void NilPainter::StrokeOp(double width, const Pointf& p1, const RGBA& color1, const Pointf& p2, const RGBA& color2, i32 style) {}
void NilPainter::StrokeOp(double width, const Pointf& f, const RGBA& color1, const Pointf& c, double r, const RGBA& color2, i32 style) {}
void NilPainter::StrokeOp(double width, const Pointf& f, const RGBA& color1, const RGBA& color2, const Xform2D& transsrc, i32 style) {}
void NilPainter::ClipOp() {}
void NilPainter::CharacterOp(const Pointf& p, i32 ch, Font fnt) {}
void NilPainter::TextOp(const Pointf& p, wtukk text, Font fnt, i32 n, const double *dx) {}
void NilPainter::ColorStopOp(double pos, const RGBA& color) {}
void NilPainter::ClearStopsOp() {}
void NilPainter::OpacityOp(double o) {}
void NilPainter::LineCapOp(i32 linecap) {}
void NilPainter::LineJoinOp(i32 linejoin) {}
void NilPainter::MiterLimitOp(double l) {}
void NilPainter::EvenOddOp(bool evenodd) {}
void NilPainter::InvertOp(bool invert) {}
void NilPainter::DashOp(const Vec<double>& dash, double start) {}
...
ImagePainter::ImagePainter(Size sz, i32 mode)
:	ImageBuffer__(sz), BufferPainter(ImageBuffer__::ib, mode)
{}

ImagePainter::ImagePainter(i32 cx, i32 cy, i32 mode)
:	ImageBuffer__(Size(cx, cy)), BufferPainter(ImageBuffer__::ib, mode)
{}

DrawPainter::DrawPainter(Draw& w, Size sz, i32 mode)
