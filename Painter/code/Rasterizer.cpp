...
void Rasterizer::Create(i32 cx, i32 cy, bool subpixel)
{
	Free();
...
force_inline
Rasterizer::Cell *Rasterizer::AddCells(i32 y, i32 n)
{
	CellArray& a = cell[y];
...
inline void Rasterizer::RenderHLine(i32 ey, i32 x1, i32 y1, i32 x2, i32 y2)
{
	i32 ex1 = x1 >> 8;
	i32 ex2 = x2 >> 8;
	i32 fx1 = x1 & 255;
...
void Rasterizer::LineRaw(i32 x1, i32 y1, i32 x2, i32 y2)
{
	...
	Cell *c;
	i32 x_from, x_to;
	i32 p, rem, mod, lift, delta, first, incr;
...
void Rasterizer::Render(i32 y, Rasterizer::Filler& g, bool evenodd)
{
