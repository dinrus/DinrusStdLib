...
FT_Face FTFace(Font fnt, Txt* rpath);
...
bool RenderOutline(const FT_Outline& outline, Painter& path, double xx, double yy)
{
	...
	FT_Vector*  limit;
	char*       tags;
	i32   n;         // index of contour in outline
	char  tag;       // current point's state
	u8   first = 0; // index of first point in contour
...
void PaintCharacterSys(Painter& sw, double x, double y, i32 ch, Font fnt)
{
	//DrawLock __;
