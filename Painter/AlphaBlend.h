...
void AlphaBlend(RGBA *t, const RGBA& c, i32 alpha);
void AlphaBlend(RGBA *t, const RGBA *s, i32 alpha, i32 len);
void AlphaBlend(RGBA *t, const RGBA& c, i32 alpha, i32 len);
...
force_inline
void AlphaBlend__(RGBA& t, const RGBA& c, i32 cover)
{
	i32 a = c.a * cover >> 8;
	i32 alpha = 256 - a - (a >> 7);
