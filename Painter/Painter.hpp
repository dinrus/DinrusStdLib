...
inline
Painter& Painter::Fill(const Pointf& p1, const RGBA& color1, const Pointf& p2, const RGBA& color2, i32 style)
{
...
inline
Painter& Painter::Fill(const Pointf& f, const RGBA& color1, const Pointf& c, double r, const RGBA& color2, i32 style)
{
...
inline
Painter& Painter::Stroke(double width, const Pointf& p1, const RGBA& color1, const Pointf& p2, const RGBA& color2, i32 style)
{
...
inline
Painter& Painter::Stroke(double width, const Pointf& f, const RGBA& color1, const Pointf& c, double r, const RGBA& color2, i32 style)
{
...
inline Painter& Painter::LineCap(i32 linecap)
{
	LineCapOp(linecap);
	return *this;
}

inline Painter& Painter::LineJoin(i32 linejoin)
{
	LineJoinOp(linejoin);
	return *this;
}
...
inline Painter& Painter::Dash(const Vec<double>& dash, double start)
{
	if(dash.GetCount() & 1) {
		Vec<double> dash1;
		dash1.Append(dash);
...
inline Painter& Painter::Dash(tukk dash, double start)
{
	DashOp(dash, start);
	return *this;
}
...
inline Painter& Painter::Character(const Pointf& p, i32 ch, Font fnt)
{
...
inline
Painter& Painter::Text(const Pointf& p, wtukk text, Font fnt, i32 n, const double *dx)
{
