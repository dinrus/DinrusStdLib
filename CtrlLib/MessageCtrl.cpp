...
void MessageBox::Set(Ctrl& c, const Txt& msg, bool animate, bool append, i32 secs)
{
	...
	i32 duration = clamp(secs, 0, 24 * 3600) * 1000;
...
void MessageBox::SetButtonLayout(Button& b, i32 id, i32& rpos)
{
...
void MessageBox::SetCross(i32& rpos)
{
	i32 gap  = Zx(10 / 4);
	i32 cx   = Zx(10);
	btstyle  = CrossStyle();
...
MessageCtrl& MessageCtrl::Information(Ctrl& c, const Txt& s, Event<const Txt&> link, i32 sec)
{
	auto& msg = Create();
...
MessageCtrl& MessageCtrl::Warning(Ctrl& c, const Txt& s, Event<const Txt&> link)
{
	auto& msg = Create();
...
MessageCtrl& MessageCtrl::OK(Ctrl& c, const Txt& s, Event<const Txt&> link)
{
	auto& msg = Create();
...
MessageCtrl& MessageCtrl::AskYesNo(Ctrl& c, const Txt& s, Event<i32> action, Event<const Txt&> link)
{
	auto& msg = Create();
	msg.MessageType(MessageBox::Type::QUESTION);
	msg.Placement(place);
	msg.ButtonR(IDNO, t_("Нет"));
	msg.ButtonL(IDYES, t_("Да"));
	msg.Set(c, s, animate, append);
	msg.WhenLink = link;
...
MessageCtrl& MessageCtrl::AskYesNoCancel(Ctrl& c, const Txt& s, Event<i32> action, Event<const Txt&> link)
{
	auto& msg = Create();
	msg.MessageType(MessageBox::Type::QUESTION);
	msg.Placement(place);
	msg.ButtonR(IDCANCEL, t_("Отмена"));
	msg.ButtonM(IDNO, t_("Нет"));
	msg.ButtonL(IDYES,t_("Да"));
	msg.Set(c, s, animate, append);
	msg.WhenLink = link;
	msg.WhenAction = action;
...
MessageCtrl& MessageCtrl::AskRetryCancel(Ctrl& c, const Txt& s, Event<i32> action, Event<const Txt&> link)
{
	auto& msg = Create();
	msg.MessageType(MessageBox::Type::QUESTION);
	msg.Placement(place);
	msg.ButtonR(IDCANCEL, t_("Отмена"));
	msg.ButtonL(IDRETRY,t_("Повторить"));
	msg.Set(c, s, animate, append);
	msg.WhenLink = link;
	msg.WhenAction = action;
	return *this;
...
MessageCtrl& MessageCtrl::AskAbortRetry(Ctrl& c, const Txt& s, Event<i32> action, Event<const Txt&> link)
{
	auto& msg = Create();
	msg.MessageType(MessageBox::Type::QUESTION);
	msg.Placement(place);
	msg.ButtonR(IDRETRY, t_("Повтроить"));
	msg.ButtonL(IDABORT, t_("Прервать"));
	msg.Set(c, s, animate, append);
	msg.WhenLink = link;
	msg.WhenAction = action;
	return *this;
...
MessageCtrl& MessageCtrl::AskAbortRetryIgnore(Ctrl& c, const Txt& s, Event<i32> action, Event<const Txt&> link)
{
	auto& msg = Create();
	msg.MessageType(MessageBox::Type::QUESTION);
	msg.Placement(place);
	msg.ButtonR(IDIGNORE, t_("Игнорировать"));
	msg.ButtonM(IDRETRY, t_("Повторить"));
	msg.ButtonL(IDABORT,t_("Прервать"));
	msg.Set(c, s, animate, append);
	msg.WhenLink = link;
	msg.WhenAction = action;
...
MessageCtrl& MessageCtrl::Error(Ctrl& c, const Txt& s, Event<const Txt&> link)
{
	auto& msg = Create();
...
MessageCtrl& MessageCtrl::ErrorOKCancel(Ctrl& c, const Txt& s, Event<i32> action, Event<const Txt&> link)
{
	auto& msg = Create();
	msg.MessageType(MessageBox::Type::FAILURE);
	msg.Placement(place);
...
MessageCtrl& MessageCtrl::ErrorYesNo(Ctrl& c, const Txt& s, Event<i32> action, Event<const Txt&> link)
{
	auto& msg = Create();
	msg.MessageType(MessageBox::Type::FAILURE);
	msg.Placement(place);
...
MessageCtrl& MessageCtrl::ErrorYesNoCancel(Ctrl& c, const Txt& s, Event<i32> action, Event<const Txt&> link)
{
	auto& msg = Create();
	msg.MessageType(MessageBox::Type::FAILURE);
	msg.Placement(place);
...
MessageCtrl& MessageCtrl::ErrorRetryCancel(Ctrl& c, const Txt& s, Event<i32> action, Event<const Txt&> link)
{
	auto& msg = Create();
	msg.MessageType(MessageBox::Type::FAILURE);
	msg.Placement(place);
...
MessageCtrl& MessageCtrl::ErrorAbortRetry(Ctrl& c, const Txt& s, Event<i32> action, Event<const Txt&> link)
{
	auto& msg = Create();
	msg.MessageType(MessageBox::Type::FAILURE);
	msg.Placement(place);
	msg.ButtonR(IDRETRY, t_("Повторить"));
	msg.ButtonL(IDABORT, t_("Прервать"));
	msg.Set(c, s, animate, append);
	msg.WhenLink = link;
	msg.WhenAction = action;
...
MessageCtrl& MessageCtrl::ErrorAbortRetryIgnore(Ctrl& c, const Txt& s, Event<i32> action, Event<const Txt&> link)
{
	auto& msg = Create();
	msg.MessageType(MessageBox::Type::FAILURE);
	msg.Placement(place);
...
{
	for(i32 i = 0; i < messages.GetCount(); i++) {
		auto& msg = messages[i];
		if(!msg.IsDiscarded())
			continue;
		messages.Remove(i);
