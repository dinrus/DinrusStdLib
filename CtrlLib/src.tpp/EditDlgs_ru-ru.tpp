topic "Простые диалоговые окна с одним значением";
...
[{_} 
[ {{10000@(113.42.0) [s0;%RU-RU [*@7;4 Простые диалоговые окна с одним 
значением]]}}&]
[s3; &]
...
_[@3 0])&]
[s2;%RU-RU Предлагает пользователю отредактироват
ь единичное текстовое значение.&]
[s3;%RU-RU &]
[s4; &]
...
[@(0.0.255) int]_[*@3 maxlen]_`=_[@3 0])&]
[s2;%RU-RU Предлагает пользователю отредактироват
ь единичное текстовое значение., пустой 
текст недопустим.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
...
lse])&]
[s2;%RU-RU Предлагает пользователю отредактироват
ь единичное целочисленное значение.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
...
_[@(0.0.255) false])&]
[s2;%RU-RU Prompts user to edit a single double value.&]
[s3;%RU-RU &]
[s4;%RU-RU &]
...
[s2;%RU-RU Предлагает пользователю отредактироват
ь единичное значение даты Date.&]
[s3;%RU-RU ]]