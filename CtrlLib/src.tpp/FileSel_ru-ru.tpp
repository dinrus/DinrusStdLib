...
[{_} 
[ {{10000@3 [s0;%RU-RU [*@7;4 Класс ][*@(229)4 FileSel (ФайлВыбор)]]}}&]
[s3; &]
...
[s2;%RU-RU Этот обрвыз можно использовать 
для чередования иконок файлов. Первый 
параметр определяет директорию, второй 
`- имя файла. Клиентский код может 
менять Image, передаваемый как третий 
параметр.&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:WhenIconLazy: [@(0.0.255) void]_(`*[* WhenIconLazy])([@(0.0.255) const]_Str
ing[@(0.0.255) `&]_path, Image[@(0.0.255) `&]_result)&]
[s2;%RU-RU Когда не NULL, эта функция вызывается 
в отдельном потоке для дополнительного 
разрешения иконки файла Заметьте, 
что FileSel, когда закрыт/разрушен, не 
ожидает окончания работы этой функции, 
поэтому нельзя полагаться на данные, 
расположенные вне её.&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:Serialize`(Stream`&`): [@(0.0.255) void]_[* Serialize]([_^Stream^ Stream][@(0.0.255) `&
]_[*@3 s])&]
[s2;%RU-RU Сериализует текущие настройки 
FileSel. В них входит текущая директория, 
текущий выбранный тип файла, размер 
окна FileSel, список LRU посещённых директорий 
и состояние переключателя `"Сортировать 
по`".&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:ExecuteOpen`(const char`*`): [@(0.0.255) bool]_[* ExecuteOpen]([@(0.0.255) c
onst]_[@(0.0.255) char]_`*[*@3 title]_`=_NULL)&]
[s2;%RU-RU Выполняет диалоговое окно `"Открыть 
файл`". [%-*@3 title] может задавать альтернативный 
заголовок диалогового окна. Если 
пользователь выбрал открываемый 
файл, возвращается true.&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:ExecuteSaveAs`(const char`*`): [@(0.0.255) bool]_[* ExecuteSaveAs]([@(0.0.255) c
onst]_[@(0.0.255) char]_`*[*@3 title]_`=_NULL)&]
[s2;%RU-RU Выполняет диалоговое окно `"Сохранить 
как`". [%-*@3 title] может задавать альтернативный 
заголовок диалогового окна. Если 
пользователь выбрал сохраняемый 
файл, возвращается true.&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:ExecuteSelectDir`(const char`*`): [@(0.0.255) bool]_[* ExecuteSelectDir](
[@(0.0.255) const]_[@(0.0.255) char]_`*[*@3 title]_`=_NULL)&]
[s2;%RU-RU Выполняет диалоговое окно выбора 
директории. [%-*@3 title] может задавать 
альтернативный заголовок диалогового 
окна. Если пользователь выбрал открываемый 
файл, возвращается true.&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:Get`(`)const: [_^String^ String]_[* Get]()_[@(0.0.255) const]&]
[s2;%RU-RU Возвращает путь первого выбранного 
файла. Если он отсутствует, возвращается 
пустая String.&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:Set`(const String`&`): [@(0.0.255) void]_[* Set]([@(0.0.255) const]_[_^String^ S
tring][@(0.0.255) `&]_[*@3 s])&]
[s2;%RU-RU Устанавливает [%-*@3 s] как выбираемый 
файл: если в этой строке содержится 
полный путь, то файлвыборка переходит 
в эту директорию, а имяф помещается 
в редактор имён файлов файлвыборки.&]
[s3; &]
[s4; &]
...
[s2;%RU-RU Устанавливает выбираемую группу 
файлов.&]
[s3; &]
[s4; &]
...
[s2;%RU-RU Добавляет тип файла, отображаемый 
как имя [%-*@3 name]. [%-*@3 ext] содержит набор 
файловых масок, разделённых пробелами. 
Например: Type(`"Исходники`", `"`*.c `*.h`").&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:Types`(const char`*`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* Types]([@(0.0.255) c
onst]_[@(0.0.255) char]_`*[*@3 d])&]
[s2;%RU-RU Добавляет ряд типов файлов, используя 
простой текстовый формат: `'`\n`' используется 
для разделения типов, `'`\t`' используется 
для разделения описания типа файла 
и файловой маски. Если `'`\t`' отсутствует, 
текст используется и для описания 
файла, и для файловой маски.&]
[s2;%RU-RU Примеры: Types(`"Все файлы`\t`*.`*`\nТекстовые 
файлы`\t`*.txt`\nФайлы рисунков`\t`*.bmp `*.png 
`*.jpg `*.gif`")).&]
[s3;%RU-RU &]
[s4; &]
[s5;:FileSel`:`:AllFilesType`(`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* AllFilesType]()&]
[s2;%RU-RU То же, что и Type(`"Все файлы`", `"`*.`*`").&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:ClearTypes`(`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* ClearTypes]()&]
[s2;%RU-RU Удаляет файлы всех типов из FileSel.&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:ActiveDir`(const String`&`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* ActiveD
ir]([@(0.0.255) const]_[_^String^ String][@(0.0.255) `&]_[*@3 d])&]
[s2;%RU-RU Устанавливает активную директорию 
файлвыборки (директории старта файлвыборки)
.&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:ActiveType`(int`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* ActiveType]([@(0.0.255) i
nt]_[*@3 i])&]
[s2;%RU-RU Устанавливает активный тип файла.&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:PreSelect`(const String`&`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* PreSele
ct]([@(0.0.255) const]_[_^String^ String][@(0.0.255) `&]_[*@3 path])&]
[s2;%RU-RU Предварительно выделяет файловый 
путь [%-*@3 path].&]
[s3;%RU-RU &]
[s4; &]
[s5;:FileSel`:`:DefaultExt`(const char`*`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* DefaultE
xt]([@(0.0.255) const]_[@(0.0.255) char]_`*[*@3 ext])&]
[s2;%RU-RU Устанавливает расширение файла, 
добавляемое в диалоговом окне `"Сохранить 
как`", если ничего не указано.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:FileSel`:`:Sort`(int`): [_^Upp`:`:FileSel^ FileSel][@(0.0.255) `&]_[* Sort]([@(0.0.255) i
nt]_[*@3 kind])&]
[s2;%RU-RU Устанавливает режим сортировки, 
[%-*@3 kind] может быть одним из следующего 
набора: FILELISTSORT`_NAME, FILELISTSORT`_EXT, FILELISTSORT`_TIME, 
FILELISTSORT`_SIZE, потенциально комбинированным 
(с бинарником или) с флагом FILELISTSORT`_DESCENDING.&]
[s3;%RU-RU &]
[s4; &]
[s5;:Upp`:`:FileSel`:`:Columns`(int`): [_^Upp`:`:FileSel^ FileSel][@(0.0.255) `&]_[* Column
s]([@(0.0.255) int]_[*@3 n])&]
[s2;%RU-RU Устанавливает число колонок.&]
[s3;%RU-RU &]
[s4; &]
[s5;:FileSel`:`:Multi`(bool`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* Multi]([@(0.0.255) bool
]_[*@3 b]_`=_[@(0.0.255) true])&]
[s2;%RU-RU В этом режиме, можно выделять 
несколько файлов. Дефолт равен false.&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:ReadOnlyOption`(bool`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* ReadOnlyOpti
on]([@(0.0.255) bool]_[*@3 b]_`=_[@(0.0.255) true])&]
[s2;%RU-RU Делает опцию `"Только чтение`" 
видимой. Дефолт равен false.&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:MkDirOption`(bool`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* MkDirOption]([@(0.0.255) b
ool]_[*@3 b]_`=_[@(0.0.255) true])&]
[s2;%RU-RU Делает кнопку `"Создать директорию`" 
видимой. Дефолт равен true.&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:NoMkDirOption`(`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* NoMkDirOption]()&]
[s2;%RU-RU То же, что и MkDirOption(false).&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:BaseDir`(const char`*`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* BaseDir]([@(0.0.255) c
onst]_[@(0.0.255) char]_`*[*@3 dir])&]
[s2;%RU-RU Устанавливает базовую директорию 
[%-*@3 dir]. Если используется, то можно 
выделять файлы только внутри этой 
базовой директории (или её поддиректориях), 
а выделенные файловые путь относительны 
к ней.&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:Asking`(bool`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* Asking]([@(0.0.255) bo
ol]_[*@3 b]_`=_[@(0.0.255) true])&]
[s2;%RU-RU Если активен,то файлвыборка задаёт 
вопрос перед возвратом пути существующего 
файла в диалоговом окне `"Сохранить 
как`". Дефолтно активен.&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:NoAsking`(`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* NoAsking]()&]
[s2;%RU-RU То же, что и Asking(false).&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:EditFileName`(bool`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* EditFileName](
[@(0.0.255) bool]_[*@3 b])&]
[s2;%RU-RU Если активен, то пользователь 
может набирать файл в поле редактирования 
имени файла. Дефолтно активен.&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:NoEditFileName`(`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* NoEditFileName](
)&]
[s2;%RU-RU То же, что и EditFileName(false).&]
[s3; &]
[s4; &]
...
[s2;%RU-RU Если активен (дефолт), диалоговое 
окно выполняется как модальное окно 
приложения.&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:Preview`(Ctrl`&`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* Preview]([_^Ctrl^ C
trl][@(0.0.255) `&]_[*@3 ctrl])&]
[s2;%RU-RU Устанавливает [%-*@3 ctrl], обеспечивающий 
предпросмотр текущего выделенного 
файла. Этот виджет помещается в FileSel 
и получает путь к файлу, который предпросмат
ривается, через SetData, либо Null, если 
нечего предпросматривать.&]
[s3;%RU-RU &]
[s4; &]
[s5;:FileSel`:`:Preview`(const Display`&`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* Preview](
[@(0.0.255) const]_[_^Display^ Display][@(0.0.255) `&]_[*@3 d])&]
[s2;%RU-RU Устанавливает [%-*@3 d], обеспечивающий 
предпросмотр текущего выделенного 
файла. Этот Дисплей используется 
FileSel для показа предпросмотра, Значение 
в методе Paint является либо путём к 
файлу, либо Null, если нечего предпросматриват
ь.&]
[s3;%RU-RU &]
[s4; &]
[s5;:FileSel`:`:ClearPlaces`(`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* ClearPlaces]()&]
[s2;%RU-RU Опорожняет список особых папок 
(платформо`-специфичный, обычно с 
папками типа Видео, Изображения, Загрузки, 
входящими в этот список дефолтно). 
Список, если он не пустой, отображается 
...
[@(0.0.255) const]_[@(0.0.255) char`*]_[*@3 group]_`=_NULL, [@(0.0.255) int]_[*@3 row]_`=_`-
[@3 1])&]
[s2;%RU-RU Добавляет путь к папке [%-*@3 path] к 
списку особых папок с именем [%-*@3 name] 
и иконкой [%-*@3 m]. [%-*@3 group] и [%-*@3 row] в этот 
момент должны оставаться при своих 
дефолтных значениях (они используются 
только внутренне). Если [%-*@3 name] или 
иконка [%-*@3 m] не указаны, они создаются 
на основе [%-*@3 path].&]
[s3;%RU-RU &]
[s4; &]
[s5;:FileSel`:`:AddPlaceSeparator`(`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* AddPlaceSepar
ator]()&]
[s2;%RU-RU Добавляет линию горизонтального 
разделителя к списку особых папок.&]
[s3; &]
[s4; &]
[s5;:FileSel`:`:AddStandardPlaces`(`): [_^FileSel^ FileSel][@(0.0.255) `&]_[* AddStandardPl
aces]()&]
[s2;%RU-RU Добавляет дефолтные особые папки 
в список. Вызывается конструктором 
FileSel.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:FileSel`:`:FileCtrl`(Upp`:`:Ctrl`&`,int`): [_^Upp`:`:FileSel^ FileSel][@(0.0.255) `&
]_[* FileCtrl]([_^Upp`:`:Ctrl^ Ctrl][@(0.0.255) `&]_[*@3 ext], [@(0.0.255) int]_[*@3 cx])&]
[s5;:Upp`:`:FileSel`:`:FileCtrl`(Upp`:`:Ctrl`&`): [_^Upp`:`:FileSel^ FileSel][@(0.0.255) `&
]_[* FileCtrl]([_^Upp`:`:Ctrl^ Ctrl][@(0.0.255) `&]_[*@3 ext])&]
[s2;%RU-RU Предоставляет способ расширять 
FileSel: Добавляет виджет после виджета 
имени файла. Высота виджета устанавливается
 такой же, как у имя файла, ширина равна 
[%-*@3 cx.] Вариант без [%-*@3 cx] получает ширину 
от GetMinSize().&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Указывает дефолтное имя для операции 
`"Сохранить Как`".&]
[s3;%RU-RU &]
[s3;%RU-RU ]]