...
[s2; Возвращает the real name of [%-*@3 path].(directory 
or file) with the right letter cases or `"`" if [%-*@3 path].does 
not exist.&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает the size in bytes of the sum of all file 
sizes under [%-*@3 directoryName].&]
[s3; &]
[s4;%- &]
...
[s2; Устанавливает [%-*@3 path ](file or folder) as read 
only or write permitted depending on the value of[%-*@3  readOnly].&]
...
[s2; Устанавливает [%-*@3 path] (file or folder) as read 
only or write permitted for[%-*@3  user], [%-*@3 group ]and [%-*@3 others].&]
[s0;l288; -|Возвращает true in case of success.&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает true in [%-*@3 user], [%-*@3 group] or [%-*@3 others] 
if [%-*@3 path ](file or folder) is read only for some of those 
user groups.&]
...
[s2; То же, что и LoadFile([%-*@3 fileName]) but it works in 
POSIX for files automatically generated by the OS.&]
[s2; &]
...
[s2; Возвращает an Array of String`'и containing the file 
names with full path of the files under folder [%-*@3 dir] that 
comply with condition (with wildcards) [%-*@3 condFile] and that 
contain inside the text [%-*@3 text].&]
...
[s2; Возвращает the number of items (files and directories) 
located in the Trash Bin.&]
[s3;%- &]
[s4;%- &]
...
[s0; &]
[s0;%- [%RU-RU File and folder handling functions with eXtras defined 
in ]EXT`_FILE`_FLAGS&]
[s3; &]
[s4;%- &]
[s5;:USE`_TRASH`_BIN:%- [@(0.0.255) enum]_EXT`_FILE`_FLAGS_[* USE`_TRASH`_BIN]_`=_[@3 1]&]
[s2; Если true, removed fildes and fodlers will be moved to the 
Trash (recycle) Bin.&]
[s3;%- &]
[s4;%- &]
...
[s2; Если true, file/folder deletion functions will not consider 
read only flag.&]
[s0; &]
[s4;%- &]
...
[s2;%- [%RU-RU Delete all folders under ][*@3 path ][%RU-RU using ][*@3 flags][%RU-RU  
...
EXT`_FILE`_FLAGS_[*@3 flags]_`=_[@3 0])&]
[s2;%- [%RU-RU Delete all files under ][*@3 path ][%RU-RU using ][*@3 flags][%RU-RU  
that comply the condition in wildcards included in ][*@3 path.]&]
[s2; Возвращает true in case of success.&]
[s3; &]
[s4;%- &]
...
[s2; Создаёт [%-*@3 path] directory. Возвращает  true, 
если [%-*@3 path] exists.&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает all substrings in [%-*@3 str] beginning from 
...
[s2; Устанавливаетin [%-*@3 ret] all substrings in [%-*@3 str] 
beginning from [%-*@3 pos][%-  ]that are between [%-*@3 token].&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает the String from original [%-*@3 pos] to the 
char after found token or until the end of the String if no token 
is found. [%-*@3 pos] is updated to the next char after returned 
String, or Null if there are not more chars available.&]
...
[s2; Возвращает the String to the char after found token 
or until the end of the String if no token is found.&]
[s2; It replaces old Tokenize function().&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает the long number [%-*@3 a ]converted into 
a String.&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает a String containing [%-*@3 hour], [%-*@3 min 
]and [%-*@3 seconds ]formatted as HH:MM:SS.&]
...
har]_`*[*@3 s])&]
[s2;%- [%RU-RU Like ][@(0.0.255) const]_[@(0.0.255) char]_`*[* StrToTime]([@(0.0.255) struct]_[_^Time^ U
...
har]_`*[*@3 s])&]
[s2;%- [%RU-RU Like ][@(0.0.255) const]_[@(0.0.255) char]_`*[* StrToDate]([@(0.0.255) struct]_[_^Time^ U
...
[s2; Возвращает number [%-*@3 d] in [%-*@3 range ]converted 
to a String, so that it has the right number of digits.&]
...
[s2; Возвращает number [%-*@3 d] converted to a String with 
the best resolution, using either fixed or exponential notation, 
 filling exactly [%-*@3 fieldWidth] chars. If [%-*@3 fillSpaces] 
is set, returned string is filled with spaces at the left until 
[%-*@3 fieldWidth].&]
[s3; &]
[s4;%- &]
[s5;:RemoveAccents`(String`):%- [_^String^ String]_[* RemoveAccents]([_^String^ String]_[*@3 s
tr])&]
[s2; Возвращает [%-*@3 str ]with the accented characters 
substituted with the most approximated ascii characters.&]
...
[s2; Возвращает  true, если [%-*@3 c ]is a punctuation 
character.&]
[s3;%- &]
[s4; &]
...
[*@4 T]_[*@3 a])&]
[s2;%- [%RU-RU Возвращает the sign of ][*@3 a:]&]
...
[s2; Возвращает the average of [%-*@3 a], [%-*@3 b], [%-*@3 c] 
and [%-*@3 d].&]
[s3; &]
[s4;%- &]
...
[*@3 max])&]
[s2; Возвращает  true, если [%-*@3 val] is between [%-*@3 min] 
and [%-*@3 max].&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает the slope of the line that crosses ([%-*@3 x1], 
[%-*@3 y1]) and ([%-*@3 x2], [%-*@3 y2]).&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает the slope of the line that crosses [%-*@3 p1] 
and [%-*@3 p2].&]
[s3; &]
[s4; &]
...
[s2; Возвращает [%-*@3 val ]rounded to the upper even number 
or itself if it is even.&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает the rectangle in a Rect to fit inside [%-*@3 frame] 
the [%-*@3 object ]maintaining the aspect ratio.&]
[s0; &]
[s0;= 
@@image:3268&2037
...
16])&]
[s2; Возвращает a rainbow color from an input value [%-*@3 val16] 
from 0 (Red) to 0xFFFF.&]
[s3; &]
[s4; &]
...
[s2; Возвращает a subimage delimited by Rect [%-*@3 r] taken 
from [%-*@3 orig].&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает  true, если coordinates [%-*@3 x] and 
[%-*@3 y] are inside Image [%-*@3 img].&]
[s3; &]
[s4; &]
...
[s2; Возвращает  true, если coordinates [%-*@3 x] and 
[%-*@3 y] are inside ImageBuffer [%-*@3 img].&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает  true, если point [%-*@3 t] is inside 
Image [%-*@3 img].&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает an array with the paths to all drives, 
internal or external, identified in the system.&]
[s3; &]
[s4;%- &]
[s5;:Getcwd`(`):%- [_^String^ String]_[* Getcwd]()&]
[s2; Возвращает an absolute file name representing the 
...
ring]_`&[*@3 folder])&]
[s2; Устанавливаетthe process`'s working directory to 
[%-*@3 folder].&]
...
[s2; High resolution clock. Возвращает time in seconds 
...
[s2; Возвращает  true, если the difference ratio between 
[%-*@3 a] and [%-*@3 b] is lower than [%-*@3 ratio]. A value lower 
than [%-*@3 zero] is considered zero.&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает the id of the element of Range (Vector<>, 
Array<>, ...) [%-*@3 r] that is equal to [%-*@3 value] from id [%-*@3 from]. 
...
[s2; Возвращает the element of Range (Vector<>, Array<>, 
...) [%-*@3 r] whose difference ratio with [%-*@3 value] is lower 
than [%-*@3 ratio] searching from id [%-*@3 from]. If nothing is 
found it returns `-1.&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает the id of the element of Range (Vector<>, 
Array<>, ...) [%-*@3 r] whose difference ratio with [%-*@3 value] 
is lower than [%-*@3 ratio] searching from id [%-*@3 from], adding 
it if is new.&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает the element of Range (Vector<>, Array<>, 
...) [%-*@3 r] whose difference with [%-*@3 value] is lower than 
[%-*@3 delta] searching from id [%-*@3 from]. If nothing is found 
it returns `-1.&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает the id of the element of Range (Vector<>, 
Array<>, ...) [%-*@3 r] whose difference with [%-*@3 value] is lower 
than [%-*@3 delta] searching from id [%-*@3 from], adding it if is 
new.&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает the id of the element of Range (Vector<>, 
Array<>, ...) [%-*@3 r] that is equal to [%-*@3 value] from id [%-*@3 from], 
rounding [%-*@3 numDecimals] decimals. If nothing is found it returns 
`-1.&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает the id of the closest element of Range 
(Vector<>, Array<>, ...) [%-*@3 r] to [%-*@3 value] counting from 
id [%-*@3 from].&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает  true, если Ranges (Vector<>, Array<>, 
...) [%-*@3 a] and [%-*@3 b] are equal.&]
[s3; &]
[s4; &]
...
[s2;%- [%RU-RU Возвращает  true, если the elements of 
Ranges (Vector<>, Array<>, ...) ][*@3 a][%RU-RU  and ][*@3 b][%RU-RU  
are closer than ][*@3 ratio.]&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает a String from a Range (Vector<>, Array<>, 
...) [%-*@3 a] with elements separated with `';`'.&]
[s3; &]
[s4;%- &]
...
[s2; Возвращает the Python ctypes declarations based on 
C declarations in [%-*@3 include].&]
[s3; &]
[s4;%- &]
...
ize])&]
[s2; Возвращает the relative path to go from [%-*@3 from] 
to [%-*@3 path ]in[%-*@3  ret] and returns true if there is a match.&]
