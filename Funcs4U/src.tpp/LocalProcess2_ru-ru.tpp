...
[s2; Возвращает  true, если process is still running.&]
[s3; &]
[s4; &]
...
age]()&]
[s2; Возвращает the string defined by the operating system to describe 
the error code.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:LocalProcess2`:`:GetExitCode`(`): [@(0.0.255) int]_[* GetExitCode]()&]
[s2; Возвращает the process exit code.&]
[s3; &]
[s4; &]
...
[s2; Возвращает  true, если process is paused.&]
[s2; [*@(0.0.255)1 Only defined in Windows.]&]
[s3;%- ]]