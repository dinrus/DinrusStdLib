...
void SystemDraw::Init(uk cgContext, uk view)
{
	handle = cgContext;
	nsview = view;
	Push();
...
SystemDraw::SystemDraw(uk cgContext, uk nsview)
{
...
PointCG SystemDraw::Convert(i32 x, i32 y)
{
...
RectCG SystemDraw::Convert(i32 x, i32 y, i32 cx, i32 cy)
{
	Point p = GetOffset(); // TODO: Optimize
	x += p.x;
	y += p.y;
