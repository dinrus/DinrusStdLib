...
//	winAttributes.bit_gravity = ForgetGravity;
	...
	SetAttributes(ValMask, winAttributes);
	...
	//		GetTopWindow()->GetWindow(), 				// parent
		...
		XChangeWindowAttributes(Xdisplay, hwnd, ValMask, &winAttributes);
	}
...
*/
	...
	// Adds window to DRX managed windows
