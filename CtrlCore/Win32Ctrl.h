private:
	...
	static void RenderFormat(i32 format);
...
protected:
	...
	static VecMap< HWND, Ptr<Ctrl> >& Windows();
	...
	void  Create(HWND parent, DWORD style, DWORD exstyle, bool savebits, i32 show, bool dropshadow);
	Image DoMouse(i32 e, Point p, i32 zd = 0);
