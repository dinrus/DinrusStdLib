...
i32  GLCtrl::depthSize = 24;
i32  GLCtrl::stencilSize = 8;
bool GLCtrl::doubleBuffering = true;
i32  GLCtrl::numberOfSamples = 1;
...
Image GLCtrl::MouseEvent(i32 event, Point p, i32 zdelta, dword keyflags)
{
	if(mouseTarget) {
...
Image GLCtrl::GLPane::MouseEvent(i32 event, Point p, i32 zdelta, dword keyflags)
{
