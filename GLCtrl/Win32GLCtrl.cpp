...
static i32                   s_pixelFormatID;

void MakeWGLContext(i32 depthBits, i32 stencilBits, i32 samples)
{
	ONCELOCK {
		for(i32 pass = 0; pass < 2; pass++) {
			HWND hWND = CreateWindow("DINRUS-CLASS-A", "Fake Window",
...
void GLCtrl::GLPane::State(i32 reason)
{
	DHCtrl::State(reason);
