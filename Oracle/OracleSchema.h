#define INT(x)                     COLUMN("number", i32, x, 0, 0)
#define INT_ARRAY(x, items)        COLUMN_ARRAY("number", i32, x, 0, 0, items)
#define INT_(x)                    COLUMN_("number", i32, x, 0, 0)
#define INT_ARRAY_(x, items)       COLUMN_ARRAY("number", i32, x, 0, 0, items)

#define INT64(x)                   COLUMN("number", z64, x, 0, 0)
#define INT64_ARRAY(x, items)      COLUMN_ARRAY("number", z64, x, 0, 0, items)
#define INT64_(x)                  COLUMN_("number", z64, x, 0, 0)
#define INT64_ARRAY_(x, items)     COLUMN_ARRAY("number", z64, x, 0, 0, items)
...
#define TXT(x, n)               COLUMN("varchar2(" #n ")", Txt, x, n, 0)
#define TXT_ARRAY(x, n, items)  COLUMN_ARRAY("varchar2(" #n ")", Txt, x, n, 0, items)
#define TXT_(x, n)              COLUMN_("varchar2(" #n ")", Txt, x, n, 0)
#define TXT_ARRAY_(x, n, items) COLUMN_ARRAY_("varchar2(" #n ")", Txt, x, n, 0, items)
...
#define LONG(x)                    COLUMN("long", Txt, x, 0, 0)
#define LONG_(x)                   COLUMN_("long", Txt, x, 0, 0)

#define LONGRAW(x)                 COLUMN("long raw", Txt, x, 0, 0)
#define LONGRAW_(x)                COLUMN_("long raw", Txt, x, 0, 0)

#define BLOB(x)                    COLUMN("blob", Txt, x, INT_MAX/2, 0)
#define BLOB_(x)                   COLUMN_("blob", Txt, x, INT_MAX/2, 0)

#define CLOB(x)                    COLUMN("clob", Txt, x, INT_MAX/2, 0)
#define CLOB_(x)                   COLUMN_("clob", Txt, x, INT_MAX/2, 0)
