...
#define oci_boolean i32
typedef void dvoid;
typedef i32 sword;
typedef i32 sb4;
typedef DRX::dword uword;
typedef DRX::dword ub4;
typedef short sb2;
typedef DRX::word ub2;
typedef i8 sb1;
typedef DRX::u8 ub1;
typedef DRX::u8 OraText;
enum
{
	// OCIInitialize modes
	...
	SQLT_VNU = 6, // NUM with preceding length u8
	...
	OCI_TXT_MAXLEN = 4000, // default maximum length of a vstring
};
...
typedef sb4 (*OCICallbackInBind)(duk ictxp, DRX::OCIBind *bindp, ub4 iter,
	ub4 index, duk *bufpp, ub4 *alenp,
	ub1 *piecep, duk *indp);

typedef sb4 (*OCICallbackOutBind)(duk octxp, DRX::OCIBind *bindp, ub4 iter,
	ub4 index, duk *bufpp, ub4 **alenp,
	ub1 *piecep, duk *indp,
	ub2 **rcodep);
