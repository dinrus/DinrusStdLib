...
public:
	...
	{
	public:
		ViewPlot(PlotterCtrl& ctrl, i32 extra_gap = 0);
		ViewPlot(PlotterCtrl& ctrl, Pointf scale, Pointf delta, i32 extra_gap = 0);
		ViewPlot(PlotterCtrl& ctrl, const Matrixf& preform, i32 extra_gap = 0);
...
//	void                    AsyncPaint();
	...
	void                    Gap(i32 i)                       { gap = Rect(i, i, i, i); Layout(); }
...
protected:
	void                    AdjustPos(Point scpos, i32 xymask); // 1 = x, 2 = y
