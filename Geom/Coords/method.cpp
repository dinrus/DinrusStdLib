...
Pointf GisCoordsLonLat::Project(Pointf lonlat, i32 branch) const
{
...
double GisCoordsLonLat::ProjectDeviation(Pointf lonlat1, Pointf lonlat2, i32 branch) const
{
	return 0;
}

double GisCoordsLonLat::ProjectRatio(Pointf lonlat, i32 branch) const
{
	return 1;
}

/*
Txt GisCoordsLonLat::ToTxt() const
{
...
Pointf GisCoordsSpherical::Project(Pointf lonlat, i32 branch) const
{
	CheckInterpolator();
...
double GisCoordsSpherical::ProjectDeviation(Pointf lonlat1, Pointf lonlat2, i32 branch) const
{
	CheckInterpolator();
	return 0;
}

double GisCoordsSpherical::ProjectRatio(Pointf lonlat, i32 branch) const
{
...
/*
Txt GisCoordsSpherical::ToTxt() const
{
...
i32 GisCoordsConical::GetBranchCount() const
{
	return 3;
}

Array<Pointf> GisCoordsConical::LonLatBoundary(const Rectf& lonlat_extent, i32 branch) const
{
	Array<Pointf> out;
	i32 em = DegreeMask(lonlat_extent.left /* - prime_meridian*/, lonlat_extent.right /*- prime_meridian*/);
	if(em & AM_E2)
	{
		if(branch == 1)
		{
...
Pointf GisCoordsConical::Project(Pointf lonlat, i32 branch) const
{
	CheckInterpolator();
...
double GisCoordsConical::ProjectDeviation(Pointf lonlat1, Pointf lonlat2, i32 branch) const
{
...
double GisCoordsConical::ProjectRatio(Pointf lonlat, i32 branch) const
{
...
/*
Txt GisCoordsConical::ToTxt() const
{
...
Txt GisCoordsConical::DumpProjectedDelta() const
{
...
{
//	i32 paspol = ffloor(xy.x / 1000000);
...
Pointf GisCoordsUTM::Project(Pointf lonlat, i32 branch) const
{
...
i32 GisCoordsAzimuthal::GetBranchCount() const
{
	return 1;
}

Array<Pointf> GisCoordsAzimuthal::LonLatBoundary(const Rectf& lonlat_extent, i32 branch) const
{
	return Array<Pointf>();
}
...
Pointf GisCoordsAzimuthal::Project(Pointf lonlat, i32 branch) const
{
...
/*
double GisCoordsAzimuthal::ProjectDeviation(Pointf lonlat1, Pointf lonlat2, i32 branch) const
{
	return 0;
}
*/
...
/*
double GisCoordsAzimuthal::ProjectRatio(Pointf lonlat, i32 branch) const
{
	return 1;
}
*/
...
const Vec<i32>& GisCoords::EnumEPSG()
{
	static Vec<i32> epsg;
	if(epsg.IsEmpty())
		epsg
...
GisCoords GisCoords::GetEPSG(i32 code)
{
