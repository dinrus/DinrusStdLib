...
public:
	...
	double            operator [] (i32 i) const                    { return i == 0 ? x : i == 1 ? y : z; }
	double&           operator [] (i32 i)                          { return i == 0 ? x : i == 1 ? y : z; }
...
extern Txt         AsTxt(const Pointf3& p);
...
public:
	...
	Plane3  GetMinPlane(i32 coord) const { return Plane3(low[coord], normal[coord]); }
	Plane3  GetMaxPlane(i32 coord) const { return Plane3(-high[coord], -normal[coord]); }
