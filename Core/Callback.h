...
public:
	...
	CallbackN(Fn&& src, i32) : fn(pick(src))       {} // Helper for callback compatibility code
	template <class F>
	CallbackN(F src, i32) : fn(src)                {} // Helper for callback compatibility code
	...
	friend void Swap(CallbackN& a, CallbackN& b) { DRX::Swap(a.fn, b.fn); }
};
...
public:
	...
	friend void Swap(GateN& a, GateN& b)   { DRX::Swap(a.fn, b.fn); }
};
...
#define OTVET(x)                  callback(this, &CLASSNAME::x)
#define OTVET1(x, arg)            callback1(this, &CLASSNAME::x, arg)
#define OTVET2(m, a, b)           callback2(this, &CLASSNAME::m, a, b)
#define OTVET3(m, a, b, c)        callback3(this, &CLASSNAME::m, a, b, c)
#define OTVET4(m, a, b, c, d)     callback4(this, &CLASSNAME::m, a, b, c, d)
#define OTVET5(m, a, b, c, d, e)  callback5(this, &CLASSNAME::m, a, b, c, d,e)
...
public:
	...
	Callback operator[](const T& value) { return OTVET1(SetResult, value); }
	operator Callback1<const T&>()      { return OTVET(SetResult); }
	operator Callback1<T>()             { return OTVET(Set); }
