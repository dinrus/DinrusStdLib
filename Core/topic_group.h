...
#define TOPIC(id)       { tukk topic = id;
#define TITLE(x)          tukk title = x;
#define COMPRESSED        static u8k data[] = {
#define END_TOPIC         }; RegisterTopic__(ASTXT(TOPICFILE), topic, title, data, __countof(data)); }
