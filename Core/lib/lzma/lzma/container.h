 ...
 *
 * The MicroLZMA format is a raw LZMA stream whose first u8 (always 0x00)
 * has been replaced with bitwise-negation of the LZMA properties (lc/lp/pb).
 * This encoding ensures that the first u8 of MicroLZMA stream is never
 ...
 * the first u8 of the non-.lz data. An exception to this is if the first
 ...
 * data reliably, one must ensure that the first u8 isn't 0x4C. Actually
