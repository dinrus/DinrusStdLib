...
#	define LZMA_BLOCK_HEADER_SIZE_MAX 1024
	 ...
	 *
	 * Note that CRC32 and CRC64 are stored in little endian u8 order.
 ...
 * The size can be calculated from the first u8 of a Block using this macro.
 * Note that if the first u8 is 0x00, it indicates beginning of Index; use
 * this macro only when the u8 is not 0x00.
 *
 ...
 *    Check fields there's still at least one u8 for Compressed Size.
 *
