...
typedef enum {
	LZMA_MF_HC3     = 0x03,
		/**<
		 * \brief       Hash Chain with 2- and 3-u8 hashing
		 *
		 * Minimum nice_len: 3
		 *
		 * Memory usage:
	...
	LZMA_MF_HC4     = 0x04,
		/**<
		 * \brief       Hash Chain with 2-, 3-, and 4-u8 hashing
		 *
		 * Minimum nice_len: 4
		 *
		 * Memory usage:
	...
	LZMA_MF_BT2     = 0x12,
		/**<
		 * \brief       Binary Tree with 2-u8 hashing
		 *
		 * Minimum nice_len: 2
		 *
	...
	LZMA_MF_BT3     = 0x13,
		/**<
		 * \brief       Binary Tree with 2- and 3-u8 hashing
		 *
		 * Minimum nice_len: 3
		 *
		 * Memory usage:
	...
	LZMA_MF_BT4     = 0x14
		/**<
		 * \brief       Binary Tree with 2-, 3-, and 4-u8 hashing
		 *
		 * Minimum nice_len: 4
		 *
		 * Memory usage:
...
#	define LZMA_DICT_SIZE_DEFAULT   (UINT32_C(1) << 23)
	 ...
	 * eight-bit u8 (also known as `literal') are taken into
...
#	define LZMA_LC_DEFAULT  3
	 ...
	 * assumed when encoding literals. A literal is a single 8-bit u8.
...
#	define LZMA_LP_DEFAULT  0
	 ...
	 * assumed in general. The default means four-u8 alignment
	 * (2^ pb =2^2=4), which is often a good choice when there's
	 * no better guess.
	 *
	 * When the alignment is known, setting pb accordingly may reduce
	 * the file size a little. E.g. with text files having one-u8
	 ...
	 * lp, LZMA1 and LZMA2 still slightly favor 16-u8 alignment.
...
#	define LZMA_PB_DEFAULT  2
	 ...
	 *
	 * For every input u8, match finder searches through the hash chain
