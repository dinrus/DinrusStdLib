...
#	define LZMA_VERSION_STABILITY_TXT "alpha"
#elif LZMA_VERSION_STABILITY == LZMA_VERSION_STABILITY_BETA
#	define LZMA_VERSION_STABILITY_TXT "beta"
#elif LZMA_VERSION_STABILITY == LZMA_VERSION_STABILITY_STABLE
#	define LZMA_VERSION_STABILITY_TXT ""
#else
#	error Incorrect LZMA_VERSION_STABILITY
#endif

#define LZMA_VERSION_TXT_C_(major, minor, patch, stability, commit) \
		#major "." #minor "." #patch stability commit

#define LZMA_VERSION_TXT_C(major, minor, patch, stability, commit) \
		LZMA_VERSION_TXT_C_(major, minor, patch, stability, commit)
 ...
 */
#define LZMA_VERSION_TXT LZMA_VERSION_TXT_C( \
		LZMA_VERSION_MAJOR, LZMA_VERSION_MINOR, \
		LZMA_VERSION_PATCH, LZMA_VERSION_STABILITY_TXT, \
		LZMA_VERSION_COMMIT)
 ...
 */
extern LZMA_API(tukk ) lzma_version_string(void)
		lzma_nothrow lzma_attr_const;
