...
#define max_pcre_offsets 120	//if modified-chk upp RegExp.h as well, keep at multiple of 3
...
//#define  HAVE_INTTYPES_H 1 <= use upp's z64

/* Define to 1 if you have the <limits.h> header file. */
#define  HAVE_LIMITS_H 1

/* Define to 1 if the system has the type `i64'. */
...
/* #undef HAVE_STDINT_H */
//#define  HAVE_STDINT_H 1	<=use upp z64
...
/* Define to any value if linking statically (СДЕЛАТЬ: make nice with Libtool) */
/* #undef PCRE_STATIC */
