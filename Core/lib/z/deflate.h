...
/* A Pos is an index in the character window. We use short instead of i32 to
...
typedef struct internal_state {
    ...
    Bytef *pending_out;  /* next pending u8 to output to the stream */
    ulg   pending;       /* nb of bytes in the pending buffer */
    i32   wrap;          /* bit 0 true for zlib, bit 1 true for gzip */
    gz_headerp  gzhead;  /* gzip header information to write */
    ulg   gzindex;       /* where in extra, name, or comment */
    Byte  method;        /* can only be DEFLATED */
    i32   last_flush;    /* value of flush param for previous deflate call */
     ...
     * u8 no longer takes part in the hash key, that is:
...
#   define max_insert_length  max_lazy_match
    ...
    i32 strategy; /* favor or force Huffman coding*/
