...
[{_}%RU-RU 
[ {{10000@(113.42.0) [s0; [*@7;4 Класс Txt]]}}&]
[s3; &]
[s1;:String`:`:class:%- [@(0.0.255)3 class][3 _][*3 Txt][3 _:_][@(0.0.255)3 public][3 _][*@3;3 Movea
ble][@(0.0.255)3 <][*3 Txt][3 , ][_^AString^3 AString][@(0.0.255)3 <][_^String0^3 String0][@(0.0.255)3 >
][3 _>_]&]
...
[s3;%- &]
[s5;:String`:`:String`(`):%- [* Txt]()&]
[s2; Дефолтный конструктор. Конструирует 
пустой класс [* String].&]
[s3;%- &]
[s4;%- &]
[s5;:String`:`:String`(const String`&`):%- [* Txt]([@(0.0.255) const]_[* Txt][@(0.0.255) `&]_
[*@3 s])&]
[s2; Дефолтный копи`-конструктор.&]
[s3; &]
[s4;%- &]
[s5;:Upp`:`:String`:`:String`(Upp`:`:String`&`&`):%- [* Txt]([* Txt][@(0.0.255) `&`&]_[*@3 s])
&]
[s2; Пик`-конструктор.&]
[s3; &]
[s4;%- &]
[s5;:String`:`:String`(const char`*`):%- [* Txt]([@(0.0.255) const]_[@(0.0.255) char]_`*[*@3 s
])&]
[s2; Создаёт копию строки с нулевым окончанием 
[%-*@3 s].&]
[s3; &]
[s4;%- &]
[s5;:String`:`:String`(const char`*`,int`):%- [* Txt]([@(0.0.255) const]_[@(0.0.255) char]_
...
[s3; &]
[s4;%- &]
[s5;:String`:`:String`(const String`&`,int`):%- [* Txt]([@(0.0.255) const]_[* Txt][@(0.0.255) `&
...
[s3; &]
[s4;%- &]
[s5;:String`:`:String`(const byte`*`,int`):%- [* Txt]([@(0.0.255) const]_[_^byte^ byte]_`*[*@3 s
], [@(0.0.255) int]_[*@3 n])&]
[s2; Конструирует строку, равную первым 
...
[s3; &]
[s4;%- &]
[s5;:String`:`:String`(const char`*`,const char`*`):%- [* Txt]([@(0.0.255) const]_[@(0.0.255) c
...
[s3; &]
[s4;%- &]
[s5;:String`:`:String`(int`,int`):%- [* Txt]([@(0.0.255) int]_[*@3 chr], 
...
[s3; &]
[s4;%- &]
[s5;:String`:`:String`(StringBuffer`&`):%- [* Txt]([_^StringBuffer^ StringBuffer][@(0.0.255) `&
]_[*@3 b])&]
[s2; Конструирует строку из [%-*@3 b]. [%-*@3 b] 
этой операцией опустошается.&]
[s3; &]
[s4;%- &]
[s5;:String`:`:String`(const Nuller`&`):%- [* Txt]([@(0.0.255) const]_[_^Nuller^ Nuller][@(0.0.255) `&
])&]
...
[s3;%- &]
[s4;%- &]
[s5;:String`:`:String`(const string`&`):%- [* Txt]([@(0.0.255) const]_[_^http`:`/`/en`.cppreference`.com`/w`/cpp`/string`/basic`_string^ s
...
[s3;%- &]
[s4;%- &]
[s5;:String`:`:ToWString`(`)const:%- [_^WString^ WTxt]_[* ToWTxt]()_[@(0.0.255) const]&]
[s2; Преобразует String в WString, используя 
текущий дефолтный набор символов.&]
[s3;%- &]
[s4;%- &]
[s5;:String`:`:ToString`(`)const:%- [@(0.0.255) const]_[_^String^ Txt][@(0.0.255) `&]_[* ToTx
t]()_[@(0.0.255) const]&]
...
[s3;%- &]
[s4;%- &]
[s5;:String`:`:GetVoid`(`):%- [@(0.0.255) static] [_^String^ Txt]_[* GetVoid]()&]
...
onst]_[_^String0^ Txt][@(0.0.255) `&]_[*@3 s])_[@(0.0.255) const]&]
...
[s3; &]
[s4;%- &]
[s5;:String`:`:operator`+`=`(const char`*`):%- [@(0.0.255) const]_[_^String0^ Txt][@(0.0.255) `&
]_[* operator`+`=]([@(0.0.255) const]_[@(0.0.255) char]_`*[*@3 s])&]
[s5;:String`:`:operator`+`=`(const String`&`):%- [@(0.0.255) const]_[_^String0^ Txt][@(0.0.255) `&
]_[* operator`+`=]([@(0.0.255) const]_[_^String0^ Txt][@(0.0.255) `&]_[*@3 s])&]
[s2; Приставляет строку с нулевым окончанием 
[%-*@3 s].&]
[s3; &]
[s4;%- &]
[s5;:String`:`:operator`=`(const String`&`):%- [_^String^ String][@(0.0.255) `&]_[* operato
r`=]([@(0.0.255) const]_[_^String0^ Txt][@(0.0.255) `&]_[*@3 s])&]
...
r`=]([_^String0^ Txt][_^StringBuffer^ Buffer][@(0.0.255) `&]_[*@3 b])&]
[s2; Присваивает содержимое [* TxtBuffer]. После 
операции b опорожняется.&]
[s3; &]
[s4;%- &]
...
[s2; Преобразует Txt в std`::string.&]
[s3; &]
[s4;%- &]
...
[s0;%- &]
[s0;%- &]
[ {{10000@(113.42.0) [s0; [*@7;4 Класс WTxt]]}}&]
[s3; &]
[s1;:WString`:`:class:%- [@(0.0.255)3 class][3 _][*3 Wxt][3 _:_][@(0.0.255)3 public][3 _][*@3;3 Move
able][@(0.0.255)3 <][*3 WTxt][3 , ][_^AString^3 AString][@(0.0.255)3 <][_^WString0^3 WString0
][@(0.0.255)3 >][3 _>_]&]
[s9; WString подобен String, но использует 16`-битную 
кодировку Ucs2. String и WString разделяют 
ряд общих функций через интерфейс 
...
[ {{10000F(128)G(128)@1 [s0; [* Детали Конструктора]]}}&]
[s3; &]
[s5;:WString`:`:WString`(`):%- [* WTxt]()&]
[s2; Дефолтный конструктор. Консмтруирует 
пустую [%-* WTxt].&]
[s3;%- &]
[s4;%- &]
[s5;:WString`:`:WString`(const WString`&`):%- [* WTxt]([@(0.0.255) const]_[* WTxt][@(0.0.255) `&
]_[*@3 s])&]
[s2; Дефолтный копи`-конструктор.&]
[s3; &]
[s4;%- &]
[s5;:WString`:`:WString`(const wchar`*`):%- [* WTxt]([@(0.0.255) const]_[_^wchar^ wchar]_`*
[*@3 s])&]
[s2; Создаёт копию строки с нулевым окончанием 
[%-*@3 s].&]
[s3; &]
[s4;%- &]
[s5;:WString`:`:WString`(const char`*`):%- [* WTxt]([@(0.0.255) const]_[@(0.0.255) char]_`*
[*@3 s])&]
[s2; Создаёт копию строки с нулевым окончанием 
[%-*@3 s].&]
[s3; &]
[s4;%- &]
[s5;:WString`:`:WString`(const WString`&`,int`):%- [* WTxt]([@(0.0.255) const]_[* WTxt][@(0.0.255) `&
]_[*@3 s], [@(0.0.255) int]_[*@3 n])&]
[s2;%- [%RU-RU Конструирует строку, равную 
первым ][*@3 n][%RU-RU  символам из ][* WTxt ][*@3 s][%RU-RU  
]([*@3 s ]может содержать символы нуля).&]
[s3; &]
[s4;%- &]
[s5;:WString`:`:WString`(const wchar`*`,int`):%- [* WTxt]([@(0.0.255) const]_[_^wchar^ wcha
...
[s3; &]
[s4;%- &]
[s5;:WString`:`:WString`(const wchar`*`,const wchar`*`):%- [* WTxt]([@(0.0.255) const]_[_^wchar^ w
char]_`*[*@3 s], [@(0.0.255) const]_[_^wchar^ wchar]_`*[*@3 lim])&]
[s2;%- [%RU-RU Конструирует строку, равную 
...
[s3; &]
[s4;%- &]
[s5;:WString`:`:WString`(const char`*`,int`):%- [* WTxt]([@(0.0.255) const]_[@(0.0.255) cha
r]_`*[*@3 s], [@(0.0.255) int]_[*@3 n])&]
[s2;%- [%RU-RU Конструирует строку, равную 
...
[s3; &]
[s4;%- &]
[s5;:WString`:`:WString`(const char`*`,const char`*`):%- [* WTxt]([@(0.0.255) const]_[@(0.0.255) c
har]_`*[*@3 s], [@(0.0.255) const]_[@(0.0.255) char]_`*[*@3 lim])&]
[s2;%- [%RU-RU Конструирует строку, равную 
первым ][*@3 n][%RU-RU  символам строки с нулевым 
окончанием ][*@3 s ]([*@3 s ]может содержать 
...
[s3; &]
[s4;%- &]
[s5;:WString`:`:WString`(int`,int`):%- [* WTxt]([@(0.0.255) int]_[*@3 chr], 
[@(0.0.255) int]_[*@3 count])&]
[s2; Конструирует строку, состоящую из 
...
[s3; &]
[s4;%- &]
[s5;:WString`:`:WString`(WStringBuffer`&`):%- [* WTxt]([_^WStringBuffer^ WTxtBuffer][@(0.0.255) `&
]_[*@3 b])&]
[s2; Конструирует строку из [%-*@3 b]. [%-*@3 b] 
опустошается при этой операции.&]
[s3; &]
[s4;%- &]
[s5;:WString`:`:WString`(const Nuller`&`):%- [* WTxt]([@(0.0.255) const]_[_^Nuller^ Nuller][@(0.0.255) `&
])&]
[s2; Конструирует пустой [* WTxt] . Этот вариант 
позволяет присваивать [* Null]  [* WTxt] (что 
равносильно присвоению пустой [* WTxt] 
).&]
[s3;%- &]
[s4;%- &]
[s5;:WString`:`:WString`(const wstring`&`):%- [* WTxt]([@(0.0.255) const]_std`::wstring[@(0.0.255) `&
]_[*@3 s])&]
...
[s3;%- &]
[s4;%- &]
[s5;:WString`:`:ToString`(`)const:%- [_^String^ Txt]_[* ToTxt]()_[@(0.0.255) const]&]
[s2; Преобразует [%-* WTxt ]в [%-* Txt], используя 
текущий дефолтный набор символов. 
...
[s3;%- &]
[s4;%- &]
[s5;:WString`:`:GetVoid`(`):%- [@(0.0.255) static] [_^WString^ WTxt]_[* GetVoid]()&]
[s2; Возвращает особое значение Void. Это 
значение то же, что и пустая строка, 
но для него метод IsVoid возвращает true. 
Используется в особых сценариях, 
