...
i32 CPU_Cores()
{
	...
	ONCELOCK {
		...
		n = minmax((i32)sysconf(_SC_NPROCESSORS_ONLN), 1, 256);
#else
...
void EndianSwap(i16 *v, size_t count) ENDIAN_SWAP
void EndianSwap(dword *v, size_t count) ENDIAN_SWAP
void EndianSwap(i32 *v, size_t count) ENDIAN_SWAP
void EndianSwap(z64 *v, size_t count) ENDIAN_SWAP
void EndianSwap(zu64 *v, size_t count) ENDIAN_SWAP
