...
struct f32x4 {
	...
	f32x4& Load(ukk ptr)   { data = vld1q_f32((float *)ptr); return *this; }
	f32x4& Load64(ukk ptr) { data = vcombine_f32(vld1_f32((float *)ptr), vdup_n_f32(0)); return *this; }
	f32x4& Load32(ukk ptr) { data = vsetq_lane_f32(*(float *)ptr, vdupq_n_f32(0), 0); return *this; }

	void   Store(uk ptr)        { vst1q_f32((float32_t *)ptr, data); }
	void   Store64(uk ptr)      { vst1_f32((float32_t *)ptr, vget_low_f32(data)); }
	void   Store32(uk ptr)      { *(float32_t *)ptr = vgetq_lane_f32(data, 0); }
	...
	f32x4(i32 f)                 { data = vsetq_lane_f32((float)f, vdupq_n_f32(0), 0); }
...
struct i16x8 { // 8xint16
	...
	i16x8& Load(ukk ptr)   { data = vld1q_s16((int16_t *)ptr); return *this; }
	i16x8& Load64(ukk ptr) { data = vcombine_s16(vld1_s16((int16_t *)ptr), vdup_n_s16(0)); return *this; }
	i16x8& Load32(ukk ptr) { data = vreinterpretq_s16_s32(vsetq_lane_s32(*(int32_t *)ptr, vdupq_n_s32(0), 0)); return *this; }

	void   Store(uk ptr)      { vst1q_s16((int16_t *)ptr, data); }
	void   Store64(uk ptr)    { vst1_s16((int16_t *)ptr, vget_low_s16(data)); }
	void   Store32(uk ptr)    { *(int32_t *)ptr = vgetq_lane_s32(vreinterpretq_s32_s16(data), 0); }
	...
	i16x8(i32 v)                 { data = vsetq_lane_s16(v, vdupq_n_s16(0), 0); }
	i16x8(i32 a, i32 b, i32 c, i32 d, i32 e, i32 f, i32 g, i32 h) {
...
force_inline i16x8  i16all(i32 v)                  { return vdupq_n_s16(v); }
...
force_inline i16x8  operator>>(i16x8 a, i32 b)     { return vreinterpretq_s16_u16(vshlq_u16(vreinterpretq_u16_s16(a), vdupq_n_s16(-b))); }
force_inline i16x8& operator>>=(i16x8& a, i32 b)   { return a = a >> b; }
force_inline i16x8  operator<<(i16x8 a, i32 b)     { return vshlq_s16(a, vdupq_n_s16(b)); }
force_inline i16x8& operator<<=(i16x8& a, i32 b)   { return a = a << b; }
...
struct i32x4 { // 4xint32
	...
	i32x4& Load(ukk ptr)   { data = vld1q_s32((int32_t *)ptr); return *this; }
	i32x4& Load64(ukk ptr) { data = vcombine_s32(vld1_s32((int32_t *)ptr), vdup_n_s32(0)); return *this; }
	i32x4& Load32(ukk ptr) { data = vsetq_lane_s32(*(int32_t *)ptr, vdupq_n_s32(0), 0); return *this; }

	void   Store(uk ptr)      { vst1q_s32((int32_t *)ptr, data); }
	void   Store64(uk ptr)    { vst1_s32((int32_t *)ptr, vget_low_s32(data)); }
	void   Store32(uk ptr)    { *(int32_t *)ptr = vgetq_lane_s32(data, 0); }
	...
	i32x4(i32 v)                 { data = vsetq_lane_s32(v, vdupq_n_s32(0), 0); }
	...
	operator i32()               { return vgetq_lane_s32(data, 0); }
	operator i16x8() const       { return i16x8(data); }
};

force_inline i32x4  i32all(i32 v)                 { return vdupq_n_s32(v); }
...
force_inline i32x4  operator>>(i32x4 a, i32 b)     { return vshlq_s32(a, vdupq_n_s32(-b)); }
...
struct i8x16 { // 16*i8
	...
	i8x16& Load(ukk ptr)   { data = vld1q_s8((int8_t *)ptr); return *this; }
	i8x16& Load64(ukk ptr) { data = vcombine_s8(vld1_s8((int8_t *)ptr), vdup_n_s8(0)); return *this; }
	i8x16& Load32(ukk ptr) { data = vreinterpretq_s8_s32(vsetq_lane_s32(*(int32_t *)ptr, vdupq_n_s32(0), 0)); return *this; }

	void   Store(uk ptr)      { vst1q_s8((int8_t *)ptr, data); }
	void   Store64(uk ptr)    { vst1_s32((int32_t *)ptr, vget_low_s32(vreinterpretq_s32_s8(data))); }
	void   Store32(uk ptr)    { *(int32_t *)ptr = vgetq_lane_s32(vreinterpretq_s32_s8(data), 0); }
	...
	i8x16(i32 v)                 { data = vsetq_lane_s8(v, vdupq_n_s8(0), 0); }
...
force_inline i8x16  i8all(i32 v)                  { return vdupq_n_s8(v); }
