...
[s0; [^topic`:`/`/Core`/srcdoc`/Core2016`_ru`-ru`#3^ 3. Callback changes]&]
[s0; [^topic`:`/`/Core`/srcdoc`/Core2016`_ru`-ru`#4^ 4. Algorithms 
and Containers]&]
[s0; [^topic`:`/`/Core`/srcdoc`/Core2016`_ru`-ru`#5^ 5. Tuple]&]
[s0; [^topic`:`/`/Core`/srcdoc`/Core2016`_ru`-ru`#6^ 6. Changes in 
r`-value and pick]&]
[s0; [^topic`:`/`/Core`/srcdoc`/Core2016`_ru`-ru`#7^ 7. Smaller improvements]&]
[s0; &]
[s3;:1: 1. Allocator&]
