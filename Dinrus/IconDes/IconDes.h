...
#include <Dinrus/RichEdit/RichEdit.h>
#include <Dinrus/plugin/bmp/bmp.h>

namespace Upp {

#define IMAGECLASS IconDesImg
#define IMAGEFILE <Dinrus/IconDes/IconDes.iml>
#include <Dinrus/Draw/iml_header.h>

#define LAYOUTFILE <Dinrus/IconDes/IconDes.lay>
...
#include             <Dinrus/CtrlLib/key_header.h>
