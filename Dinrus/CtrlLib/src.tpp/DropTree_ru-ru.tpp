topic "Класс DropTree (ВыпадающееДерево)";
...
[s2;%RU-RU Триггируется перед выпадением 
дерева. Можно использовать для заполнения 
дерева прямо перед его отображением.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:DropTree`:`:Clear`(`): [@(0.0.255) void]_[* Clear]()&]
[s2;%RU-RU Очищает дерево и присваивает 
ему значение Null.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:DropTree`:`:TreeObject`(`): [_^Upp`:`:PopUpTree^ PopUpTree][@(0.0.255) `&]_[* T
reeObject]()&]
[s2;%RU-RU Возвращает объект TreeCtrl (PopUpTree 
`- это класс с новыми деталями реализации, 
публично произведённый от класса 
TreeCtrl), добавляя управление деревом. 
Иной способ доступа к методам TreeCtrl 
`- через оператор `->.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:DropTree`:`:operator`-`>`(`): [_^Upp`:`:TreeCtrl^ TreeCtrl]_`*[* operator`->](
)&]
[s5;:Upp`:`:DropTree`:`:operator`-`>`(`)const: [@(0.0.255) const]_[_^Upp`:`:TreeCtrl^ Tre
eCtrl]_`*[* operator`->]()_[@(0.0.255) const]&]
[s2;%RU-RU Доступ к методам TreeCtrl.&]
[s3; &]
[s4; &]
...
`"всплывающего выпадающего`" TreeCtrl`'а 
в пикселях.&]
[s4; &]
[s5;:Upp`:`:DropTree`:`:AutoResize`(bool`): [_^Upp`:`:DropTree^ DropTree][@(0.0.255) `&]_
[* AutoResize]([@(0.0.255) bool]_[*@3 b]_`=_[@(0.0.255) true])&]
[s2;%RU-RU Если активен, размер выпадающего 
TreeCtrl`'а меняется в зависимости от 
реальных нужд (bно никогда не превышает 
лимит MaxHeight).&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Устанавливает отдельный дисплей 
для выделенного значения. Дефолтно 
используется дисплей TreeCtrl`'а.&]
[s3;%RU-RU &]
[s4; &]
[s5;:Upp`:`:DropTree`:`:DropFocus`(bool`): [_^Upp`:`:DropTree^ DropTree][@(0.0.255) `&]_[* D
ropFocus]([@(0.0.255) bool]_[*@3 b]_`=_[@(0.0.255) true])&]
[s2;%RU-RU Если активен, нажатие кнопки выпадения 
устанавливает фокус на виджет DropTree. 
Дефолтно неактивен.&]
[s3;%RU-RU &]
[s4; &]
...
[s2;%RU-RU Устанавливает MaxHeight с аргументом 
вычисленным для отображения максимум 
[%-*@3 d] строк стандартным шрифтом (напр., 
текст со стандартным дисплеем).&]
[s3;%RU-RU &]
[s4; &]
[s5;:Upp`:`:DropTree`:`:DropWidth`(int`): [_^Upp`:`:DropTree^ DropTree][@(0.0.255) `&]_[* D
ropWidth]([@(0.0.255) int]_[*@3 w])&]
[s2;%RU-RU Меняет ширину всплывающего TreeCtrl 
на [%-*@3 w] пикселей (обычно она равна 
ширине виджета DropTree).&]
[s3;%RU-RU &]
[s4; &]
[s5;:Upp`:`:DropTree`:`:DropWidthZ`(int`): [_^Upp`:`:DropTree^ DropTree][@(0.0.255) `&]_[* D
ropWidthZ]([@(0.0.255) int]_[*@3 w])&]
[s2;%RU-RU То же, что и DropWidth(Zx([%-*@3 w])).&]
[s3;%RU-RU &]
[s0;%RU-RU ]]