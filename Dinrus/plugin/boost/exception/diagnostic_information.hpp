...
#include <Dinrus/plugin/boost/exception/get_error_info.hpp>
#include <Dinrus/plugin/boost/exception/info.hpp>
#include <Dinrus/plugin/boost/utility/enable_if.hpp>
...
#include <Dinrus/plugin/boost/exception/current_exception_cast.hpp>
#endif
