...
#  define BOOST_ABI_PREFIX <Dinrus/plugin/boost/config/abi/msvc_prefix.hpp>
#endif
#ifndef BOOST_ABI_SUFFIX
#  define BOOST_ABI_SUFFIX <Dinrus/plugin/boost/config/abi/msvc_suffix.hpp>
#endif
...
#include <Dinrus/plugin/boost/config/pragma_message.hpp>
