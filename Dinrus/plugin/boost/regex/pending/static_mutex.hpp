...
#include <Dinrus/plugin/boost/regex/config.hpp> // dll import/export options.
...
#include <Dinrus/plugin/boost/cstdint.hpp>
...
//
#define BOOST_REGEX_H1 <Dinrus/plugin/boost/thread/once.hpp>
#define BOOST_REGEX_H2 <Dinrus/plugin/boost/thread/recursive_mutex.hpp>
#define BOOST_REGEX_H3 <Dinrus/plugin/boost/thread/lock_types.hpp>
