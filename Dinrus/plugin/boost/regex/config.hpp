...
#if !defined(BOOST_REGEX_STANDALONE) && !__has_include(<Dinrus/plugin/boost/version.hpp>)
...
#  include <Dinrus/plugin/boost/regex/config/borland.hpp>
#endif
#ifndef BOOST_REGEX_STANDALONE
#include <Dinrus/plugin/boost/version.hpp>
#endif
...
#else
#include <Dinrus/plugin/boost/assert.hpp>
...
#     define BOOST_REGEX_USER_CONFIG <Dinrus/plugin/boost/regex/user.hpp>
#  endif

#  include BOOST_REGEX_USER_CONFIG

#ifndef BOOST_REGEX_STANDALONE
#  include <Dinrus/plugin/boost/config.hpp>
#  include <Dinrus/plugin/boost/predef.h>
#endif

#else
   /*
    * C build,
    * don't include <Dinrus/plugin/boost/config.hpp> because that may
...
#  include <Dinrus/plugin/boost/regex/config/cwchar.hpp>
#endif
...
#  endif
#  include <Dinrus/plugin/boost/config/auto_link.hpp>
#endif
#endif
...
#include <stdexcept>
#include <string>
#include <Dinrus/plugin/boost/throw_exception.hpp>
