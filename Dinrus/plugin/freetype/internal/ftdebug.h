...
#define DLG_STATIC
#include <Dinrus/plugin/freetype/dlg/output.h>
#include <Dinrus/plugin/freetype/dlg/dlg.h>

#include <Dinrus/plugin/freetype/ftlogging.h>
...
#define FT_TRACE_DEF( x )  trace_ ## x ,
  ...
  {
#include <Dinrus/plugin/freetype/internal/fttrace.h>
    trace_count
