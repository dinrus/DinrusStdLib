...
FT_BEGIN_HEADER
   ...
   *   own projects.
   *
   * - Copy the file <Dinrus/plugin/freetype/ft2build.h> to `$BUILD/ft2build.h` and modify it
   *   slightly to pre-define the macro `FT_CONFIG_OPTIONS_H` used to locate
   *   this file during the build.  For example,
   *
   *   ```
   *     #define FT_CONFIG_OPTIONS_H  <myftoptions.h>
   *     #include <Dinrus/plugin/freetype/config/ftheader.h>
   *   ```
   *
   ...
   *   default, this file is `<Dinrus/plugin/freetype/config/ftmodule.h>`.
   *
