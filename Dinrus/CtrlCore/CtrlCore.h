...
#include <Dinrus/RichText/RichText.h>
#include <Dinrus/Painter/Painter.h>
...
#include <Dinrus/guiplatform.h>
	...
	#ifdef flagTURTLE
		#define GUIPLATFORM_KEYCODES_INCLUDE <Dinrus/Turtle/Keys.h>
		//need to make SDL_keysym.h known before K_ enum
		#define GUIPLATFORM_INCLUDE          <Dinrus/Turtle/Turtle.h>
		#define GUIPLATFORM_NOSCROLL
		#define PLATFORM_TURTLE
		#define TURTLE
	#elif VIRTUALGUI
		#define GUIPLATFORM_KEYCODES_INCLUDE <Dinrus/VirtualGui/Keys.h>
		#define GUIPLATFORM_INCLUDE          <Dinrus/VirtualGui/VirtualGui.h>
	#elif PLATFORM_COCOA
...
#define IMAGEFILE <Dinrus/CtrlCore/CtrlCore.iml>
...
#include <Dinrus/CtrlCore/TopWindow.h>
