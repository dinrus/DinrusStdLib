...
[s9; Этот класс добавляет классу RasterEncoder 
методы, необходимые для работы с потоками 
изображений.&]
[s3; &]
[s0; &]
...
[s2; Устанавливает Stream, используемый 
как источник данных изображений. 
Производный класс может опрашивать 
этот поток, методом GetStream.&]
[s3; &]
[s4;%- &]
...
[*@3 raster])&]
[s2; Сохраняет [%-*@3 raster ]в файл [%-*@3 fn].&]
[s3; &]
[s4; &]
[s5;:StreamRasterEncoder`:`:SaveString`(Raster`&`):%- [_^String^ String]_[* SaveString]([_^Raster^ R
aster][@(0.0.255) `&]_[*@3 raster])&]
[s2; Сохраняет [%-*@3 raster] в память и возвращает 
итоговые двоичные данные как String.&]
[s3; &]
[s4; &]
