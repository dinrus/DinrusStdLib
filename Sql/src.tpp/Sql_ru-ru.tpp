...
[s2; Возвращает the associated SqlSession.&]
[s3; &]
[s4; &]
[s5;:Sql`:`:GetDialect`(`)const:%- [@(0.0.255) int]_[* GetDialect]()_[@(0.0.255) const]&]
[s2; Возвращает the SQL dialect of associated SqlSession.&]
[s3; &]
[s4; &]
