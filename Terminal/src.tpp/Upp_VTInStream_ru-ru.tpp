...
[{_} 
[ {{10000@(113.42.0) [s0;%RU-RU [*@7;4 Класс VTInStream]]}}&]
[s0; &]
[s1;:Upp`:`:VTInStream`:`:class: [@(0.0.255)3 class][3 _][*3 VTInStream][3 _:_][@(0.0.255)3 publ
ic][3 _][*@3;3 MemReadStream]&]
[s2;%RU-RU This class encapsulates a reliable and high`-performance 
VT500 series “lexical” parser designed specifically for handling 
...
[s2;%RU-RU &]
[s2;%RU-RU VTInStream can handle UTF`-8 and non UTF`-8 characters, 
C0 and C1 control bytes, and ESC, CSI, DCS, OSC, and APC sequences 
...
8])&]
[s2;%RU-RU Parses a [%-*@3 data] string, or a [%-*@3 data].buffer with 
given [%-*@3 size]. The parser will switch to UTF`-8 mode when 
the [%-*@3 utf8] flag is enabled and this flag can be enabled or 
disabled run`-time. Important note: VTInStream has no explicit 
error state. It will ignore the remaining bytes of the erroneous 
sequence if it encounters any. Still, it is possible to reset 
the parser to its initial state at any moment, using the [^topic`:`/`/Terminal`/src`/Upp`_VTInStream`_en`-us`#Upp`:`:VTInStream`:`:Reset`(`)^ R
eset()] method.&]
[s3;%RU-RU &]
[s4; &]
[s5;:Upp`:`:VTInStream`:`:Reset`(`): [@(0.0.255) void]_[* Reset]()&]
[s2;%RU-RU Resets the parser to its initial state.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:VTInStream`:`:WasChr`(`)const: [@(0.0.255) bool]_[* WasChr]()_[@(0.0.255) const
]&]
[s2;%RU-RU Returns true if the last item was a character and not 
a sequence.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:VTInStream`:`:WhenChr: [_^Upp`:`:Event^ Event]<[@(0.0.255) int]>_[* WhenChr]&]
[s2;%RU-RU This event is dispatched when a UTF`-8 or non UTF`-8 character 
is received.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:VTInStream`:`:WhenCtl: [_^Upp`:`:Event^ Event]<[_^Upp`:`:byte^ byte]>_[* WhenCt
l]&]
[s2;%RU-RU This event is dispatched when a control byte (either in 
0x00`-0x7F range or in 0x80`-0x9F range) is received. &]
[s3; &]
[s4; &]
[s5;:Upp`:`:VTInStream`:`:WhenEsc: [_^Upp`:`:Event^ Event]<[@(0.0.255) const]_VTInStream`:
:Sequence[@(0.0.255) `&]>_[* WhenEsc]&]
[s2;%RU-RU This event is dispatched when an escape sequence is received.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:VTInStream`:`:WhenCsi: [_^Upp`:`:Event^ Event]<[@(0.0.255) const]_VTInStream`:
:Sequence[@(0.0.255) `&]>_[* WhenCsi]&]
[s2;%RU-RU This event is dispatched when a control function is received.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:VTInStream`:`:WhenDcs: [_^Upp`:`:Event^ Event]<[@(0.0.255) const]_VTInStream`:
:Sequence[@(0.0.255) `&]>_[* WhenDcs]&]
[s2;%RU-RU This event is dispatched when a device control string 
is received.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:VTInStream`:`:WhenOsc: [_^Upp`:`:Event^ Event]<[@(0.0.255) const]_VTInStream`:
:Sequence[@(0.0.255) `&]>_[* WhenOsc]&]
[s2;%RU-RU This event is dispatched when an operating system command 
is received.&]
[s3;%RU-RU &]
[s4; &]
[s5;:Upp`:`:VTInStream`:`:WhenApc: [_^Upp`:`:Event^ Event]<[@(0.0.255) const]_VTInStream`:
:Sequence[@(0.0.255) `&]>_[* WhenApc]&]
[s2;%RU-RU This event is dispatched when an application programming 
command is received.&]
[s3; &]
[s3; &]
...
[s3; &]
[s0; &]
[ {{10000@(113.42.0) [s0;%RU-RU [*@7;4 VTInStream`::Sequence]]}}&]
[s0;%RU-RU &]
[s1;:Upp`:`:VTInStream`:`:Sequence`:`:struct: [@(0.0.255)3 struct][3 _][*3 Sequence]&]
[s2;%RU-RU This structure represents a ESC, CSI, DCS, or OSC sequence, 
depending on the VTInStream context.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:VTInStream`:`:Sequence`:`:type: [_^Upp`:`:byte^ byte]_[* type]&]
[s2;%RU-RU Represents the type of the sequence. Currently the valid 
values are ESC, CSI, DCS, OSC, and APC.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:VTInStream`:`:Sequence`:`:opcode: [_^Upp`:`:byte^ byte]_[* opcode]&]
[s2;%RU-RU Also known as the `"final`" or `"terminator`" byte. Usually 
represents the opcode of received function.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:VTInStream`:`:Sequence`:`:mode: [_^Upp`:`:byte^ byte]_[* mode]&]
[s2;%RU-RU Contains the context`-dependent mode information of the 
given sequence. E.g. for private (DEC/xterm) functions or modes 
this is usually, but not always, a 0x3F (question mark).&]
[s3; &]
[s4; &]
[s5;:Upp`:`:VTInStream`:`:Sequence`:`:intermediate: [_^Upp`:`:byte^ byte]_[* intermediate
][@(0.0.255) `[][@3 4][@(0.0.255) `]]&]
[s2;%RU-RU Contains the collected intermediate bytes specific to 
the given sequence. Allows up to 4 intermediary bytes. (Historically, 
max 2 bytes are used.)&]
[s3; &]
[s4; &]
[s5;:Upp`:`:VTInStream`:`:Sequence`:`:parameters: [_^Upp`:`:Vector^ Vector]<[_^Upp`:`:String^ S
tring]>_[* parameters]&]
[s2;%RU-RU Contains the function parameters specific to CSI or DCS 
sequences, in a vectorized form. Note that this vector can contain 
empty strings that usually mean an implicit default value, depending 
on the sequence`'s context.&]
[s3;%RU-RU &]
[s4; &]
[s5;:Upp`:`:VTInStream`:`:Sequence`:`:payload: [_^Upp`:`:String^ String]_[* payload]&]
[s2;%RU-RU Contains any addtional data to be parsed by client code. 
For example, operating system commands and the string component 
of the device control strings are handed to client code via this 
member variable.&]
[s3; &]
[s4; &]
...
[s2;%RU-RU A convenience method for parsing integer parameters. [%-*@3 n] 
...
[s2;%RU-RU The same as above but for string parameters. [%-*@3 n ] 
is the index of the sequence parameter. Returns a void string 
for erroneous, out`-of`-bounds, or empty (defaulted) sequence 
parameters.&]
[s3;%RU-RU &]
[s4; &]
[s5;:Upp`:`:VTInStream`:`:Sequence`:`:ToString`(`)const: [_^Upp`:`:String^ String]_[* ToS
tring]()_[@(0.0.255) const]&]
[s2;%RU-RU Returns the sequence as a String. Useful for diagnostics 
and logging.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:VTInStream`:`:Sequence`:`:GetHashValue`(`)const: [_^Upp`:`:dword^ dword]_[* G
etHashValue]()_[@(0.0.255) const]&]
[s2;%RU-RU Returns a 32`-bit hash of the given sequence.&]
[s3; &]
[s4; &]
[s5;:Upp`:`:VTInStream`:`:Sequence`:`:Clear`(`): [@(0.0.255) void]_[* Clear]()&]
[s0;%RU-RU -|Clears the structure.]]