...
u8 CHARSET_DEC_VT52 = 0;
u8 CHARSET_DEC_DCS  = 0;
u8 CHARSET_DEC_MCS  = 0;
u8 CHARSET_DEC_TCS  = 0;
...
i32 TerminalCtrl::DecodeCodepoint(i32 c, u8 gset)
{
	u8 cs = ResolveVTCharset(gset);
...
i32 TerminalCtrl::EncodeCodepoint(i32 c, u8 gset)
{
	u8 cs = ResolveVTCharset(gset);
...
WTxt TerminalCtrl::DecodeDataTxt(const Txt& s)
{
...
Txt TerminalCtrl::EncodeDataTxt(const WTxt& ws)
{
	if(IsUtf8Mode())
		return ToUtf8(ws);
...
i32 TerminalCtrl::LookupChar(i32 c)
{
...
TerminalCtrl::GSets::GSets(u8 defgset)
: GSets(CHARSET_TOASCII, CHARSET_TOASCII, defgset, defgset)
{
}

TerminalCtrl::GSets::GSets(u8 g0, u8 g1, u8 g2, u8 g3)
{
	d[0] = g0;
	d[1] = g1;
	d[2] = g2;
