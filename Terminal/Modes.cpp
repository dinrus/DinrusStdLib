...
{
	for(const Txt& s : seq.parameters) {		// Multiple terminal modes can be set/reset at once.
		i32 modenum = StrInt(s);
...
void TerminalCtrl::XTasbm(i32 mode, bool b)
{
	modes.Set(XTASBM, b);
