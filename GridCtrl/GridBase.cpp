...
i32 GridCtrl::ItemRect::sortCol;
i32 GridCtrl::ItemRect::sortMode;
...
VecMap<Id, i32> *GridCtrl::ItemRect::aliases = NULL;
...
GridCtrl::ItemRect& GridCtrl::ItemRect::Alias(tukk  s)
{
	aliases->SetKey(id, s);
	return *this;
}

GridCtrl::ItemRect& GridCtrl::ItemRect::Name(Txt &s)
{
	(*items)[0][id].val = s;
	return *this;
}
...
GridCtrl::ItemRect& GridCtrl::ItemRect::Name(tukk  s)
{
	(*items)[0][id].val = s;
	return *this;
}

GridCtrl::ItemRect& GridCtrl::ItemRect::Size(i32 n, bool hv)
{
	hidden = n == 0;
...
GridCtrl::ItemRect& GridCtrl::ItemRect::Width(i32 n)
{
	return Size(n, true);
}

GridCtrl::ItemRect& GridCtrl::ItemRect::Height(i32 n)
{
	return Size(n, false);
}

GridCtrl::ItemRect& GridCtrl::ItemRect::Min(i32 n)
{
	if(hidden)
		return *this;
	min = n;
...
GridCtrl::ItemRect& GridCtrl::ItemRect::Max(i32 n)
{
	if(hidden)
		return *this;
	max = n;
...
GridCtrl::ItemRect& GridCtrl::ItemRect::Fixed(i32 n)
{
...
{
	i32 n = GetTextSize((Txt)(*items)[0][id].val, StdFont()).cx + 15;
	return Min(n).Max(n);
}
...
{
	if(++sortmode > 2) sortmode = (i32) !idsort;
}
...
GridCtrl::ItemRect& GridCtrl::ItemRect::Default(Val v)
{
	defval = v;
	return *this;
}
...
Txt GridCtrl::ItemRect::GetName() const
{
...
GridCtrl::ItemRect& GridCtrl::ItemRect::SetFormat(tukk fmt)
{
...
Val GridCtrl::ItemRect::ExtractVal(i32 r, i32 c) const
{
	const Val& v = (*items)[r][c].val;
	return IsType<AttrText>(v) ? Val(ValTo<AttrText>(v).text) : v;
}
