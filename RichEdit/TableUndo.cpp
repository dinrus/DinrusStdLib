...
RichEdit::UndoTableFormat::UndoTableFormat(const RichText& txt, i32 table)
: table(table)
{
...
RichEdit::UndoDestroyTable::UndoDestroyTable(const RichText& txt, i32 tab)
{
...
RichEdit::UndoRemoveParaSpecial::UndoRemoveParaSpecial(const RichText& txt, i32 table, bool before)
...
RichEdit::UndoTable::UndoTable(const RichText& txt, i32 tab)
{
	table = tab;
