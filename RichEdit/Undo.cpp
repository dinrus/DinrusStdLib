...
RichEdit::UndoInsert::UndoInsert(i32 pos, i32 length, bool typing)
...
RichEdit::UndoRemove::UndoRemove(const RichText& txt, i32 pos, i32 length)
: pos(pos)
{
...
RichEdit::UndoFormat::UndoFormat(const RichText& txt, i32 pos, i32 length)
