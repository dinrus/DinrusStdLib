...
struct TensorEvaluator<const TensorPairReducerOp<ReduceOp, Dims, ArgType>, Device>
{
  ...
  static constexpr i32 NumDims = internal::array_size<InputDimensions>::value;
  ...
  static constexpr i32 Layout = TensorEvaluator<const TensorReductionOp<ReduceOp, Dims, const TensorIndexPairOp<ArgType>>, Device>::Layout;
  //===- Tensor block evaluation strategy (see TensorBlock.h) -------------===//
  typedef internal::TensorBlockNotImplemented TensorBlock;
  //===--------------------------------------------------------------------===//
        ...
        m_return_dim(op.return_dim())
  {
    ...
    if (Layout == static_cast<i32>(ColMajor)) {
