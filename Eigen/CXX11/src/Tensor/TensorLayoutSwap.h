...
struct traits<TensorLayoutSwapOp<XprType> > : public traits<XprType>
{
  ...
  static constexpr i32 Layout = (traits<XprType>::Layout == ColMajor) ? RowMajor : ColMajor;
...
struct TensorEvaluator<const TensorLayoutSwapOp<ArgType>, Device>
{
  ...
  static constexpr i32 Layout = (TensorEvaluator<ArgType, Device>::Layout == static_cast<i32>(ColMajor)) ? RowMajor : ColMajor;
  enum {
