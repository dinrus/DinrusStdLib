...
struct traits<TensorReshapingOp<NewDimensions, XprType> > : public traits<XprType>
{
  ...
  static constexpr i32 NumDimensions = array_size<NewDimensions>::value;
...
struct TensorEvaluator<const TensorReshapingOp<NewDimensions, ArgType>, Device>
{
  ...
  static constexpr i32 NumOutputDims = internal::array_size<Dimensions>::value;
...
struct traits<TensorSlicingOp<StartIndices, Sizes, XprType> > : public traits<XprType>
{
  ...
  typedef typename XprType::Nested Nested;
  typedef std::remove_reference_t<Nested> Nested_;
  static constexpr i32 NumDimensions = array_size<StartIndices>::value;
  static constexpr i32 Layout = XprTraits::Layout;
  typedef typename XprTraits::PointerType PointerType;
};
...
struct TensorEvaluator<const TensorSlicingOp<StartIndices, Sizes, ArgType>, Device>
{
  ...
  static constexpr i32 NumDims = internal::array_size<Sizes>::value;
  ...
  {
    m_is_identity = true;
    for (i32 i = 0; i < internal::array_size<Dimensions>::value; ++i) {
...
struct TensorEvaluator<const TensorStridingSlicingOp<StartIndices, StopIndices, Strides, ArgType>, Device>
{
  ...
  static constexpr i32 NumDims = internal::array_size<Strides>::value;
  typedef typename XprType::Index Index;
  typedef typename XprType::Scalar Scalar;
  typedef typename XprType::CoeffReturnType CoeffReturnType;
  typedef typename PacketType<CoeffReturnType, Device>::type PacketReturnType;
