...
struct traits<TensorConcatenationOp<Axis, LhsXprType, RhsXprType> >
{
  ...
  static constexpr i32 NumDimensions = traits<LhsXprType>::NumDimensions;
...
struct TensorEvaluator<const TensorConcatenationOp<Axis, LeftArgType, RightArgType>, Device>
{
  ...
  static constexpr i32 NumDims = internal::array_size<typename TensorEvaluator<LeftArgType, Device>::Dimensions>::value;
  static constexpr i32 RightNumDims = internal::array_size<typename TensorEvaluator<RightArgType, Device>::Dimensions>::value;
  ...
  {
    EIGEN_STATIC_ASSERT((static_cast<i32>(TensorEvaluator<LeftArgType, Device>::Layout) == static_cast<i32>(TensorEvaluator<RightArgType, Device>::Layout) || NumDims == 1), YOU_MADE_A_PROGRAMMING_MISTAKE);
  ...
  {
    i32k packetSize = PacketType<CoeffReturnType, Device>::size;
  ...
  : public TensorEvaluator<const TensorConcatenationOp<Axis, LeftArgType, RightArgType>, Device>
{
  ...
  EIGEN_STRONG_INLINE TensorEvaluator(XprType& op, const Device& device)
    : Base(op, device)
  {
    EIGEN_STATIC_ASSERT((static_cast<i32>(Layout) == static_cast<i32>(ColMajor)), YOU_MADE_A_PROGRAMMING_MISTAKE);
  }
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE CoeffReturnType& coeffRef(Index index) const
  {
    ...
    for (i32 i = Base::NumDims - 1; i > 0; --i) {
