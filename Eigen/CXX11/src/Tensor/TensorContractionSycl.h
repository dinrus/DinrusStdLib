...
static EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
  ...
  EIGEN_CONSTEXPR i32 PacketSize = Eigen::internal::unpacket_traits<PacketType>::size;
  EIGEN_UNROLL_LOOP
...
struct BlockProperties {
  ...
  static EIGEN_CONSTEXPR i32 elements_per_access = Eigen::internal::unpacket_traits<OutType>::size;
  static EIGEN_CONSTEXPR bool is_coalesced_layout = !(is_transposed ^ is_rhs);
  static EIGEN_CONSTEXPR i32 nc_stride = (is_coalesced_layout ? elements_per_access : 1);
  static EIGEN_CONSTEXPR i32 c_stride = (is_coalesced_layout ? 1 : elements_per_access);
};
...
class TensorContractionKernel {
 public:
  typedef typename Eigen::TensorSycl::internal::Vectorise<OutScalar, Eigen::SyclDevice, Vectorizable>::PacketReturnType
      PacketReturnType;
  static EIGEN_CONSTEXPR i32 PacketSize =
...
struct GeneralVectorTensor {
  ...
  template <typename InputBlockProperties, bool is_internal_block, i32 CFactor, i32 GroupSize, typename Input,
            typename Local>
...
struct TensorEvaluator<const TensorContractionOp<Indices, LeftArgType, RightArgType, OutputKernelType>,
  ...
  static constexpr i32 LDims = Base::LDims;
  static constexpr i32 RDims = Base::RDims;
  static constexpr i32 ContractDims = Base::ContractDims;
