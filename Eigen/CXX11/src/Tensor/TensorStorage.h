...
/** \internal
  ...
  * \sa Tensor
  */
template<typename T, typename Dimensions, i32 Options> class TensorStorage;


// Pure fixed-size storage
template<typename T, typename FixedDimensions, i32 Options_>
class TensorStorage
{
 private:
...
// pure dynamic
template<typename T, typename IndexType, i32 NumIndices_, i32 Options_>
