...
namespace internal {
  ...
  struct is_base_of
  {
    ...
    static no check(B*, i32);

    static const bool value = sizeof(check(Host<B,D>(), i32())) == sizeof(yes);
  };
