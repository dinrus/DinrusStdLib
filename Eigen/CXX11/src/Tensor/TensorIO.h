...
struct TensorIOFormat {
  TensorIOFormat(const std::vector<std::string>& _separator, const std::vector<std::string>& _prefix,
                 const std::vector<std::string>& _suffix, i32 _precision = StreamPrecision, i32 _flags = 0,
  ...
  TensorIOFormat(i32 _precision = StreamPrecision, i32 _flags = 0, const std::string& _tenPrefix = "",
...
template <typename T, i32 Layout, i32 rank>
...
struct TensorPrinter {
  static void run(std::ostream& s, const Tensor& _t, const TensorIOFormat& fmt) {
    ...
    static i32k layout = Tensor::Layout;
    ...
    typedef std::conditional_t<is_same<Scalar, char>::value || is_same<Scalar, u8>::value ||
                          ...
                          std::conditional_t<is_same<Scalar, std::complex<char> >::value ||
                                                is_same<Scalar, std::complex<u8> >::value ||
                                                is_same<Scalar, std::complex<numext::int8_t> >::value ||
                                                is_same<Scalar, std::complex<numext::uint8_t> >::value,
                                        std::complex<i32>, const Scalar&>> PrintType;
