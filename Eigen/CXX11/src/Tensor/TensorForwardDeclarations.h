...
template<typename PlainObjectType, i32 Options_ = Unaligned, template <class> class MakePointer_ = MakePointer> class TensorMap;
template<typename Scalar_, i32 NumIndices_, i32 Options_ = 0, typename IndexType = DenseIndex> class Tensor;
template<typename Scalar_, typename Dimensions, i32 Options_ = 0, typename IndexType = DenseIndex> class TensorFixedSize;
template<typename PlainObjectType> class TensorRef;
template<typename Derived, i32 AccessLevel> class TensorBase;
...
template<typename FFT, typename XprType, i32 FFTDataType, i32 FFTDirection> class TensorFFTOp;
