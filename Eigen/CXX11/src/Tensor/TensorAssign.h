...
struct traits<TensorAssignOp<LhsXprType, RhsXprType> >
{
  ...
  static constexpr i32 Layout = internal::traits<LhsXprType>::Layout;
...
class TensorAssignOp : public TensorBase<TensorAssignOp<LhsXprType, RhsXprType> >
{
  ...
  static constexpr i32 NumDims = Eigen::internal::traits<TensorAssignOp>::NumDimensions;
...
struct TensorEvaluator<const TensorAssignOp<LeftArgType, RightArgType>, Device>
{
  ...
  static constexpr i32 NumDims = XprType::NumDims;
  ...
  {
    EIGEN_STATIC_ASSERT(
        (static_cast<i32>(TensorEvaluator<LeftArgType, Device>::Layout) ==
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void evalPacket(Index i) const {
    ...
    i32k LhsStoreMode = TensorEvaluator<LeftArgType, Device>::IsAligned ? Aligned : Unaligned;
    i32k RhsLoadMode = TensorEvaluator<RightArgType, Device>::IsAligned ? Aligned : Unaligned;
