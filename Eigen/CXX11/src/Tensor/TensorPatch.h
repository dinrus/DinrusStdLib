...
struct TensorEvaluator<const TensorPatchOp<PatchDim, ArgType>, Device>
{
  ...
  static constexpr i32 NumDims = internal::array_size<typename TensorEvaluator<ArgType, Device>::Dimensions>::value + 1;
  ...
  {
    Index output_stride_index = (static_cast<i32>(Layout) == static_cast<i32>(ColMajor)) ? NumDims - 1 : 0;
