...
struct ThreadPoolDevice {
  ...
  ThreadPoolDevice(ThreadPoolInterface* pool, i32 num_cores, Allocator* allocator = nullptr)
  ...
  EIGEN_STRONG_INLINE void memcpy(void* dst, const void* src, size_t n) const {
    ...
    if (n <= kMinBlockSize || num_threads < 2) {
      ...
      Barrier barrier(static_cast<i32>(num_threads - 1));
  ...
  EIGEN_STRONG_INLINE void memset(void* buffer, i32 c, size_t n) const {
    ::memset(buffer, c, n);
  }
  ...
  EIGEN_STRONG_INLINE i32 numThreads() const {
    return num_threads_;
  }
  ...
  EIGEN_STRONG_INLINE i32 numThreadsInPool() const {
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE i32 majorDeviceVersion() const {
  ...
  EIGEN_STRONG_INLINE i32 currentThreadId() const {
  ...
  void parallelFor(Index n, const TensorOpCost& cost,
    ...
    // Compute small problems directly in the caller thread.
               ...
               CostModel::numThreads(n, cost, static_cast<i32>(numThreads())) == 1) {
      f(0, n);
      return;
    }
    ...
    Barrier barrier(static_cast<u32>(block.count));
 ...
 private:
  ...
  ParallelForBlock CalculateParallelForBlock(
    ...
    double max_efficiency =
        ...
        (divup<i32>(block_count, numThreads()) * numThreads());
    ...
    for (Index prev_block_count = block_count;
      ...
      const double coarser_efficiency =
          ...
          (divup<i32>(coarser_block_count, numThreads()) * numThreads());
