...
template <typename T> struct SumReducer
{
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE T initialize() const {
    internal::scalar_cast_op<i32, T> conv;
    return conv(0);
  }
  template <typename Packet>
...
template <typename T, i32 NaNPropagation=PropagateFast> struct MaxReducer
{
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void reduce(const T t, T* accum) const {
...
template <typename T, typename Device, i32 NaNPropagation>
...
template <typename T, i32 NaNPropagation=PropagateFast> struct MinReducer
{
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void reduce(const T t, T* accum) const {
