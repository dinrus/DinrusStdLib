...
template<typename PlainObjectType, i32 Options_, template <class> class MakePointer_> class TensorMap : public TensorBase<TensorMap<PlainObjectType, Options_, MakePointer_> >
{
  public:
   ...
   typedef typename internal::traits<PlainObjectType>::StorageKind StorageKind;
    ...
    static constexpr i32 Layout = PlainObjectType::Layout;
    enum {
      IsAligned = ((i32(Options_)&Aligned)==Aligned),
      CoordAccess = true,
      RawAccess = true
    };
