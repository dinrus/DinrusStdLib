...
struct TensorEvaluator
{
  ...
  static constexpr i32 NumCoords = internal::traits<Derived>::NumDimensions > 0 ?
                                   internal::traits<Derived>::NumDimensions : 0;
  static constexpr i32 Layout = Derived::Layout;
  ...
  template<i32 LoadMode> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
  ...
  template <i32 StoreMode> EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
struct TensorEvaluator<const Derived, Device>
{
  ...
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE CoeffReturnType coeff(const array<DenseIndex, NumCoords>& coords) const {
    eigen_assert(m_data != NULL);
    const Index index = (static_cast<i32>(Layout) == static_cast<i32>(ColMajor)) ? m_dims.IndexOfColMajor(coords)
...
struct TensorEvaluator<const TensorCwiseUnaryOp<UnaryOp, ArgType>, Device>
{
  ...
  enum {
    ...
    PacketAccess       = i32(TensorEvaluator<ArgType, Device>::PacketAccess) &
                         i32(internal::functor_traits<UnaryOp>::PacketAccess),
  ...
  typedef StorageMemory<CoeffReturnType, Device> Storage;
  typedef typename Storage::Type EvaluatorPointerType;
  static constexpr i32 NumDims = internal::array_size<Dimensions>::value;
...
struct TensorEvaluator<const TensorCwiseBinaryOp<BinaryOp, LeftArgType, RightArgType>, Device>
{
  ...
  enum {
    IsAligned         = i32(TensorEvaluator<LeftArgType, Device>::IsAligned) &
                        i32(TensorEvaluator<RightArgType, Device>::IsAligned),
    PacketAccess      = i32(TensorEvaluator<LeftArgType, Device>::PacketAccess) &
                        i32(TensorEvaluator<RightArgType, Device>::PacketAccess) &
                        i32(internal::functor_traits<BinaryOp>::PacketAccess),
    BlockAccess       = i32(TensorEvaluator<LeftArgType, Device>::BlockAccess) &
                        i32(TensorEvaluator<RightArgType, Device>::BlockAccess),
    PreferBlockAccess = i32(TensorEvaluator<LeftArgType, Device>::PreferBlockAccess) |
                        i32(TensorEvaluator<RightArgType, Device>::PreferBlockAccess),
    CoordAccess       = false,  // to be implemented
    RawAccess         = false
  };
  ...
  {
    EIGEN_STATIC_ASSERT((static_cast<i32>(TensorEvaluator<LeftArgType, Device>::Layout) == static_cast<i32>(TensorEvaluator<RightArgType, Device>::Layout) || internal::traits<XprType>::NumDimensions <= 1), YOU_MADE_A_PROGRAMMING_MISTAKE);
  ...
  static constexpr i32 NumDims = internal::array_size<
...
struct TensorEvaluator<const TensorCwiseTernaryOp<TernaryOp, Arg1Type, Arg2Type, Arg3Type>, Device>
{
  ...
  static constexpr i32 Layout = TensorEvaluator<Arg1Type, Device>::Layout;
  enum {
  ...
  {
    EIGEN_STATIC_ASSERT((static_cast<i32>(TensorEvaluator<Arg1Type, Device>::Layout) == static_cast<i32>(TensorEvaluator<Arg3Type, Device>::Layout) || internal::traits<XprType>::NumDimensions <= 1), YOU_MADE_A_PROGRAMMING_MISTAKE);
...
struct TensorEvaluator<const TensorSelectOp<IfArgType, ThenArgType, ElseArgType>, Device>
{
  ...
  typedef typename XprType::Scalar Scalar;
    ...
    static constexpr i32 Layout = TensorEvaluator<IfArgType, Device>::Layout;
  enum {
  ...
  {
    EIGEN_STATIC_ASSERT((static_cast<i32>(TensorEvaluator<IfArgType, Device>::Layout) == static_cast<i32>(TensorEvaluator<ThenArgType, Device>::Layout)), YOU_MADE_A_PROGRAMMING_MISTAKE);
    EIGEN_STATIC_ASSERT((static_cast<i32>(TensorEvaluator<IfArgType, Device>::Layout) == static_cast<i32>(TensorEvaluator<ElseArgType, Device>::Layout)), YOU_MADE_A_PROGRAMMING_MISTAKE);
