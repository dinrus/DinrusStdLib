...
template<typename ResScalar, typename LhsScalar, typename RhsScalar, typename StorageIndex, i32 ShardingType = ShardByCol>
 ...
 */
 ...
 TensorContractionBlocking(StorageIndex k, StorageIndex m, StorageIndex n, StorageIndex num_threads = 1) :
      kc_(k), mc_(m), nc_(n)
  {
    ...
    i32k rhs_packet_size = internal::packet_traits<RhsScalar>::size;
