...
template<i32 One_, i32 Two_>
struct Symmetry
{
  static_assert(One_ != Two_, "Symmetries must cover distinct indices.");
  constexpr static i32 One = One_;
  constexpr static i32 Two = Two_;
  constexpr static i32 Flags = 0;
};
...
struct AntiSymmetry
{
  ...
  constexpr static i32 One = One_;
  constexpr static i32 Two = Two_;
  constexpr static i32 Flags = NegationFlag;
};
...
struct Hermiticity
{
  ...
  constexpr static i32 One = One_;
  constexpr static i32 Two = Two_;
  constexpr static i32 Flags = ConjugationFlag;
};
...
struct AntiHermiticity
{
  ...
  constexpr static i32 One = One_;
  constexpr static i32 Two = Two_;
  constexpr static i32 Flags = ConjugationFlag | NegationFlag;
};
...
template<i32 One_, i32 Two_, typename... Sym> struct tensor_symmetry_num_indices<Symmetry<One_, Two_>, Sym...>
{
private:
...
template<i32 One_, i32 Two_, typename... Sym> struct tensor_symmetry_num_indices<AntiSymmetry<One_, Two_>, Sym...>
  : public tensor_symmetry_num_indices<Symmetry<One_, Two_>, Sym...> {};
template<i32 One_, i32 Two_, typename... Sym> struct tensor_symmetry_num_indices<Hermiticity<One_, Two_>, Sym...>
  : public tensor_symmetry_num_indices<Symmetry<One_, Two_>, Sym...> {};
template<i32 One_, i32 Two_, typename... Sym> struct tensor_symmetry_num_indices<AntiHermiticity<One_, Two_>, Sym...>
  : public tensor_symmetry_num_indices<Symmetry<One_, Two_>, Sym...> {};
...
struct tensor_symmetry_assign_value
{
  ...
  static inline i32 run(const std::array<Index, NumIndices>& transformed_indices, i32 transformation_flags, i32 dummy, Tensor_& tensor, const Scalar& value_)
  {
    Scalar value(value_);
...
struct tensor_symmetry_calculate_flags
{
  ...
  static inline i32 run(const std::array<Index, NumIndices>& transformed_indices, i32 transform_flags, i32 current_flags, const std::array<Index, NumIndices>& orig_indices)
  {
...
template<typename Tensor_, typename Symmetry_, i32 Flags = 0>
class tensor_symmetry_value_setter
{
  ...
  private:
    ...
    inline void doAssign(Scalar const& value)
    {
        ...
        i32 value_flags = m_symmetry.template apply<internal::tensor_symmetry_calculate_flags<Tensor_>, i32>(m_indices, m_symmetry.globalFlags(), m_indices);
      ...
      #endif
      m_symmetry.template apply<internal::tensor_symmetry_assign_value<Tensor_>, i32>(m_indices, 0, m_tensor, value);
    }
};
