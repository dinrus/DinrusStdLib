...
template<i32... nn>
struct tensor_static_symgroup_permutate<numeric_list<i32, nn...>>
{
...
template<typename indices_, i32 flags_>
struct tensor_static_symgroup_element
{
  typedef indices_ indices;
  constexpr static i32 flags = flags_;
};

template<typename Gen, i32 N>
struct tensor_static_symgroup_element_ctor
{
  typedef tensor_static_symgroup_element<
    typename gen_numeric_list_swapped_pair<i32, N, Gen::One, Gen::Two>::type,
    Gen::Flags
  > type;
};
...
{
  typedef tensor_static_symgroup_element<
    typename gen_numeric_list<i32, N>::type,
    0
  > type;
};
...
{
  template<i32... iia>
  constexpr static inline numeric_list<i32, get<iia, iib>::value...> helper(numeric_list<i32, iia...>) {
    return numeric_list<i32, get<iia, iib>::value...>();
  }
};
...
struct tensor_static_symgroup_multiply
{
  private:
    ...
    constexpr static i32 ffa = A::flags;
    constexpr static i32 ffb = B::flags;
...
struct tensor_static_symgroup_equality
{
  ...
  private:
     ...
     */
    constexpr static i32 flags_cmp_ = ffa ^ ffb;
  ...
  public:
    constexpr static i32 global_flags = 
...
template<typename Index, std::size_t N, i32... ii, i32... jj>
constexpr static inline std::array<Index, N> tensor_static_symgroup_index_permute(std::array<Index, N> idx, internal::numeric_list<i32, ii...>, internal::numeric_list<i32, jj...>)
{
  return {{ idx[ii]..., idx[jj]... }};
}

template<typename Index, i32... ii>
static inline std::vector<Index> tensor_static_symgroup_index_permute(std::vector<Index> idx, internal::numeric_list<i32, ii...>)
{
...
struct tensor_static_symgroup_do_apply<internal::type_list<first, next...>>
{
  ...
  static inline RV run(const std::array<Index, NumIndices>& idx, RV initial, Args&&... args)
  {
    ...
    typedef typename internal::gen_numeric_list<i32, NumIndices - SGNumIndices, SGNumIndices>::type remaining_indices;
...
class StaticSGroup
{
  ...
  public:
    ...
    constexpr static inline i32 globalFlags() { return group_elements::global_flags; }
