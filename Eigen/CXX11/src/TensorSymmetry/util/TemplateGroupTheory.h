 ...
 * type_list<typename...> and numeric_list<typename = i32, i32...>
 * templates.
 *
...
struct strip_identities<Equality, id, type_list<t, ts...>>
{
  ...
  > type;
  constexpr static i32 global_flags = Equality<id, t>::global_flags | strip_identities<Equality, id, type_list<ts...>>::global_flags;
};
...
struct strip_identities<Equality, id, type_list<EIGEN_TPL_PP_SPEC_HACK_USE(ts)>>
{
  ...
  constexpr static i32 global_flags = 0;
};
...
#endif // EIGEN_PARSED_BY_DOXYGEN
{
  ...
  constexpr static i32 global_flags = Equality<current_element, id>::global_flags;
};
...
struct dimino_first_step_elements
{
  ...
  constexpr static i32 global_flags = helper::global_flags;
};
...
struct dimino_add_cosets_for_rep<Multiply, Equality, id, sub_group_elements, elements, type_list<g, gs...>, rep_element, sub_group_size>
{
  ...
  constexpr static i32 global_flags = _cil::global_flags | _helper::global_flags;
...
struct dimino_add_all_coset_spaces
{
  ...
  constexpr static i32 new_rep_pos = rep_pos + sub_group_elements::count;
  ...
  typedef typename _helper::type type;
  constexpr static i32 global_flags = _helper::global_flags | _ac4r::global_flags;
};
...
struct dimino_add_generator
{
  ...
  constexpr static i32 rep_pos = elements::count;
  ...
  > _helper;
  typedef typename _helper::type type;
  constexpr static i32 global_flags = _helper::global_flags;
};
