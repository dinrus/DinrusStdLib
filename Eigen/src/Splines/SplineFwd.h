...
namespace Eigen
{
    template <typename Scalar, i32 Dim, i32 Degree = Dynamic> class Spline;

    template < typename SplineType, i32 DerivativeOrder = Dynamic > struct SplineTraits {};

    /**
     * \ingroup Splines_Module
     * \brief Compile-time attributes of the Spline class for Dynamic degree.
     **/
    template <typename Scalar_, i32 Dim_, i32 Degree_>
     ...
     **/
    template < typename Scalar_, i32 Dim_, i32 Degree_, i32 _DerivativeOrder >
