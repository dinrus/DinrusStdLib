                                          ...
                                          typename NumTraits<typename internal::traits<internal::remove_all_t<DerivativeType>>::Scalar>::Real>::value>
{
  public:
    ...
    AutoDiffScalar(const Scalar& value, i32 nbDer, i32 derNumber)
...
template<typename A_Scalar, i32 A_Rows, i32 A_Cols, i32 A_Options, i32 A_MaxRows, i32 A_MaxCols, typename B>
...
template<typename A, typename B_Scalar, i32 B_Rows, i32 B_Cols, i32 B_Options, i32 B_MaxRows, i32 B_MaxCols>
...
template<typename A_Scalar, i32 A_Rows, i32 A_Cols, i32 A_Options, i32 A_MaxRows, i32 A_MaxCols,
         typename B_Scalar, i32 B_Rows, i32 B_Cols, i32 B_Options, i32 B_MaxRows, i32 B_MaxCols>
...
struct is_identically_zero_impl<AutoDiffScalar<DerivativeType>> {
  static inline bool run(const AutoDiffScalar<DerivativeType>& s)
  {
    ...
    for(i32 i=0; i<derivatives.size(); ++i)
    {
