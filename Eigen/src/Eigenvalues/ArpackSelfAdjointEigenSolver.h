...
public:
   ...
   *
   * This constructor calls compute(const MatrixType&, const MatrixType&, Index, string, i32, RealScalar)
  ...
  ArpackGeneralizedSelfAdjointEigenSolver(const MatrixType& A, const MatrixType& B,
                               ...
                               i32 options=ComputeEigenvectors, RealScalar tol=0.0)
    : m_eivec(),
      m_eivalues(),
      m_isInitialized(false),
      m_eigenvectorsOk(false),
   ...
   *    means machine precision.
   *
   * This constructor calls compute(const MatrixType&, Index, string, i32, RealScalar)
...
::compute(const MatrixType& A, Index nbrEigenvalues,
          std::string eigs_sigma, i32 options, RealScalar tol)
{
    MatrixType B(0,0);
    compute(A, B, nbrEigenvalues, eigs_sigma, options, tol);
          ...
          std::string eigs_sigma, i32 options, RealScalar tol)
{
  ...
  //
  i32 ncv = std::min(std::max(2*nev, 20), n);
  ...
  i32 lworkl = ncv*ncv+8*ncv; // Must be at least this length
  Scalar *workl = new Scalar[lworkl];

  i32 *iparam= new i32[11];
  iparam[0] = 1; // 1 means we let ARPACK perform the shifts, 0 means we'd have to do it
  iparam[2] = std::max(300, (i32)std::ceil(2*n/std::max(ncv,1)));
  ...
  else
  {
    ...
    //
    i32 rvec = (options & ComputeEigenvectors) == ComputeEigenvectors;
...
// Single precision
//
extern "C" void ssaupd_(i32 *ido, char *bmat, i32 *n, char *which,
    i32 *nev, float *tol, float *resid, i32 *ncv,
    float *v, i32 *ldv, i32 *iparam, i32 *ipntr,
    float *workd, float *workl, i32 *lworkl,
    i32 *info);

extern "C" void sseupd_(i32 *rvec, char *All, i32 *select, float *d,
    float *z, i32 *ldz, float *sigma, 
    char *bmat, i32 *n, char *which, i32 *nev,
    float *tol, float *resid, i32 *ncv, float *v,
    i32 *ldv, i32 *iparam, i32 *ipntr, float *workd,
    float *workl, i32 *lworkl, i32 *ierr);

// Double precision
//
extern "C" void dsaupd_(i32 *ido, char *bmat, i32 *n, char *which,
    i32 *nev, double *tol, double *resid, i32 *ncv,
    double *v, i32 *ldv, i32 *iparam, i32 *ipntr,
    double *workd, double *workl, i32 *lworkl,
    i32 *info);

extern "C" void dseupd_(i32 *rvec, char *All, i32 *select, double *d,
    double *z, i32 *ldz, double *sigma, 
    char *bmat, i32 *n, char *which, i32 *nev,
    double *tol, double *resid, i32 *ncv, double *v,
    i32 *ldv, i32 *iparam, i32 *ipntr, double *workd,
    double *workl, i32 *lworkl, i32 *ierr);
...
template<typename Scalar, typename RealScalar> struct arpack_wrapper
{
  static inline void saupd(i32 *ido, char *bmat, i32 *n, char *which,
      i32 *nev, RealScalar *tol, Scalar *resid, i32 *ncv,
      Scalar *v, i32 *ldv, i32 *iparam, i32 *ipntr,
      Scalar *workd, Scalar *workl, i32 *lworkl, i32 *info)
  { 
    EIGEN_STATIC_ASSERT(!NumTraits<Scalar>::IsComplex, NUMERIC_TYPE_MUST_BE_REAL)
  }

  static inline void seupd(i32 *rvec, char *All, i32 *select, Scalar *d,
      Scalar *z, i32 *ldz, RealScalar *sigma,
      char *bmat, i32 *n, char *which, i32 *nev,
      RealScalar *tol, Scalar *resid, i32 *ncv, Scalar *v,
      i32 *ldv, i32 *iparam, i32 *ipntr, Scalar *workd,
      Scalar *workl, i32 *lworkl, i32 *ierr)
  {
    EIGEN_STATIC_ASSERT(!NumTraits<Scalar>::IsComplex, NUMERIC_TYPE_MUST_BE_REAL)
  }
};
...
template <> struct arpack_wrapper<float, float>
{
  static inline void saupd(i32 *ido, char *bmat, i32 *n, char *which,
      i32 *nev, float *tol, float *resid, i32 *ncv,
      float *v, i32 *ldv, i32 *iparam, i32 *ipntr,
      float *workd, float *workl, i32 *lworkl, i32 *info)
  {
    ssaupd_(ido, bmat, n, which, nev, tol, resid, ncv, v, ldv, iparam, ipntr, workd, workl, lworkl, info);
  }

  static inline void seupd(i32 *rvec, char *All, i32 *select, float *d,
      float *z, i32 *ldz, float *sigma,
      char *bmat, i32 *n, char *which, i32 *nev,
      float *tol, float *resid, i32 *ncv, float *v,
      i32 *ldv, i32 *iparam, i32 *ipntr, float *workd,
...
template <> struct arpack_wrapper<double, double>
{
  static inline void saupd(i32 *ido, char *bmat, i32 *n, char *which,
      i32 *nev, double *tol, double *resid, i32 *ncv,
      double *v, i32 *ldv, i32 *iparam, i32 *ipntr,
      double *workd, double *workl, i32 *lworkl, i32 *info)
  {
    dsaupd_(ido, bmat, n, which, nev, tol, resid, ncv, v, ldv, iparam, ipntr, workd, workl, lworkl, info);
  }

  static inline void seupd(i32 *rvec, char *All, i32 *select, double *d,
      double *z, i32 *ldz, double *sigma,
      char *bmat, i32 *n, char *which, i32 *nev,
      double *tol, double *resid, i32 *ncv, double *v,
      i32 *ldv, i32 *iparam, i32 *ipntr, double *workd,
...
struct OP
{
    static inline void applyOP(MatrixSolver &OP, const MatrixType &A, i32 n, Scalar *in, Scalar *out);
    static inline void project(MatrixSolver &OP, i32 n, i32 k, Scalar *vecs);
};
