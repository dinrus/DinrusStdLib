...
template<typename VectorsType, typename CoeffsType, i32 Side>
...
template<typename VectorsType, typename CoeffsType, i32 Side> class HouseholderSequence
  : public EigenBase<HouseholderSequence<VectorsType,CoeffsType,Side> >
{
  ...
  public:
    ...
    template<typename VectorsType_, typename CoeffsType_, i32 Side_> friend struct internal::hseq_side_dependent_impl;
    ...
    template <typename VectorsType2, typename CoeffsType2, i32 Side2> friend class HouseholderSequence;
...
/** \brief Computes the product of a matrix with a Householder sequence.
  ...
  */
template<typename OtherDerived, typename VectorsType, typename CoeffsType, i32 Side>
