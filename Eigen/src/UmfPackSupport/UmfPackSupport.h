...
// generic double/complex<double> wrapper functions:
 ...
 // Defaults
inline void umfpack_defaults(double control[UMFPACK_CONTROL], double, i32)
{ umfpack_di_defaults(control); }

inline void umfpack_defaults(double control[UMFPACK_CONTROL], std::complex<double>, i32)
...
// Report info
inline void umfpack_report_info(double control[UMFPACK_CONTROL], double info[UMFPACK_INFO], double, i32)
{ umfpack_di_report_info(control, info);}

inline void umfpack_report_info(double control[UMFPACK_CONTROL], double info[UMFPACK_INFO], std::complex<double>, i32)
...
// Report status
inline void umfpack_report_status(double control[UMFPACK_CONTROL], i32 status, double, i32)
{ umfpack_di_report_status(control, status);}

inline void umfpack_report_status(double control[UMFPACK_CONTROL], i32 status, std::complex<double>, i32)
{ umfpack_zi_report_status(control, status);}

inline void umfpack_report_status(double control[UMFPACK_CONTROL], i32 status, double, SuiteSparse_long)
{ umfpack_dl_report_status(control, status);}

inline void umfpack_report_status(double control[UMFPACK_CONTROL], i32 status, std::complex<double>, SuiteSparse_long)
{ umfpack_zl_report_status(control, status);}

// report control
inline void umfpack_report_control(double control[UMFPACK_CONTROL], double, i32)
{ umfpack_di_report_control(control);}

inline void umfpack_report_control(double control[UMFPACK_CONTROL], std::complex<double>, i32)
...
// Free numeric
inline void umfpack_free_numeric(void **Numeric, double, i32)
{ umfpack_di_free_numeric(Numeric); *Numeric = 0; }

inline void umfpack_free_numeric(void **Numeric, std::complex<double>, i32)
...
// Free symbolic
inline void umfpack_free_symbolic(void **Symbolic, double, i32)
{ umfpack_di_free_symbolic(Symbolic); *Symbolic = 0; }

inline void umfpack_free_symbolic(void **Symbolic, std::complex<double>, i32)
...
// Symbolic
inline i32 umfpack_symbolic(i32 n_row,i32 n_col,
                            i32k Ap[], i32k Ai[], const double Ax[], void **Symbolic,
...
inline i32 umfpack_symbolic(i32 n_row,i32 n_col,
                            i32k Ap[], i32k Ai[], const std::complex<double> Ax[], void **Symbolic,
                            const double Control [UMFPACK_CONTROL], double Info [UMFPACK_INFO])
{
...
// Numeric
inline i32 umfpack_numeric( i32k Ap[], i32k Ai[], const double Ax[],
...
inline i32 umfpack_numeric( i32k Ap[], i32k Ai[], const std::complex<double> Ax[],
                            void *Symbolic, void **Numeric,
                            const double Control[UMFPACK_CONTROL],double Info [UMFPACK_INFO])
{
...
// solve
inline i32 umfpack_solve( i32 sys, i32k Ap[], i32k Ai[], const double Ax[],
...
inline i32 umfpack_solve( i32 sys, i32k Ap[], i32k Ai[], const std::complex<double> Ax[],
...
inline SuiteSparse_long umfpack_solve(i32 sys, const SuiteSparse_long Ap[], const SuiteSparse_long Ai[], const double Ax[],
                                      double X[], const double B[], void *Numeric,
                                      const double Control[UMFPACK_CONTROL], double Info[UMFPACK_INFO])
{
...
inline SuiteSparse_long umfpack_solve(i32 sys, const SuiteSparse_long Ap[], const SuiteSparse_long Ai[], const std::complex<double> Ax[],
                                      std::complex<double> X[], const std::complex<double> B[], void *Numeric,
                                      const double Control[UMFPACK_CONTROL], double Info[UMFPACK_INFO])
{
...
// Get Lunz
inline i32 umfpack_get_lunz(i32 *lnz, i32 *unz, i32 *n_row, i32 *n_col, i32 *nz_udiag, void *Numeric, double)
{
  return umfpack_di_get_lunz(lnz,unz,n_row,n_col,nz_udiag,Numeric);
}

inline i32 umfpack_get_lunz(i32 *lnz, i32 *unz, i32 *n_row, i32 *n_col, i32 *nz_udiag, void *Numeric, std::complex<double>)
{
...
// Get Numeric
inline i32 umfpack_get_numeric(i32 Lp[], i32 Lj[], double Lx[], i32 Up[], i32 Ui[], double Ux[],
                               i32 P[], i32 Q[], double Dx[], i32 *do_recip, double Rs[], void *Numeric)
{
  return umfpack_di_get_numeric(Lp,Lj,Lx,Up,Ui,Ux,P,Q,Dx,do_recip,Rs,Numeric);
}

inline i32 umfpack_get_numeric(i32 Lp[], i32 Lj[], std::complex<double> Lx[], i32 Up[], i32 Ui[], std::complex<double> Ux[],
                               i32 P[], i32 Q[], std::complex<double> Dx[], i32 *do_recip, double Rs[], void *Numeric)
{
...
// Get Determinant
inline i32 umfpack_get_determinant(double *Mx, double *Ex, void *NumericHandle, double User_Info [UMFPACK_INFO], i32)
{
  return umfpack_di_get_determinant(Mx,Ex,NumericHandle,User_Info);
}

inline i32 umfpack_get_determinant(std::complex<double> *Mx, double *Ex, void *NumericHandle, double User_Info [UMFPACK_INFO], i32)
{
...
class UmfPackLU : public SparseSolverBase<UmfPackLU<MatrixType_> >
{
  ...
  public:
    ...
    typedef Matrix<i32, 1, MatrixType::ColsAtCompileTime> IntRowVectorType;
    typedef Matrix<i32, MatrixType::RowsAtCompileTime, 1> IntColVectorType;
  ...
  public:
    ...
    /** Provides the return status code returned by UmfPack during the numeric
      ...
      * \sa factorize(), compute()
      */
    inline i32 umfpackFactorizeReturncode() const
    {
