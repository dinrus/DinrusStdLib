...
class MatrixPowerAtomic : internal::noncopyable
{
  private:
    ...
    void computePade(i32 degree, const MatrixType& IminusT, ResultType& res) const;
    void compute2x2(ResultType& res, RealScalar p) const;
    void computeBig(ResultType& res) const;
    static i32 getPadeDegree(float normIminusT);
    static i32 getPadeDegree(double normIminusT);
    static i32 getPadeDegree(long double normIminusT);
...
template<typename MatrixType>
void MatrixPowerAtomic<MatrixType>::computePade(i32 degree, const MatrixType& IminusT, ResultType& res) const
{
  i32 i = 2*degree;
...
{
  using std::ldexp;
  i32k digits = std::numeric_limits<RealScalar>::digits;
  ...
  i32 degree, degree2, numberOfSquareRoots = 0;
...
template<typename MatrixType>
inline i32 MatrixPowerAtomic<MatrixType>::getPadeDegree(float normIminusT)
{
...
template<typename MatrixType>
inline i32 MatrixPowerAtomic<MatrixType>::getPadeDegree(double normIminusT)
{
...
class MatrixPower : internal::noncopyable
{
  ...
  private:
    ...
    template<i32 Rows, i32 Cols, i32 Options, i32 MaxRows, i32 MaxCols>
