...
Scalar stem_function_exp(Scalar x, i32)
{
  using std::exp;
  return exp(x);
}
...
template <typename Scalar>
Scalar stem_function_cos(Scalar x, i32 n)
{
  using std::cos;
  using std::sin;
  Scalar res;
...
template <typename Scalar>
Scalar stem_function_sin(Scalar x, i32 n)
{
  using std::cos;
  using std::sin;
  Scalar res;
...
template <typename Scalar>
Scalar stem_function_cosh(Scalar x, i32 n)
{
  using std::cosh;
  using std::sinh;
  Scalar res;
...
template <typename Scalar>
Scalar stem_function_sinh(Scalar x, i32 n)
{
  using std::cosh;
  using std::sinh;
  Scalar res;
