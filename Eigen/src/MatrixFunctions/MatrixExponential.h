...
struct MatrixExponentialScalingOp
{
   ...
   */
  MatrixExponentialScalingOp(i32 squarings) : m_squarings(squarings) { }
...
struct matrix_exp_computeUV
{
  /** \brief Compute Pad&eacute; approximant to the exponential.
    ...
    */
  static void run(const MatrixType& arg, MatrixType& U, MatrixType& V, i32& squarings);
};
...
struct matrix_exp_computeUV<MatrixType, float>
{
  ...
  static void run(const ArgType& arg, MatrixType& U, MatrixType& V, i32& squarings)
  {
    using std::frexp;
    using std::pow;
