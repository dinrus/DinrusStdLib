...
struct matrix_log_max_pade_degree 
{
  ...
  static i32k value = std::numeric_limits<RealScalar>::digits<= 24?  5:  // single precision
...
inline i32 matrix_log_get_pade_degree(float normTminusI)
{
  const float maxNormForPade[] = { 2.5111573934555054e-1 /* degree = 3 */ , 4.0535837411880493e-1,
            5.3149729967117310e-1 };
  i32k minPadeDegree = matrix_log_min_pade_degree<float>::value;
  i32k maxPadeDegree = matrix_log_max_pade_degree<float>::value;
  i32 degree = minPadeDegree;
...
inline i32 matrix_log_get_pade_degree(double normTminusI)
{
  const double maxNormForPade[] = { 1.6206284795015624e-2 /* degree = 3 */ , 5.3873532631381171e-2,
            1.1352802267628681e-1, 1.8662860613541288e-1, 2.642960831111435e-1 };
  i32k minPadeDegree = matrix_log_min_pade_degree<double>::value;
  i32k maxPadeDegree = matrix_log_max_pade_degree<double>::value;
  i32 degree = minPadeDegree;
  for (; degree <= maxPadeDegree; ++degree)
    if (normTminusI <= maxNormForPade[degree - minPadeDegree])
      break;
...
inline i32 matrix_log_get_pade_degree(long double normTminusI)
{
...
#endif
  i32k minPadeDegree = matrix_log_min_pade_degree<long double>::value;
  i32k maxPadeDegree = matrix_log_max_pade_degree<long double>::value;
  i32 degree = minPadeDegree;
  for (; degree <= maxPadeDegree; ++degree)
    if (normTminusI <= maxNormForPade[degree - minPadeDegree])
      break;
...
template <typename MatrixType>
void matrix_log_compute_pade(MatrixType& result, const MatrixType& T, i32 degree)
{
  typedef typename NumTraits<typename MatrixType::Scalar>::Real RealScalar;
  i32k minPadeDegree = 3;
  i32k maxPadeDegree = 11;
...
void matrix_log_compute_big(const MatrixType& A, MatrixType& result)
{
  ...
  i32 numberOfSquareRoots = 0;
  i32 numberOfExtraSquareRoots = 0;
  i32 degree;
  MatrixType T = A, sqrtT;

  i32k maxPadeDegree = matrix_log_max_pade_degree<Scalar>::value;
  ...
  while (true) {
    ...
    if (normTminusI < maxNormForPade) {
      ...
      i32 degree2 = matrix_log_get_pade_degree(normTminusI / RealScalar(2));
