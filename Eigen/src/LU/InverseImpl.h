...
template<typename MatrixType, typename ResultType, i32 Size = MatrixType::RowsAtCompileTime>
...
template<typename MatrixType, i32 i, i32 j>
EIGEN_DEVICE_FUNC 
...
(const MatrixBase<Derived>& matrix, i32 i1, i32 i2, i32 i3, i32 j1, i32 j2, i32 j3)
{
...
template<i32 Arch, typename Scalar, typename MatrixType, typename ResultType>
...
struct Assignment<DstXprType, Inverse<XprType>, internal::assign_op<typename DstXprType::Scalar,typename XprType::Scalar>, Dense2Dense>
{
  ...
  static void run(DstXprType &dst, const SrcXprType &src, const internal::assign_op<typename DstXprType::Scalar,typename XprType::Scalar> &)
  {
    ...
    i32k Size = plain_enum_min(XprType::ColsAtCompileTime, DstXprType::ColsAtCompileTime);
