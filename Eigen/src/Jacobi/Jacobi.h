...
template<typename Scalar, typename OtherScalar,
         i32 SizeAtCompileTime, i32 MinAlignment, bool Vectorizable>
...
template<typename Scalar, typename OtherScalar,
         i32 SizeAtCompileTime, i32 MinAlignment>
...
void inline apply_rotation_in_the_plane(DenseBase<VectorX>& xpr_x, DenseBase<VectorY>& xpr_y, const JacobiRotation<OtherScalar>& j)
{
  ...
  constexpr bool Vectorizable = (i32(evaluator<VectorX>::Flags) & i32(evaluator<VectorY>::Flags) & PacketAccessBit) &&
                                (i32(packet_traits<Scalar>::size) == i32(packet_traits<OtherScalar>::size));
