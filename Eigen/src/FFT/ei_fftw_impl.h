...
namespace internal {
  ...
  struct fftw_plan<float>
  {
      ...
      inline
      void fwd(complex_type * dst,complex_type * src,i32 nfft) {
      ...
      inline
      void inv(complex_type * dst,complex_type * src,i32 nfft) {
          if (m_plan==NULL) m_plan = fftwf_plan_dft_1d(nfft,src,dst, FFTW_BACKWARD , FFTW_ESTIMATE|FFTW_PRESERVE_INPUT);
          fftwf_execute_dft( m_plan, src,dst);
      }
      inline
      void fwd(complex_type * dst,scalar_type * src,i32 nfft) {
      ...
      inline
      void inv(scalar_type * dst,complex_type * src,i32 nfft) {
          if (m_plan==NULL)
      ...
      inline 
      void fwd2( complex_type * dst,complex_type * src,i32 n0,i32 n1) {
          if (m_plan==NULL) m_plan = fftwf_plan_dft_2d(n0,n1,src,dst,FFTW_FORWARD,FFTW_ESTIMATE|FFTW_PRESERVE_INPUT);
          fftwf_execute_dft( m_plan, src,dst);
      }
      inline 
      void inv2( complex_type * dst,complex_type * src,i32 n0,i32 n1) {
  ...
  protected:
      ...
      inline
      PlanData & get_plan(i32 nfft,bool inverse,void * dst,const void * src)
      {
      ...
      inline
      PlanData & get_plan(i32 n0,i32 n1,bool inverse,void * dst,const void * src)
      {
          bool inplace = (dst==src);
          bool aligned = ( (reinterpret_cast<size_t>(src)&15) | (reinterpret_cast<size_t>(dst)&15) ) == 0;
