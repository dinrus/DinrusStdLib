...
/** \ingroup SparseCore_Module
  ...
  */
template<typename Scalar_, i32 _BlockAtCompileTime=Dynamic, i32 Options_=ColMajor, typename StorageIndex_=i32> class BlockSparseMatrix;

template<typename BlockSparseMatrixT> class BlockSparseMatrixView;

namespace internal {
template<typename Scalar_, i32 _BlockAtCompileTime, i32 Options_, typename Index_>
...
template<typename Scalar_, i32 _BlockAtCompileTime, i32 Options_, typename StorageIndex_>
