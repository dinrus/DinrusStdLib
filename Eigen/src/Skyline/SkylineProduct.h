...
template<typename Lhs, typename Rhs, i32 ProductMode>
...
template<typename LhsNested, typename RhsNested, i32 ProductMode>
struct internal::traits<SkylineProduct<LhsNested, RhsNested, ProductMode> > {
    ...
    enum {
        ...
        Flags = (i32(LhsFlags | RhsFlags) & HereditaryBits & RemovedBits)
...
public:
    ...
    : m_lhs(lhs), m_rhs(rhs) {
        ...
        enum {
            ...
            || i32(LhsNested_::ColsAtCompileTime) == i32(RhsNested_::RowsAtCompileTime),
...
template<typename Lhs, typename Rhs, typename ResultType,
        i32 LhsStorageOrder = traits<Lhs>::Flags&RowMajorBit>
