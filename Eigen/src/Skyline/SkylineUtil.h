...
u32k SkylineBit = 0x1200;
template<typename Lhs, typename Rhs, i32 ProductMode> class SkylineProduct;
...
template<typename Scalar_, i32 Flags_ = 0> class SkylineMatrix;
template<typename Scalar_, i32 Flags_ = 0> class DynamicSkylineMatrix;
template<typename Scalar_, i32 Flags_ = 0> class SkylineVector;
template<typename Scalar_, i32 Flags_ = 0> class MappedSkylineMatrix;

namespace internal {

template<typename Lhs, typename Rhs> struct skyline_product_mode;
template<typename Lhs, typename Rhs, i32 ProductMode = skyline_product_mode<Lhs,Rhs>::value> struct SkylineProductReturnType;
