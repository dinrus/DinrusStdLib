...
template<typename Derived, typename OtherDerived, i32 Size>
struct cross_impl
{
...
template< i32 Arch,typename VectorLhs,typename VectorRhs,
...
template<typename Derived, i32 Size = Derived::SizeAtCompileTime>
