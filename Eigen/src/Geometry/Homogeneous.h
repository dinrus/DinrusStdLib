...
template<typename MatrixType,i32 Direction>
 ...
 : traits<MatrixType>
{
  ...
  enum {
    RowsPlusOne = (MatrixType::RowsAtCompileTime != Dynamic) ?
                  i32(MatrixType::RowsAtCompileTime) + 1 : Dynamic,
    ColsPlusOne = (MatrixType::ColsAtCompileTime != Dynamic) ?
                  i32(MatrixType::ColsAtCompileTime) + 1 : Dynamic,
...
template<typename MatrixType,i32 Direction_> class Homogeneous
  : public MatrixBase<Homogeneous<MatrixType,Direction_> >, internal::no_assignment_operator
{
  public:
    ...
    inline Index rows() const EIGEN_NOEXCEPT { return m_matrix.rows() + (i32(Direction)==Vertical   ? 1 : 0); }
    EIGEN_DEVICE_FUNC EIGEN_CONSTEXPR
    inline Index cols() const EIGEN_NOEXCEPT { return m_matrix.cols() + (i32(Direction)==Horizontal ? 1 : 0); }
    ...
    {
      eigen_assert(i32(Direction)==Horizontal);
    ...
    {
      eigen_assert(i32(Direction)==Vertical);
      return Product<Lhs,Homogeneous>(lhs.derived(),rhs);
    }

    template<typename Scalar, i32 Dim, i32 Mode, i32 Options> friend
...
template<typename ExpressionType, i32 Direction>
...
template<typename LhsArg, typename Rhs, i32 ProductTag>
...
template<typename Lhs, typename RhsArg, i32 ProductTag>
...
template<typename Scalar, i32 Dim, i32 Mode,i32 Options, typename RhsArg, i32 ProductTag>
