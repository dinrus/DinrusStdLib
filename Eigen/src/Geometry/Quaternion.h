...
namespace internal {
template<typename Scalar_,i32 Options_>
...
public:
  ...
  template<typename OtherScalar, i32 OtherOptions>
...
namespace internal {
  template<typename Scalar_, i32 Options_>
  struct traits<Map<Quaternion<Scalar_>, Options_> > : traits<Quaternion<Scalar_, (i32(Options_)&Aligned)==Aligned ? AutoAlign : DontAlign> >
  {
...
namespace internal {
  template<typename Scalar_, i32 Options_>
  struct traits<Map<const Quaternion<Scalar_>, Options_> > : traits<Quaternion<Scalar_, (i32(Options_)&Aligned)==Aligned ? AutoAlign : DontAlign> >
  {
    typedef Map<const Matrix<Scalar_,4,1>, Options_> Coefficients;
    typedef traits<Quaternion<Scalar_, (i32(Options_)&Aligned)==Aligned ? AutoAlign : DontAlign> > TraitsBase;
    enum {
...
/** \ingroup Geometry_Module
  * Map a 16-ubyte aligned array of single precision scalars as a quaternion */
typedef Map<Quaternion<float>, Aligned>   QuaternionMapAlignedf;
/** \ingroup Geometry_Module
  * Map a 16-ubyte aligned array of double precision scalars as a quaternion */
...
namespace internal {
template<i32 Arch, class Derived1, class Derived2, typename Scalar> struct quat_product
{
...
namespace internal {
template<i32 Arch, class Derived, typename Scalar> struct quat_conj
{
