...
/** \class RotationBase
  ...
  */
template<typename Derived, i32 Dim_>
class RotationBase
{
  public:
    enum { Dim = Dim_ };
...
template<typename RotationDerived, typename Scalar, i32 Dim, i32 MaxDim>
...
/** \geometry_module
  ...
  */
template<typename Scalar_, i32 Rows_, i32 Cols_, i32 Storage_, i32 MaxRows_, i32 MaxCols_>
template<typename OtherDerived>
EIGEN_DEVICE_FUNC Matrix<Scalar_, Rows_, Cols_, Storage_, MaxRows_, MaxCols_>
::Matrix(const RotationBase<OtherDerived,ColsAtCompileTime>& r)
{
  EIGEN_STATIC_ASSERT_MATRIX_SPECIFIC_SIZE(Matrix,i32(OtherDerived::Dim),i32(OtherDerived::Dim))
...
template<typename Scalar, i32 Dim, typename OtherDerived>
