...
/** \ingroup SparseCore_Module
  ...
  * \tparam StorageIndex_ the type of the indices. It has to be a \b signed type (e.g., short, i32, std::ptrdiff_t). Default is \c i32.
  *
  * \warning In %Eigen 3.2, the undocumented type \c SparseMatrix::Index was improperly defined as the storage index type (e.g., i32),
...
template<typename Scalar_, i32 Options_, typename StorageIndex_, i32 DiagIndex>
  ...
  : public SparseCompressedBase<SparseMatrix<Scalar_, Options_, StorageIndex_> >
{
  ...
  public:
    ...
    /** Preallocates \a reserveSize[\c j] non zeros for each column (resp. row) \c j.
      ...
      * Typical choices include std::vector<i32>, Eigen::VectorXi, Eigen::VectorXi::Constant, etc.
      */
  ...
  public:
    ...
    template<typename OtherDerived, u32 UpLo>
...
/** Fill the matrix \c *this with the list of \em triplets defined by the iterator range \a begin - \a end.
  ...
  */
template<typename Scalar, i32 Options_, typename StorageIndex_>
template<typename InputIterators>
...
template <typename Scalar, i32 Options, typename StorageIndex>
