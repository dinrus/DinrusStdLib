...
template<typename MatScalar, i32 MatOptions, typename MatIndex, i32 Options_, typename StrideType_>
...
template<typename MatScalar, i32 MatOptions, typename MatIndex, i32 Options, typename StrideType>
class Ref<SparseMatrix<MatScalar,MatOptions,MatIndex>, Options, StrideType >
  : public internal::SparseRefBase<Ref<SparseMatrix<MatScalar,MatOptions,MatIndex>, Options, StrideType > >
#else
template<typename SparseMatrixType, i32 Options>
...
#endif
{
  ...
  public:
    ...
    inline Ref(SparseMatrix<MatScalar,OtherOptions,MatIndex>& expr)
    {
      ...
      eigen_assert( ((Options & i32(StandardCompressedFormat))==0) || (expr.isCompressed()) );
  ...
  : public internal::SparseRefBase<Ref<const SparseMatrix<MatScalar,MatOptions,MatIndex>, Options, StrideType> >
{
  ...
  protected:
    ...
    {
      if((Options & i32(StandardCompressedFormat)) && (!expr.isCompressed()))
      {
