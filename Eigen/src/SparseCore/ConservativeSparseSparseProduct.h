...
static void conservative_sparse_sparse_product_impl(const Lhs& lhs, const Rhs& rhs, ResultType& res, bool sortedInsertion = false)
{
  ...
  for (Index j=0; j<cols; ++j)
  {
    ...
    else
    {
      ...
      if((nnz<200 && nnz<t200) || nnz * numext::log2(i32(nnz)) < t)
      {
...
template<class Source, i32 Order>
using WithStorageOrder = SparseMatrix<typename Source::Scalar, Order, typename Source::StorageIndex>;

template<typename Lhs, typename Rhs, typename ResultType,
  i32 LhsStorageOrder = (traits<Lhs>::Flags&RowMajorBit) ? RowMajor : ColMajor,
  i32 RhsStorageOrder = (traits<Rhs>::Flags&RowMajorBit) ? RowMajor : ColMajor,
  i32 ResStorageOrder = (traits<ResultType>::Flags&RowMajorBit) ? RowMajor : ColMajor>
