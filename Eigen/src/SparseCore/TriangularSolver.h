...
template<typename Lhs, typename Rhs, i32 Mode,
  i32 UpLo = (Mode & Lower)
           ...
           ? Upper
           : -1,
  i32 StorageOrder = i32(traits<Lhs>::Flags) & RowMajorBit>
...
template<typename ExpressionType,u32 Mode>
...
template<typename Lhs, typename Rhs, i32 Mode,
  i32 UpLo = (Mode & Lower)
           ...
           ? Upper
           : -1,
  i32 StorageOrder = i32(Lhs::Flags) & (RowMajorBit)>
struct sparse_solve_triangular_sparse_selector;

// forward substitution, col-major
template<typename Lhs, typename Rhs, i32 Mode, i32 UpLo>
...
//       std::cout << "tempVector.nonZeros() == " << i32(count) << " / " << (other.rows()) << "\n";
    }
    res.finalize();
