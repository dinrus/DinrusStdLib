...
public:
  ...
  class InnerIterator
  {
    enum { IsRowMajor = (i32(Rhs::Flags)&RowMajorBit)==RowMajorBit };
  public:
...
public:
  ...
  class InnerIterator
  {
    enum { IsRowMajor = (i32(Lhs::Flags)&RowMajorBit)==RowMajorBit };
  public:
...
public:
  ...
  enum {
    CoeffReadCost = i32(evaluator<LhsArg>::CoeffReadCost) + i32(evaluator<RhsArg>::CoeffReadCost) + i32(functor_traits<BinaryOp>::Cost),
    Flags = XprType::Flags
  };
...
public:
  ...
  class InnerIterator
  {
    enum { IsRowMajor = (i32(RhsArg::Flags)&RowMajorBit)==RowMajorBit };
...
public:
  ...
  class InnerIterator
  {
    enum { IsRowMajor = (i32(LhsArg::Flags)&RowMajorBit)==RowMajorBit };
