...
template<typename XprType, i32 BlockRows, i32 BlockCols>
...
template<typename SparseMatrixType, i32 BlockRows, i32 BlockCols>
...
template<typename Scalar_, i32 Options_, typename StorageIndex_, i32 BlockRows, i32 BlockCols>
