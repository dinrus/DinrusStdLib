...
/// \internal expression type of a block of whole columns */
template<i32 N> struct NColsBlockXpr { typedef Block<Derived, internal::traits<Derived>::RowsAtCompileTime, N, !IsRowMajor> Type; };
template<i32 N> struct ConstNColsBlockXpr { typedef const Block<const Derived, internal::traits<Derived>::RowsAtCompileTime, N, !IsRowMajor> Type; };
/// \internal expression type of a block of whole rows */
template<i32 N> struct NRowsBlockXpr { typedef Block<Derived, N, internal::traits<Derived>::ColsAtCompileTime, IsRowMajor> Type; };
template<i32 N> struct ConstNRowsBlockXpr { typedef const Block<const Derived, N, internal::traits<Derived>::ColsAtCompileTime, IsRowMajor> Type; };
/// \internal expression of a block */
typedef Block<Derived> BlockXpr;
typedef const Block<const Derived> ConstBlockXpr;
/// \internal expression of a block of fixed sizes */
template<i32 Rows, i32 Cols> struct FixedBlockXpr { typedef Block<Derived,Rows,Cols> Type; };
template<i32 Rows, i32 Cols> struct ConstFixedBlockXpr { typedef Block<const Derived,Rows,Cols> Type; };

typedef VectorBlock<Derived> SegmentReturnType;
typedef const VectorBlock<const Derived> ConstSegmentReturnType;
template<i32 Size> struct FixedSegmentReturnType { typedef VectorBlock<Derived, Size> Type; };
template<i32 Size> struct ConstFixedSegmentReturnType { typedef const VectorBlock<const Derived, Size> Type; };
...
EIGEN_DOC_BLOCK_ADDONS_NOT_INNER_PANEL
///
/// \sa class Block, block<i32,i32>(Index,Index)
///
template<i32 CRows, i32 CCols>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
/// This is the const version of topRightCorner<i32, i32>().
template<i32 CRows, i32 CCols>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
/// This is the const version of topRightCorner<i32, i32>(Index, Index).
template<i32 CRows, i32 CCols>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
/// This is the const version of topLeftCorner<i32, i32>().
template<i32 CRows, i32 CCols>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
/// This is the const version of topLeftCorner<i32, i32>(Index, Index).
template<i32 CRows, i32 CCols>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
/// This is the const version of bottomRightCorner<i32, i32>().
template<i32 CRows, i32 CCols>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
/// This is the const version of bottomRightCorner<i32, i32>(Index, Index).
template<i32 CRows, i32 CCols>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
/// This is the const version of bottomLeftCorner<i32, i32>().
template<i32 CRows, i32 CCols>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
/// This is the const version of bottomLeftCorner<i32, i32>(Index, Index).
template<i32 CRows, i32 CCols>
EIGEN_STRONG_INLINE
...
/// This is the const version of topRows<i32>().
template<i32 N>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
/// This is the const version of bottomRows<i32>().
template<i32 N>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
/// This is the const version of middleRows<i32>().
template<i32 N>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
/// This is the const version of leftCols<i32>().
template<i32 N>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
/// This is the const version of rightCols<i32>().
template<i32 N>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
/// This is the const version of middleCols<i32>().
template<i32 N>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
/// which means that evaluating it does not cause a dynamic memory allocation.
///
/// \sa block(Index,Index,NRowsType,NColsType), fix<N>, fix<N>(i32), class Block
///
...
/// This is the const version of segment<i32>(Index).
template<i32 N>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
/// This is the const version of head<i32>().
template<i32 N>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
/// This is the const version of tail<i32>.
template<i32 N>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
