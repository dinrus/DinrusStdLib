...
template<typename MatrixType_, i32 UpLo_> struct traits<LLT<MatrixType_, UpLo_> >
 : traits<MatrixType_>
{
...
template<typename MatrixType, i32 UpLo> struct LLT_Traits;
}
...
/** \ingroup Cholesky_Module
  ...
  */
template<typename MatrixType_, i32 UpLo_> class LLT
        : public SolverBase<LLT<MatrixType_, UpLo_> >
{
  public:
    ...
    enum {
      ...
      AlignmentMask = i32(PacketSize)-1,
      UpLo = UpLo_
    };
...
template<typename Scalar, i32 UpLo> struct llt_inplace;
...
/** Computes / recomputes the Cholesky decomposition A = LL^* = U^*U of \a matrix
  ...
  */
template<typename MatrixType, i32 UpLo_>
template<typename InputType>
