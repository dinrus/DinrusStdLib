...
namespace internal {
  template<typename MatrixType_, i32 UpLo_> struct traits<LDLT<MatrixType_, UpLo_> >
   : traits<MatrixType_>
  {
  ...
  template<typename MatrixType, i32 UpLo> struct LDLT_Traits;
...
/** \ingroup Cholesky_Module
  ...
  */
template<typename MatrixType_, i32 UpLo_> class LDLT
...
template<i32 UpLo> struct ldlt_inplace;
