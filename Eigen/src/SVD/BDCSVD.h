...
struct allocate_small_svd {
  static void run(JacobiSVD<MatrixType, Options>& smallSvd, Index rows, Index cols, u32 computationOptions) {
...
struct allocate_small_svd<MatrixType, 0> {
  static void run(JacobiSVD<MatrixType>& smallSvd, Index rows, Index cols, u32 computationOptions) {
...
public:
   ...
   */
  EIGEN_DEPRECATED
  BDCSVD(Index rows, Index cols, u32 computationOptions) : m_algoswap(16), m_numIters(0) {
   ...
   */
  EIGEN_DEPRECATED
  BDCSVD(const MatrixType& matrix, u32 computationOptions) : m_algoswap(16), m_numIters(0) {
   ...
   */
  EIGEN_DEPRECATED
  BDCSVD& compute(const MatrixType& matrix, u32 computationOptions) {
    internal::check_svd_options_assertions<MatrixType, Options>(computationOptions, matrix.rows(), matrix.cols());
    return compute_impl(matrix, computationOptions);
  }

  void setSwitchSize(i32 s)
  {
...
private:
  BDCSVD& compute_impl(const MatrixType& matrix, u32 computationOptions);
...
template <typename MatrixType, i32 Options>
void BDCSVD<MatrixType, Options>::allocate(Index rows, Index cols, u32 computationOptions) {
  ...
  constexpr bool disableQrDecomp = static_cast<i32>(QRDecomposition) == static_cast<i32>(DisableQRDecomposition);
