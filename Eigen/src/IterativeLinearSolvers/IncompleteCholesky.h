...
/**
  ...
  * \tparam OrderingType_ The ordering method to use, either AMDOrdering<> or NaturalOrdering<>. Default is AMDOrdering<i32>,
  *                       unless EIGEN_MPL2_ONLY is defined, in which case the default is NaturalOrdering<i32>.
  *
  ...
  *
  */
template <typename Scalar, i32 UpLo_ = Lower, typename OrderingType_ = AMDOrdering<i32> >
...
template<typename Scalar, i32 UpLo_, typename OrderingType>
