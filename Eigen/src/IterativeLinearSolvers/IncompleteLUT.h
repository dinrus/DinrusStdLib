...
/** \ingroup IterativeLinearSolvers_Module
  ...
  */
template <typename Scalar_, typename StorageIndex_ = i32>
class IncompleteLUT : public SparseSolverBase<IncompleteLUT<Scalar_, StorageIndex_> >
{
  ...
  public:
    ...
    explicit IncompleteLUT(const MatrixType& mat, const RealScalar& droptol=NumTraits<Scalar>::dummy_precision(), i32 fillfactor = 10)
    ...
    void setFillfactor(i32 fillfactor);
 ...
 **/
template<typename Scalar, typename StorageIndex>
void IncompleteLUT<Scalar,StorageIndex>::setFillfactor(i32 fillfactor)
{
