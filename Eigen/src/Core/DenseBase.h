...
#endif // not EIGEN_PARSED_BY_DOXYGEN
{
  public:
    ...
    /** The numeric type of the expression' coefficients, e.g. float, double, i32 or std::complex<float>, etc. */
    ...
    enum {
      ...
      NumDimensions = i32(MaxSizeAtCompileTime) == 1 ? 0 : bool(IsVectorAtCompileTime) ? 1 : 2,
      ...
      IsRowMajor = i32(Flags) & RowMajorBit, /**< True if this expression has row-major storage order. */

      InnerSizeAtCompileTime = i32(IsVectorAtCompileTime) ? i32(SizeAtCompileTime)
                             : i32(IsRowMajor) ? i32(ColsAtCompileTime) : i32(RowsAtCompileTime),
    ...
    Index outerSize() const
    {
      return IsVectorAtCompileTime ? 1
           : i32(IsRowMajor) ? this->rows() : this->cols();
    }
    ...
    Index innerSize() const
    {
      return IsVectorAtCompileTime ? this->size()
           : i32(IsRowMajor) ? this->cols() : this->rows();
    }
    ...
    template<u32 Added,u32 Removed>
    ...
    template<i32 NaNPropagation, typename IndexType>
    EIGEN_DEVICE_FUNC
    ...
    */
    ...
    template<i32 p> RealScalar lpNorm() const;

    template<i32 RowFactor, i32 ColFactor>
    EIGEN_DEVICE_FUNC
    ...
    *
    * \sa VectorwiseOp::replicate(), DenseBase::replicate<i32,i32>(), class Replicate
    */
    //Code moved here due to a CUDA compiler bug
    EIGEN_DEVICE_FUNC
...
#undef EIGEN_DOC_UNARY_ADDONS
  ...
  protected:
    ...
    EIGEN_DEVICE_FUNC constexpr DenseBase() {
      ...
      EIGEN_STATIC_ASSERT((internal::check_implication(MaxRowsAtCompileTime==1 && MaxColsAtCompileTime!=1, i32(IsRowMajor))
                        && internal::check_implication(MaxColsAtCompileTime==1 && MaxRowsAtCompileTime!=1, i32(!IsRowMajor))),
                          INVALID_STORAGE_ORDER_FOR_THIS_VECTOR_EXPRESSION)
#endif
    }

  private:
    EIGEN_DEVICE_FUNC explicit DenseBase(i32);
    EIGEN_DEVICE_FUNC DenseBase(i32,i32);
