...
EIGEN_STRONG_INLINE std::enable_if_t< (N < 0) || (N > 63), Packet4l> parithmetic_shift_right(Packet4l a) {
  return parithmetic_shift_right<i32(N&63)>(a);
}
#endif
template <>
...
template<> EIGEN_STRONG_INLINE Packet8i pset1<Packet8i>(i32k&    from) { return _mm256_set1_epi32(from); }

template<> EIGEN_STRONG_INLINE Packet8f pset1frombits<Packet8f>(u32 from) { return _mm256_castsi256_ps(pset1<Packet8i>(from)); }
...
template<> EIGEN_STRONG_INLINE Packet8i plset<Packet8i>(i32k& a) { return padd(pset1<Packet8i>(a), (Packet8i)_mm256_set_epi32(7,6,5,4,3,2,1,0)); }
...
template<i32 N> EIGEN_STRONG_INLINE Packet8i parithmetic_shift_right(Packet8i a) {
#ifdef EIGEN_VECTORIZE_AVX2
...
template<i32 N> EIGEN_STRONG_INLINE Packet8i plogical_shift_right(Packet8i a) {
#ifdef EIGEN_VECTORIZE_AVX2
...
template<i32 N> EIGEN_STRONG_INLINE Packet8i plogical_shift_left(Packet8i a) {
#ifdef EIGEN_VECTORIZE_AVX2
...
template<> EIGEN_STRONG_INLINE Packet8i pload<Packet8i>(i32k*     from) { EIGEN_DEBUG_ALIGNED_LOAD return _mm256_load_si256(reinterpret_cast<const __m256i*>(from)); }

template<> EIGEN_STRONG_INLINE Packet8f ploadu<Packet8f>(const float* from) { EIGEN_DEBUG_UNALIGNED_LOAD return _mm256_loadu_ps(from); }
template<> EIGEN_STRONG_INLINE Packet4d ploadu<Packet4d>(const double* from) { EIGEN_DEBUG_UNALIGNED_LOAD return _mm256_loadu_pd(from); }
template<> EIGEN_STRONG_INLINE Packet8i ploadu<Packet8i>(i32k* from) { EIGEN_DEBUG_UNALIGNED_LOAD return _mm256_loadu_si256(reinterpret_cast<const __m256i*>(from)); }
...
template<> EIGEN_STRONG_INLINE Packet8i ploaddup<Packet8i>(i32k* from)
{
#ifdef EIGEN_VECTORIZE_AVX2
...
template<> EIGEN_STRONG_INLINE Packet8i ploadquad<Packet8i>(i32k* from)
{
...
template<> EIGEN_STRONG_INLINE void pstore<i32>(i32*       to, const Packet8i& from) { EIGEN_DEBUG_ALIGNED_STORE _mm256_storeu_si256(reinterpret_cast<__m256i*>(to), from); }

template<> EIGEN_STRONG_INLINE void pstoreu<float>(float*   to, const Packet8f& from) { EIGEN_DEBUG_UNALIGNED_STORE _mm256_storeu_ps(to, from); }
template<> EIGEN_STRONG_INLINE void pstoreu<double>(double* to, const Packet4d& from) { EIGEN_DEBUG_UNALIGNED_STORE _mm256_storeu_pd(to, from); }
template<> EIGEN_STRONG_INLINE void pstoreu<i32>(i32*       to, const Packet8i& from) { EIGEN_DEBUG_UNALIGNED_STORE _mm256_storeu_si256(reinterpret_cast<__m256i*>(to), from); }
...
template<> EIGEN_DEVICE_FUNC inline Packet8i pgather<i32, Packet8i>(i32k* from, Index stride)
{
...
template<> EIGEN_DEVICE_FUNC inline void pscatter<i32, Packet8i>(i32* to, const Packet8i& from, Index stride)
{
  __m128i low = _mm256_extractf128_si256(from, 0);
...
template<> EIGEN_STRONG_INLINE void pstore1<Packet8i>(i32* to, i32k& a)
{
...
template<> EIGEN_STRONG_INLINE i32    pfirst<Packet8i>(const Packet8i& a) {
...
template<> EIGEN_STRONG_INLINE i32 predux<Packet8i>(const Packet8i& a)
{
