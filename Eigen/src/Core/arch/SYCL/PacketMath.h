...
template <typename packet_type, i32 Alignment, typename T>
EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE packet_type
...
template <typename packet_type, i32 Alignment>
EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE packet_type
...
template <typename scalar, typename packet_type, i32 Alignment>
