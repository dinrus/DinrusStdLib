...
{
private:
  constexpr static i32 size = internal::size_at_compile_time(Rows_,Cols_);
...
/** \class Matrix
  ...
  * \tparam Scalar_ Numeric type, e.g. float, double, i32 or std::complex<float>.
  ...
  * \li \c RowVector3i is a row-vector of 3 ints (\c Matrix<i32, 1, 3>)
  *
...
EIGEN_MAKE_TYPEDEFS_ALL_SIZES(i32,                  i)
