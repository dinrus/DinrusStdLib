  ...
  : public PlainObjectBase<Array<Scalar_, Rows_, Cols_, Options_, MaxRows_, MaxCols_> >
{
  ...
  public:
    ...
    /** \brief Constructs an array and initializes it from the coefficients given as initializer-lists grouped by row. \cpp11
      ...
      * Therefore <code> Array<i32,Dynamic,1>{{1,2,3,4,5}}</code> is legal and the more verbose syntax
      * <code>Array<i32,Dynamic,1>{{1},{2},{3},{4},{5}}</code> can be avoided:
      *
...
EIGEN_MAKE_ARRAY_TYPEDEFS_ALL_SIZES(i32,                  i)
