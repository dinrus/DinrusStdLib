...
/** This value means that a signed quantity (e.g., a signed index) is not known at compile-time, and that instead its value
  ...
  */
i32k DynamicIndex = 0xffffff;

/** This value means that the increment to go from one value to another in a sequence is not constant for each step.
  */
i32k UndefinedIncr = 0xfffffe;

/** This value means +Infinity; it is currently used only as the p parameter to MatrixBase::lpNorm<i32>().
...
u32k RowMajorBit = 0x1;

/** \ingroup flags
  * means the expression should be evaluated by the calling expression */
u32k EvalBeforeNestingBit = 0x2;

/** \ingroup flags
  * \deprecated
  * means the expression should be evaluated before any assignment */
EIGEN_DEPRECATED
u32k EvalBeforeAssigningBit = 0x4; // FIXME deprecated
...
/** \ingroup flags
  ...
  */
u32k ActualPacketAccessBit = PacketAccessBit;
#else
u32k ActualPacketAccessBit = 0x0;
#endif
...
/** \ingroup flags
  ...
  * of this expression by coeff(i32), and coeffRef(i32) in the case of a lvalue expression. These
  ...
  * packets of this expression can be accessed by packet(i32), and writePacket(i32) in the case of a
  * lvalue expression.
  *
...
/** \deprecated \ingroup flags
  ...
  * \endcode
  */
EIGEN_DEPRECATED u32k AlignedBit = 0x80;

u32k NestByRefBit = 0x100;
...
u32k NoPreferredStorageOrderBit = 0x200;
...
/** \ingroup flags
  ...
  * \code
    ...
    \endcode
  */
u32k CompressedAccessBit = 0x400;


// list of flags that are inherited by default
u32k HereditaryBits = RowMajorBit
