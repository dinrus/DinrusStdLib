...
template<typename LhsScalar, typename RhsScalar, typename Index, typename DataMapper, i32 mr, i32 nr, bool ConjugateLhs=false, bool ConjugateRhs=false>
struct gebp_kernel;

template<typename Scalar, typename Index, typename DataMapper, i32 nr, i32 StorageOrder, bool Conjugate = false, bool PanelMode=false>
struct gemm_pack_rhs;

template<typename Scalar, typename Index, typename DataMapper, i32 Pack1, i32 Pack2, typename Packet, i32 StorageOrder, bool Conjugate = false, bool PanelMode = false>
struct gemm_pack_lhs;

template<
  typename Index,
  typename LhsScalar, i32 LhsStorageOrder, bool ConjugateLhs,
  typename RhsScalar, i32 RhsStorageOrder, bool ConjugateRhs,
  i32 ResStorageOrder, i32 ResInnerStride>
struct general_matrix_matrix_product;

template<typename Index,
         typename LhsScalar, typename LhsMapper, i32 LhsStorageOrder, bool ConjugateLhs,
         typename RhsScalar, typename RhsMapper, bool ConjugateRhs, i32 Version=Specialized>
...
class BlasVectorMapper {
  ...
  template <typename Packet, i32 AlignmentType>
...
template<typename Scalar, typename Index, i32 AlignmentType, i32 Incr=1>
class BlasLinearMapper;

template<typename Scalar, typename Index, i32 AlignmentType>
...
public:
  ...
  template<typename PacketType, i32 AlignmentT>
...
template<typename Scalar, typename Index, i32 StorageOrder, i32 AlignmentType = Unaligned, i32 Incr = 1>
...
template<typename Index, typename Scalar, typename Packet, i32 n, i32 idx, i32 StorageOrder>
...
template<typename Index, typename Scalar, typename Packet, i32 n, i32 idx>
...
template<typename Index, typename Scalar, typename Packet, i32 n, i32 StorageOrder>
...
template<typename Index, typename Scalar, typename Packet, i32 n>
...
template<typename Scalar, typename Index, i32 StorageOrder, i32 AlignmentType>
...
public:
  ...
  template <typename PacketT, i32 AlignmentT>
  ...
  template<typename SubPacket, i32 n>
...
template<typename Scalar, typename Index, i32 AlignmentType, i32 Incr>
class BlasLinearMapper
{
public:
  EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE BlasLinearMapper(Scalar *data,Index incr) : m_data(data), m_incr(incr) {}

  EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE void prefetch(i32 i) const {
    internal::prefetch(&operator()(i));
  }
...
template<typename Scalar, typename Index, i32 StorageOrder, i32 AlignmentType,i32 Incr>
class blas_data_mapper
{
public:
  ...
  template<typename SubPacket, typename Scalar_, i32 n, i32 idx>
  ...
  template<typename SubPacket, i32 n, i32 idx>
  ...
  struct storePacketBlock_helper<SubPacket, std::complex<double>, n, idx>
  {
    ...
    EIGEN_DEVICE_FUNC EIGEN_ALWAYS_INLINE void store(const blas_data_mapper<Scalar, Index, StorageOrder, AlignmentType, Incr>* sup, Index i, Index j, const PacketBlock<SubPacket, n>& block) const {
      spbh.store(sup,i,j,block);
      for(i32 l = 0; l < unpacket_traits<SubPacket>::size; l++)
      {
  ...
  template<typename SubPacket, typename Scalar_, i32 n>
...
template<typename Scalar, typename Index, i32 StorageOrder>
...
template<typename XprType> struct blas_traits
{
  ...
  enum {
    ...
    HasUsableDirectAccess = (    (i32(XprType::Flags)&DirectAccessBit)
                              && (   bool(XprType::IsVectorAtCompileTime)
                                  || i32(inner_stride_at_compile_time<XprType>::ret) == 1)
                             ) ?  1 : 0,
