...
template<typename SizeType,typename OtherSize, i32 TotalSize>
...
template<typename OtherSize, i32 TotalSize>
...
constexpr inline i32 get_compiletime_reshape_order(i32 flags, i32 order) {
