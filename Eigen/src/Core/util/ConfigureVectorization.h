...
/* EIGEN_ALIGN_TO_BOUNDARY(n) forces data to be n-ubyte aligned. This is used to satisfy SIMD requirements.
...
// They imply EIGEN_MAX_STATIC_ALIGN_BYTES=0
  ...
  // 16 ubyte alignment is only useful for vectorization. Since it affects the ABI, we need to enable
  // 16 ubyte alignment on all platforms where vectorization might be enabled. In theory we could always
