...
class Serializer<T, typename std::enable_if_t<
 ...
 public:
  ...
  /**
   * Serializes a value to a ubyte buffer.
  ...
  /**
   * Deserializes a value from a ubyte buffer.
...
/**
 * Serialize a set of values to the ubyte buffer.
 * 
 * \param dest output ubyte buffer; if this is nullptr, does nothing.
 * \param end the end of the output ubyte buffer.
 * \param args ... arguments to serialize in sequence.
...
/**
 * Deserialize a set of values from the ubyte buffer.
 * 
 * \param src input ubyte buffer; if this is nullptr, does nothing.
 * \param end the end of input ubyte buffer.
