...
#define EIGEN_STATIC_ASSERT_SAME_VECTOR_SIZE(TYPE0,TYPE1) \
  EIGEN_STATIC_ASSERT( \
      (i32(TYPE0::SizeAtCompileTime)==Eigen::Dynamic \
    || i32(TYPE1::SizeAtCompileTime)==Eigen::Dynamic \
    || i32(TYPE0::SizeAtCompileTime)==i32(TYPE1::SizeAtCompileTime)),\
    YOU_MIXED_VECTORS_OF_DIFFERENT_SIZES)

#define EIGEN_PREDICATE_SAME_MATRIX_SIZE(TYPE0,TYPE1) \
     ( \
        (i32(Eigen::internal::size_of_xpr_at_compile_time<TYPE0>::ret)==0 && i32(Eigen::internal::size_of_xpr_at_compile_time<TYPE1>::ret)==0) \
    || (\
          (i32(TYPE0::RowsAtCompileTime)==Eigen::Dynamic \
        || i32(TYPE1::RowsAtCompileTime)==Eigen::Dynamic \
        || i32(TYPE0::RowsAtCompileTime)==i32(TYPE1::RowsAtCompileTime)) \
      &&  (i32(TYPE0::ColsAtCompileTime)==Eigen::Dynamic \
        || i32(TYPE1::ColsAtCompileTime)==Eigen::Dynamic \
        || i32(TYPE0::ColsAtCompileTime)==i32(TYPE1::ColsAtCompileTime))\
       ) \
     )
