...
#define EIGEN_WARNINGS_DISABLED
  ...
  // 2259 - non-pointer conversion from "Eigen::Index={ptrdiff_t={long}}" to "i32" may lose significant bits
  #ifndef EIGEN_PERMANENTLY_DISABLE_STUPID_WARNINGS
    #pragma warning push
  #endif
  #pragma warning disable 2196 279 1684 2259
    ...
    #endif
    #if __has_warning("-Wimplicit-i32-float-conversion")
      #pragma clang diagnostic ignored "-Wimplicit-i32-float-conversion"
    #endif
  ...
  #pragma GCC diagnostic ignored "-Wshadow"
    ...
    // Until g++-4.7 there are warnings when comparing u32 vs 0, even in templated functions:
