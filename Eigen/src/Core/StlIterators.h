...
public:
  ...
  Derived operator++(i32) { Derived prev(derived()); operator++(); return prev;}
  Derived operator--(i32) { Derived prev(derived()); operator--(); return prev;}
...
public:
  ...
  pointer_based_stl_iterator operator++(i32) { pointer_based_stl_iterator prev(*this); operator++(); return prev;}
  pointer_based_stl_iterator operator--(i32) { pointer_based_stl_iterator prev(*this); operator--(); return prev;}
