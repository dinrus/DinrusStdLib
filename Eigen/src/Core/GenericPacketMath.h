...
template<typename T, i32 unique_id = 0>
...
// Apply binary operations ubyte-by-ubyte
template<typename T>
struct bytewise_bitwise_helper {
  EIGEN_DEVICE_FUNC static inline T bitwise_and(const T& a, const T& b) {
    return binary(a, b, bit_and<u8>());
  }
  EIGEN_DEVICE_FUNC static inline T bitwise_or(const T& a, const T& b) {
    return binary(a, b, bit_or<u8>());
   }
  EIGEN_DEVICE_FUNC static inline T bitwise_xor(const T& a, const T& b) {
    return binary(a, b, bit_xor<u8>());
  }
  EIGEN_DEVICE_FUNC static inline T bitwise_not(const T& a) {
    return unary(a,bit_not<u8>());
   }

 private:
  template<typename Op>
  EIGEN_DEVICE_FUNC static inline T unary(const T& a, Op op) {
    u8k * a_ptr = reinterpret_cast<u8k *>(&a);
    T c;
    u8* c_ptr = reinterpret_cast<u8*>(&c);
  ...
  EIGEN_DEVICE_FUNC static inline T binary(const T& a, const T& b, Op op) {
    u8k * a_ptr = reinterpret_cast<u8k *>(&a);
    u8k * b_ptr = reinterpret_cast<u8k *>(&b);
    T c;
    u8* c_ptr = reinterpret_cast<u8*>(&c);
    for (size_t i = 0; i < sizeof(T); ++i) {
...
// In the general case, use ubyte-by-ubyte manipulation.
...
template <i32 NaNPropagation, typename Packet>
...
template<> EIGEN_DEVICE_FUNC inline u32
pabs(u32k& a) { return a; }
template<> EIGEN_DEVICE_FUNC inline unsigned long
pabs(u64k& a) { return a; }
template<> EIGEN_DEVICE_FUNC inline unsigned z64
pabs(zu64k& a) { return a; }
...
template<i32 N> EIGEN_DEVICE_FUNC inline i32
parithmetic_shift_right(i32k& a) { return a >> N; }
template<i32 N> EIGEN_DEVICE_FUNC inline i64
parithmetic_shift_right(i64k& a) { return a >> N; }

/** \internal \returns \a a logically shifted by N bits to the right */
template<i32 N> EIGEN_DEVICE_FUNC inline i32
plogical_shift_right(i32k& a) { return static_cast<i32>(static_cast<u32>(a) >> N); }
template<i32 N> EIGEN_DEVICE_FUNC inline i64
plogical_shift_right(i64k& a) { return static_cast<long>(static_cast<unsigned long>(a) >> N); }

/** \internal \returns \a a shifted by N bits to the left */
template<i32 N> EIGEN_DEVICE_FUNC inline i32
plogical_shift_left(i32k& a) { return a << N; }
template<i32 N> EIGEN_DEVICE_FUNC inline i64
plogical_shift_left(i64k& a) { return a << N; }
...
/** \internal \returns a * 2^((i32)exponent)
  * See https://en.cppreference.com/w/cpp/numeric/math/ldexp
  */
template<typename Packet> EIGEN_DEVICE_FUNC inline Packet
pldexp(const Packet &a, const Packet &exponent) {
  EIGEN_USING_STD(ldexp)
  return static_cast<Packet>(ldexp(a, static_cast<i32>(exponent)));
}
...
template<typename Packet, i32 Alignment>
...
/** \internal copy the packet \a from to \a *to.
  * The pointer \a from must be aligned on a \a Alignment bytes boundary. */
template<typename Scalar, typename Packet, i32 Alignment>
...
/** \internal \returns a packet version of \a *from.
  ...
  */
template<typename Packet, i32 LoadMode>
...
***************************************************************************/
template <typename Packet,i32 N=unpacket_traits<Packet>::size> struct PacketBlock {
  Packet packet[N];
};
...
template <typename Packet, std::enable_if_t<is_scalar<Packet>::value, i32> = 0>
