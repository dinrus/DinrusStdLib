...
template<typename Scalar,i32 OuterStride> class plainobjectbase_evaluator_data {
public:
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
  ...
  : evaluator_base<Derived>
{
  ...
  enum {
    ...
    OuterStrideAtCompileTime = IsVectorAtCompileTime  ? 0
                                                      : i32(IsRowMajor) ? ColsAtCompileTime
                                                                        : RowsAtCompileTime
  };
  ...
  template<i32 StoreMode,typename PacketType>
  EIGEN_STRONG_INLINE
...
template<typename Scalar, i32 Rows, i32 Cols, i32 Options, i32 MaxRows, i32 MaxCols>
  ...
  : evaluator_base<CwiseNullaryOp<NullaryOp,PlainObjectType> >
{
  ...
  template<i32 LoadMode, typename PacketType, typename IndexType>
  EIGEN_STRONG_INLINE
  ...
  : evaluator_base<CwiseUnaryOp<UnaryOp, ArgType> >
{
  ...
  enum {
    CoeffReadCost = i32(evaluator<ArgType>::CoeffReadCost) + i32(functor_traits<UnaryOp>::Cost),
  ...
  : evaluator_base<CwiseTernaryOp<TernaryOp, Arg1, Arg2, Arg3> >
{
  ...
  enum {
    CoeffReadCost = i32(evaluator<Arg1>::CoeffReadCost) + i32(evaluator<Arg2>::CoeffReadCost) + i32(evaluator<Arg3>::CoeffReadCost) + i32(functor_traits<TernaryOp>::Cost),

    Arg1Flags = evaluator<Arg1>::Flags,
    Arg2Flags = evaluator<Arg2>::Flags,
    Arg3Flags = evaluator<Arg3>::Flags,
    SameType = is_same<typename Arg1::Scalar,typename Arg2::Scalar>::value && is_same<typename Arg1::Scalar,typename Arg3::Scalar>::value,
    StorageOrdersAgree = (i32(Arg1Flags)&RowMajorBit)==(i32(Arg2Flags)&RowMajorBit) && (i32(Arg1Flags)&RowMajorBit)==(i32(Arg3Flags)&RowMajorBit),
    Flags0 = (i32(Arg1Flags) | i32(Arg2Flags) | i32(Arg3Flags)) & (
        HereditaryBits
        | (i32(Arg1Flags) & i32(Arg2Flags) & i32(Arg3Flags) &
  ...
  : evaluator_base<CwiseBinaryOp<BinaryOp, Lhs, Rhs> >
{
  ...
  enum {
    CoeffReadCost = i32(evaluator<Lhs>::CoeffReadCost) + i32(evaluator<Rhs>::CoeffReadCost) + i32(functor_traits<BinaryOp>::Cost),

    LhsFlags = evaluator<Lhs>::Flags,
    RhsFlags = evaluator<Rhs>::Flags,
    SameType = is_same<typename Lhs::Scalar,typename Rhs::Scalar>::value,
    StorageOrdersAgree = (i32(LhsFlags)&RowMajorBit)==(i32(RhsFlags)&RowMajorBit),
    Flags0 = (i32(LhsFlags) | i32(RhsFlags)) & (
        HereditaryBits
      | (i32(LhsFlags) & i32(RhsFlags) &
           ( (StorageOrdersAgree ? LinearAccessBit : 0)
...
template<typename PlainObjectType, i32 MapOptions, typename StrideType>
  ...
  : public mapbase_evaluator<Map<PlainObjectType, MapOptions, StrideType>, PlainObjectType>
{
  ...
  enum {
    InnerStrideAtCompileTime = StrideType::InnerStrideAtCompileTime == 0
                             ? i32(PlainObjectType::InnerStrideAtCompileTime)
                             : i32(StrideType::InnerStrideAtCompileTime),
    OuterStrideAtCompileTime = StrideType::OuterStrideAtCompileTime == 0
                             ? i32(PlainObjectType::OuterStrideAtCompileTime)
                             : i32(StrideType::OuterStrideAtCompileTime),
    HasNoInnerStride = InnerStrideAtCompileTime == 1,
    HasNoOuterStride = StrideType::OuterStrideAtCompileTime == 0,
    HasNoStride = HasNoInnerStride && HasNoOuterStride,
    IsDynamicSize = PlainObjectType::SizeAtCompileTime==Dynamic,

    PacketAccessMask = bool(HasNoInnerStride) ? ~i32(0) : ~i32(PacketAccessBit),
    LinearAccessMask = bool(HasNoStride) || bool(PlainObjectType::IsVectorAtCompileTime) ? ~i32(0) : ~i32(LinearAccessBit),
    Flags = i32( evaluator<PlainObjectType>::Flags) & (LinearAccessMask&PacketAccessMask),

    Alignment = i32(MapOptions)&i32(AlignedMask)
  };
...
template<typename PlainObjectType, i32 RefOptions, typename StrideType>
...
template<typename ArgType, i32 BlockRows, i32 BlockCols, bool InnerPanel,
  ...
  : block_evaluator<ArgType, BlockRows, BlockCols, InnerPanel>
{
  ...
  enum {
    ...
    ArgTypeIsRowMajor = (i32(evaluator<ArgType>::Flags)&RowMajorBit) != 0,
    IsRowMajor = (MaxRowsAtCompileTime==1 && MaxColsAtCompileTime!=1) ? 1
               : (MaxColsAtCompileTime==1 && MaxRowsAtCompileTime!=1) ? 0
               : ArgTypeIsRowMajor,
    HasSameStorageOrderAsArgType = (IsRowMajor == ArgTypeIsRowMajor),
    InnerSize = IsRowMajor ? i32(ColsAtCompileTime) : i32(RowsAtCompileTime),
    InnerStrideAtCompileTime = HasSameStorageOrderAsArgType
                             ? i32(inner_stride_at_compile_time<ArgType>::ret)
                             : i32(outer_stride_at_compile_time<ArgType>::ret),
    ...
    Alignment0 = (InnerPanel && (OuterStrideAtCompileTime!=Dynamic)
                             ...
                             && (((OuterStrideAtCompileTime * i32(sizeof(Scalar))) % i32(PacketAlignment)) == 0)) ? i32(PacketAlignment) : 0,
  ...
  : evaluator_base<Block<ArgType, BlockRows, BlockCols, InnerPanel> >
{
  ...
  enum {
    ...
    ForwardLinearAccess = (InnerPanel || i32(XprType::IsRowMajor)==i32(ArgType::IsRowMajor)) && bool(evaluator<ArgType>::Flags&LinearAccessBit)
  };
  ...
  : evaluator_base<Select<ConditionMatrixType, ThenMatrixType, ElseMatrixType> >
{
  ...
  enum {
    ...
    Flags = (u32)evaluator<ThenMatrixType>::Flags & evaluator<ElseMatrixType>::Flags & HereditaryBits,
...
template<typename ArgType, i32 RowFactor, i32 ColFactor>
...
template<typename ArgType, i32 Direction>
  ...
  : evaluator_base<Reverse<ArgType, Direction> >
{
  ...
  enum {
    ...
    LinearAccess = ( (Direction==BothDirections) && (i32(Flags0)&PacketAccessBit) )
                  || ((ReverseRow && XprType::ColsAtCompileTime==1) || (ReverseCol && XprType::RowsAtCompileTime==1))
                 ? LinearAccessBit : 0,

    Flags = i32(Flags0) & (HereditaryBits | PacketAccessBit | LinearAccess),
...
template<typename ArgType, i32 DiagIndex>
  ...
  : evaluator_base<Diagonal<ArgType, DiagIndex> >
{
  ...
  enum {
    ...
    Flags = (u32)(evaluator<ArgType>::Flags & (HereditaryBits | DirectAccessBit) & ~RowMajorBit) | LinearAccessBit,
