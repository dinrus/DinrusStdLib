...
#undef EIGEN_DOC_UNARY_ADDONS
    ...
    template<u32 Mode> struct TriangularViewReturnType { typedef TriangularView<Derived, Mode> Type; };
    template<u32 Mode> struct ConstTriangularViewReturnType { typedef const TriangularView<const Derived, Mode> Type; };
    ...
    template<u32 UpLo> struct SelfAdjointViewReturnType { typedef SelfAdjointView<Derived, UpLo> Type; };
    template<u32 UpLo> struct ConstSelfAdjointViewReturnType { typedef const SelfAdjointView<const Derived, UpLo> Type; };
    ...
    template<i32 p> EIGEN_DEVICE_FUNC RealScalar lpNorm() const;
...
/////////// SVD module ///////////
    ...
    template<i32 Options = 0>
    inline JacobiSVD<PlainObject, Options> jacobiSvd() const;
    template<i32 Options = 0>
    EIGEN_DEPRECATED
    inline JacobiSVD<PlainObject, Options> jacobiSvd(u32 computationOptions) const;

    template<i32 Options = 0>
    inline BDCSVD<PlainObject, Options> bdcSvd() const;
    template<i32 Options = 0>
    EIGEN_DEPRECATED
    inline BDCSVD<PlainObject, Options> bdcSvd(u32 computationOptions) const;
...
#define EIGEN_MATRIX_FUNCTION_1(ReturnType, Name, Description, Argument) \
  ...
  private:
    EIGEN_DEVICE_FUNC explicit MatrixBase(i32);
    EIGEN_DEVICE_FUNC MatrixBase(i32,i32);
