...
template<i32 Side, typename TriangularType, typename Rhs> struct triangular_solve_retval;
...
template<typename Derived> class TriangularBase : public EigenBase<Derived>
{
  public:
    ...
    EIGEN_DEVICE_FUNC
    inline TriangularBase() { eigen_assert(!((i32(Mode) & i32(UnitDiag)) && (i32(Mode) & i32(ZeroDiag)))); }
  ...
  protected:
    ...
    void check_coordinates(Index row, Index col) const
    {
      ...
      i32k mode = i32(Mode) & ~SelfAdjoint;
...
/** \class TriangularView
  ...
  */
namespace internal {
template<typename MatrixType, u32 Mode_>
...
template<typename MatrixType_, u32 Mode_, typename StorageKind> class TriangularViewImpl;

template<typename MatrixType_, u32 Mode_> class TriangularView
  : public TriangularViewImpl<MatrixType_, Mode_, typename internal::traits<MatrixType_>::StorageKind >
{
  ...
  // workaround MSVC ICE
  #if EIGEN_COMP_MSVC
    template<i32 Side, typename Other>
    EIGEN_DEVICE_FUNC
...
/** \ingroup Core_Module
  ...
  */
template<typename MatrixType_, u32 Mode_> class TriangularViewImpl<MatrixType_,Mode_,Dense>
  : public TriangularBase<TriangularView<MatrixType_, Mode_> >
{
  ...
  public:
    ...
    /** "in-place" version of TriangularView::solve() where the result is written in \a other
      ...
      */
    template<i32 Side, typename OtherDerived>
    EIGEN_DEVICE_FUNC
...
template<typename MatrixType, u32 Mode>
template<typename OtherDerived>
...
{
  eigen_assert(Mode == i32(OtherDerived::Mode));
...
template<typename Kernel, u32 Mode, i32 UnrollCount, bool ClearOpposite> struct triangular_assignment_loop;
...
/** \internal Specialization of the dense assignment kernel for triangular matrices.
  ...
  */
template<i32 UpLo, i32 Mode, i32 SetOpposite, typename DstEvaluatorTypeT, typename SrcEvaluatorTypeT, typename Functor, i32 Version = Specialized>
...
template<i32 Mode, bool SetOpposite, typename DstXprType, typename SrcXprType, typename Functor>
...
void call_triangular_assignment_loop(DstXprType& dst, const SrcXprType& src, const Functor &func)
{
  ...
  enum {
      unroll = DstXprType::SizeAtCompileTime != Dynamic
            ...
            && DstXprType::SizeAtCompileTime * (i32(DstEvaluatorType::CoeffReadCost) + i32(SrcEvaluatorType::CoeffReadCost)) / 2 <= EIGEN_UNROLLING_LIMIT
    };

  triangular_assignment_loop<Kernel, Mode, unroll ? i32(DstXprType::SizeAtCompileTime) : Dynamic, SetOpposite>::run(kernel);
}

template<i32 Mode, bool SetOpposite, typename DstXprType, typename SrcXprType>
EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
...
struct Assignment<DstXprType, SrcXprType, Functor, Triangular2Triangular>
{
  ...
  {
    eigen_assert(i32(DstXprType::Mode) == i32(SrcXprType::Mode));
...
struct Assignment<DstXprType, SrcXprType, Functor, Triangular2Dense>
{
  EIGEN_DEVICE_FUNC static void run(DstXprType &dst, const SrcXprType &src, const Functor &func)
  {
    call_triangular_assignment_loop<SrcXprType::Mode, (i32(SrcXprType::Mode) & i32(SelfAdjoint)) == 0>(dst, src, func);
  }
};
...
template<typename Kernel, u32 Mode, i32 UnrollCount, bool SetOpposite>
...
template<typename Kernel, u32 Mode, bool SetOpposite>
...
EIGEN_DEVICE_FUNC void TriangularBase<Derived>::evalToLazy(MatrixBase<DenseDerived> &other) const
{
  ...
  internal::call_triangular_assignment_loop<Derived::Mode, (i32(Derived::Mode) & i32(SelfAdjoint)) == 0 /* SetOpposite */>(other.derived(), derived().nestedExpression());
}
