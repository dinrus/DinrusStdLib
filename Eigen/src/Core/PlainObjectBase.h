...
template<i32 MaxSizeAtCompileTime> struct check_rows_cols_for_overflow {
...
#endif
{
  ...
  public:
    ...
    EIGEN_STATIC_ASSERT(internal::check_implication(MaxRowsAtCompileTime==1 && MaxColsAtCompileTime!=1, (i32(Options)&RowMajor)==RowMajor), INVALID_MATRIX_TEMPLATE_PARAMETERS)
    EIGEN_STATIC_ASSERT(internal::check_implication(MaxColsAtCompileTime==1 && MaxRowsAtCompileTime!=1, (i32(Options)&RowMajor)==0), INVALID_MATRIX_TEMPLATE_PARAMETERS)
...
//       EIGEN_INITIALIZE_COEFFS_IF_THAT_OPTION_IS_ENABLED
  ...
  public:
    ...
    /** \name Map
      ...
      * while the AlignedMap() functions return aligned Map objects and thus should be called only with 16-ubyte-aligned
      * \a data pointers.
      *
  ...
  protected:
    ...
    template<typename T, typename OtherDerived, i32 ColsAtCompileTime>
    EIGEN_DEVICE_FUNC
  ...
  public:
    ...
    // Map symbol.
    template<typename PlainObjectType, i32 MapOptions, typename StrideType> friend class Eigen::Map;
