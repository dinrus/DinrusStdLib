...
{
  enum {
    RowsAtCompileTime = i32(array_size<RowIndices>::value),
    ColsAtCompileTime = i32(array_size<ColIndices>::value),
    ...
    RowIncr = i32(get_compile_time_incr<RowIndices>::value),
    ColIncr = i32(get_compile_time_incr<ColIndices>::value),
    InnerIncr = IsRowMajor ? ColIncr : RowIncr,
    OuterIncr = IsRowMajor ? RowIncr : ColIncr,

    HasSameStorageOrderAsXprType = (IsRowMajor == XprTypeIsRowMajor),
    XprInnerStride = HasSameStorageOrderAsXprType ? i32(inner_stride_at_compile_time<XprType>::ret) : i32(outer_stride_at_compile_time<XprType>::ret),
    XprOuterstride = HasSameStorageOrderAsXprType ? i32(outer_stride_at_compile_time<XprType>::ret) : i32(inner_stride_at_compile_time<XprType>::ret),
    ...
    DirectAccessMask = (i32(InnerIncr)!=UndefinedIncr && i32(OuterIncr)!=UndefinedIncr && InnerIncr>=0 && OuterIncr>=0) ? DirectAccessBit : 0,
