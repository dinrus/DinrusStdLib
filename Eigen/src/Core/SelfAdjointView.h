...
template<typename MatrixType_, u32 UpLo> class SelfAdjointView
  : public TriangularBase<SelfAdjointView<MatrixType_, UpLo> >
{
  public:
    ...
    enum {
      ...
      TransposeMode = ((i32(Mode) & i32(Upper)) ? Lower : 0) | ((i32(Mode) & i32(Lower)) ? Upper : 0)
    };
...
// template<typename OtherDerived, typename MatrixType, u32 UpLo>
...
template<i32 UpLo, i32 SetOpposite, typename DstEvaluatorTypeT, typename SrcEvaluatorTypeT, typename Functor, i32 Version>
