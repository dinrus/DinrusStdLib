...
template<typename Scalar, typename Index, i32 StorageOrder, i32 UpLo, bool ConjugateLhs, bool ConjugateRhs, i32 Version=Specialized>
struct selfadjoint_matrix_vector_product;

template<typename Scalar, typename Index, i32 StorageOrder, i32 UpLo, bool ConjugateLhs, bool ConjugateRhs, i32 Version>
struct selfadjoint_matrix_vector_product
...
template<typename Lhs, i32 LhsMode, typename Rhs>
struct selfadjoint_product_impl<Lhs,LhsMode,false,Rhs,0,true>
{
  ...
  void run(Dest& dest, const Lhs &a_lhs, const Rhs &a_rhs, const Scalar& alpha)
  {
    ...
    internal::selfadjoint_matrix_vector_product<Scalar, Index, (internal::traits<ActualLhsTypeCleaned>::Flags&RowMajorBit) ? RowMajor : ColMajor,
                                                i32(LhsUpLo), bool(LhsBlasTraits::NeedToConjugate), bool(RhsBlasTraits::NeedToConjugate)>::run
      (
        lhs.rows(),                             // size
...
template<typename Lhs, typename Rhs, i32 RhsMode>
struct selfadjoint_product_impl<Lhs,0,true,Rhs,RhsMode,false>
{
  ...
  static void run(Dest& dest, const Lhs &a_lhs, const Rhs &a_rhs, const Scalar& alpha)
  {
    ...
    selfadjoint_product_impl<Transpose<const Rhs>, i32(RhsUpLo)==Upper ? Lower : Upper, false,
