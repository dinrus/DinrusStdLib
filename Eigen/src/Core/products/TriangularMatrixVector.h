...
template<typename Index, i32 Mode, typename LhsScalar, bool ConjLhs, typename RhsScalar, bool ConjRhs, i32 StorageOrder, i32 Version=Specialized>
struct triangular_matrix_vector_product;

template<typename Index, i32 Mode, typename LhsScalar, bool ConjLhs, typename RhsScalar, bool ConjRhs, i32 Version>
...
template<i32 Mode,i32 StorageOrder>
...
template<i32 Mode, typename Lhs, typename Rhs>
struct triangular_product_impl<Mode,true,Lhs,false,Rhs,true>
{
  template<typename Dest> static void run(Dest& dst, const Lhs &lhs, const Rhs &rhs, const typename Dest::Scalar& alpha)
  {
    ...
    internal::trmv_selector<Mode,(i32(internal::traits<Lhs>::Flags)&RowMajorBit) ? RowMajor : ColMajor>::run(lhs, rhs, dst, alpha);
  }
};
...
struct triangular_product_impl<Mode,false,Lhs,true,Rhs,false>
{
  template<typename Dest> static void run(Dest& dst, const Lhs &lhs, const Rhs &rhs, const typename Dest::Scalar& alpha)
  {
    ...
    internal::trmv_selector<(Mode & (UnitDiag|ZeroDiag)) | ((Mode & Lower) ? Upper : Lower),
                            (i32(internal::traits<Rhs>::Flags)&RowMajorBit) ? ColMajor : RowMajor>
...
template<i32 Mode> struct trmv_selector<Mode,ColMajor>
{
...
template<i32 Mode> struct trmv_selector<Mode,RowMajor>
{
  template<typename Lhs, typename Rhs, typename Dest>
  static void run(const Lhs &lhs, const Rhs &rhs, Dest& dest, const typename Dest::Scalar& alpha)
  {
