  ...
  GemmParallelInfo<Index>* info = 0)
{
  ...
  if(info)
  {
    ...
    i32 threads = omp_get_num_threads();
    ...
    for(Index k=0; k<depth; k+=kc)
    {
      ...
      for(i32 shift=0; shift<threads; ++shift)
      {
        i32 i = (tid+shift)%threads;
...
template<i32 StorageOrder, typename LhsScalar, typename RhsScalar, i32 MaxRows, i32 MaxCols, i32 MaxDepth, i32 KcFactor=1,
...
template<i32 StorageOrder, typename LhsScalar_, typename RhsScalar_, i32 MaxRows, i32 MaxCols, i32 MaxDepth, i32 KcFactor>
