...
template<typename LhsScalar_, typename RhsScalar_, bool ConjLhs_=false, bool ConjRhs_=false, i32 Arch=Architecture::Target, i32 PacketSize_=GEBPPacketFull>
class gebp_traits;
...
struct CacheSizes {
  CacheSizes(): m_l1(-1),m_l2(-1),m_l3(-1) {
    i32 l1CacheSize, l2CacheSize, l3CacheSize;
...
inline void manage_caching_sizes(Action action, std::ptrdiff_t* l1, std::ptrdiff_t* l2, std::ptrdiff_t* l3)
{
  ...
  if(action==SetAction)
  {
    // set the cpu cache size and cache all block sizes from a global cache size in ubyte
...
template<typename LhsScalar, typename RhsScalar, i32 KcFactor, typename Index>
...
template <typename RhsPacket, typename RhsPacketx4, i32 registers_taken>
struct RhsPanelHelper {
 private:
  static constexpr i32 remaining_registers = (std::max)(i32(EIGEN_ARCH_DEFAULT_NUMBER_OF_REGISTERS) - registers_taken, 0);
 public:
...
template <i32 N, typename T1, typename T2, typename T3>
 ...
 */
template<typename LhsScalar_, typename RhsScalar_, bool ConjLhs_, bool ConjRhs_, i32 Arch, i32 PacketSize_>
class gebp_traits
{
public:
...
template<typename RealScalar, bool ConjLhs_, i32 Arch, i32 PacketSize_>
...
template<typename RealScalar, bool ConjLhs_, bool ConjRhs_, i32 Arch, i32 PacketSize_>
...
template<typename RealScalar, bool ConjRhs_, i32 Arch, i32 PacketSize_>
 ...
 */
template<typename LhsScalar, typename RhsScalar, typename Index, typename DataMapper, i32 mr, i32 nr, bool ConjugateLhs, bool ConjugateRhs>
struct gebp_kernel
{
...
template<typename LhsScalar, typename RhsScalar, typename Index, typename DataMapper, i32 mr, i32 nr, bool ConjugateLhs, bool ConjugateRhs,
i32 SwappedLhsProgress = gebp_traits<RhsScalar,LhsScalar,ConjugateRhs,ConjugateLhs,Architecture::Target>::LhsProgress>
...
template<i32 nr, Index LhsProgress, Index RhsProgress, typename LhsScalar, typename RhsScalar, typename ResScalar, typename AccPacket, typename LhsPacket, typename RhsPacket, typename ResPacket, typename GEBPTraits, typename LinearMapper, typename DataMapper>
struct lhs_process_one_packet
{
  ...
  EIGEN_STRONG_INLINE void operator()(
    ...
    i32 prefetch_res_offset, Index peeled_kc, Index pk, Index cols, Index depth, Index packet_cols4)
  {
    GEBPTraits traits;
...
void gebp_kernel<LhsScalar,RhsScalar,Index,DataMapper,mr,nr,ConjugateLhs,ConjugateRhs>
               ...
               Index strideA, Index strideB, Index offsetA, Index offsetB)
  {
    ...
    i32k prefetch_res_offset = 32/sizeof(ResScalar);    
...
#define EIGEN_GEBGP_ONESTEP(K)                                                    \
            ...
            blB += i32(pk) * i32(RhsProgress);
            blA += i32(pk) * 3 * i32(Traits::LhsProgress);
...
#define EIGEN_GEBGP_ONESTEP(K) \
            ...
            blB += i32(pk) * i32(RhsProgress);
            blA += i32(pk) * 2 * i32(Traits::LhsProgress);
    ...
    if(peeled_mc_quarter<rows)
    {
      ...
      for(Index j2=packet_cols8; j2<packet_cols4; j2+=4)
      {
        ...
        for(Index i=peeled_mc_quarter; i<rows; i+=1)
        {
          ...
          i32k SResPacketHalfSize = unpacket_traits<typename unpacket_traits<SResPacket>::half>::size;
          i32k SResPacketQuarterSize = unpacket_traits<typename unpacket_traits<typename unpacket_traits<SResPacket>::half>::half>::size;
...
//  32 33 34 35 ...
//  36 36 38 39 ...
template<typename Scalar, typename Index, typename DataMapper, i32 Pack1, i32 Pack2, typename Packet, bool Conjugate, bool PanelMode>
  ...
  ::operator()(Scalar* blockA, const DataMapper& lhs, Index depth, Index rows, Index stride, Index offset)
{
  ...
  enum { PacketSize = unpacket_traits<Packet>::size,
         ...
         HasHalf = (i32)HalfPacketSize < (i32)PacketSize,
         HasQuarter = (i32)QuarterPacketSize < (i32)HalfPacketSize};
...
//  .  .  .  .    .  .  .  .    .  .
template<typename Scalar, typename Index, typename DataMapper, i32 nr, bool Conjugate, bool PanelMode>
