...
// template<typename Scalar, i32 mr, i32 StorageOrder, bool Conjugate, i32 Mode>
// struct gemm_pack_lhs_triangular
// {
//   Matrix<Scalar,mr,mr,
//   void operator()(Scalar* blockA, const EIGEN_RESTRICT Scalar* lhs_, i32 lhsStride, i32 depth, i32 rows)
//   {
//     conj_if<NumTraits<Scalar>::IsComplex && Conjugate> cj;
//     const_blas_data_mapper<Scalar, StorageOrder> lhs(lhs_,lhsStride);
//     i32 count = 0;
//     i32k peeled_mc = (rows/mr)*mr;
//     for(i32 i=0; i<peeled_mc; i+=mr)
//     {
//       for(i32 k=0; k<depth; k++)
//         for(i32 w=0; w<mr; w++)
//           blockA[count++] = cj(lhs(i+w, k));
//     }
//     for(i32 i=peeled_mc; i<rows; i++)
//     {
//       for(i32 k=0; k<depth; k++)
...
template <typename Scalar, typename Index,
          i32 Mode, bool LhsIsTriangular,
          i32 LhsStorageOrder, bool ConjugateLhs,
          i32 RhsStorageOrder, bool ConjugateRhs,
          i32 ResStorageOrder, i32 ResInnerStride,
          i32 Version = Specialized>
...
template <typename Scalar, typename Index,
          ...
          i32 LhsStorageOrder, bool ConjugateLhs,
          i32 RhsStorageOrder, bool ConjugateRhs,
          i32 ResInnerStride, i32 Version>
...
template <typename Scalar, typename Index, i32 Mode,
          i32 LhsStorageOrder, bool ConjugateLhs,
          i32 RhsStorageOrder, bool ConjugateRhs,
          i32 ResInnerStride, i32 Version>
...
namespace internal {
template<i32 Mode, bool LhsIsTriangular, typename Lhs, typename Rhs>
