...
template<typename LhsScalar, typename RhsScalar, i32 PacketSize_=GEMVPacketFull>
class gemv_traits
{
...
public:
  enum {
        ...
        i32(unpacket_traits<LhsPacket_>::size)==i32(unpacket_traits<RhsPacket_>::size),
 ...
 */
template<typename Index, typename LhsScalar, typename LhsMapper, bool ConjugateLhs, typename RhsScalar, typename RhsMapper, bool ConjugateRhs, i32 Version>
  ...
  RhsScalar alpha)
{
  ...
  enum { LhsAlignment = Unaligned,
         ...
         HasHalf = (i32)ResPacketSizeHalf < (i32)ResPacketSize,
         HasQuarter = (i32)ResPacketSizeQuarter < (i32)ResPacketSizeHalf
  };
