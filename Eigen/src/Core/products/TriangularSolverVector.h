...
template<typename LhsScalar, typename RhsScalar, typename Index, i32 Mode, bool Conjugate, i32 StorageOrder>
...
template<typename LhsScalar, typename RhsScalar, typename Index, i32 Mode, bool Conjugate>
