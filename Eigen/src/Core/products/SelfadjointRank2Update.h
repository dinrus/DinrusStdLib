...
template<typename Scalar, typename Index, typename UType, typename VType, i32 UpLo>
...
::rankUpdate(const MatrixBase<DerivedU>& u, const MatrixBase<DerivedV>& v, const Scalar& alpha)
{
  ...
  typedef internal::remove_all_t<typename internal::conj_expr_if<i32(IsRowMajor) ^ i32(UBlasTraits::NeedToConjugate), ActualUType_>::type> UType;
  typedef internal::remove_all_t<typename internal::conj_expr_if<i32(IsRowMajor) ^ i32(VBlasTraits::NeedToConjugate), ActualVType_>::type> VType;
  internal::selfadjoint_rank2_update_selector<Scalar, Index, UType, VType,
    (IsRowMajor ? i32(UpLo==Upper ? Lower : Upper) : UpLo)>
