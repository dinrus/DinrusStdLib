...
template<typename Scalar, typename Index, i32 UpLo, bool ConjLhs, bool ConjRhs>
...
template<typename MatrixType, typename OtherType, i32 UpLo, bool OtherIsVector = OtherType::IsVectorAtCompileTime>
struct selfadjoint_product_selector;

template<typename MatrixType, typename OtherType, i32 UpLo>
