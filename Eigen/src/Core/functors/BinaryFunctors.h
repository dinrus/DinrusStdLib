...
struct functor_traits<scalar_sum_op<LhsScalar,RhsScalar> > {
  enum {
    Cost = (i32(NumTraits<LhsScalar>::AddCost) + i32(NumTraits<RhsScalar>::AddCost)) / 2, // rough estimate!
...
struct functor_traits<scalar_product_op<LhsScalar,RhsScalar> > {
  enum {
    Cost = (i32(NumTraits<LhsScalar>::MulCost) + i32(NumTraits<RhsScalar>::MulCost))/2, // rough estimate!
...
/** \internal
  ...
  */
template<typename LhsScalar,typename RhsScalar, i32 NaNPropagation>
...
struct functor_traits<scalar_difference_op<LhsScalar,RhsScalar> > {
  enum {
    Cost = (i32(NumTraits<LhsScalar>::AddCost) + i32(NumTraits<RhsScalar>::AddCost)) / 2,
