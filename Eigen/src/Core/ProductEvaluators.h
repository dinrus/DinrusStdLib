...
/** \internal
  ...
  */
template<typename Lhs, typename Rhs, i32 Options>
...
template<typename Lhs, typename Rhs, i32 DiagIndex>
...
template< typename Lhs, typename Rhs,
          ...
          i32 ProductType = internal::product_type<Lhs,Rhs>::value>
...
template<typename Lhs, typename Rhs, i32 Options, i32 ProductTag, typename LhsShape, typename RhsShape>
...
// Dense = Product
template< typename DstXprType, typename Lhs, typename Rhs, i32 Options, typename Scalar>
...
{
  template<typename T> struct is_row_major : std::conditional_t<(i32(T::Flags)&RowMajorBit), internal::true_type, internal::false_type> {};
  ...
  : generic_product_impl_base<Lhs,Rhs,generic_product_impl<Lhs,Rhs,DenseShape,DenseShape,GemvProduct> >
{
  ...
  typedef internal::remove_all_t<std::conditional_t<i32(Side)==OnTheRight,LhsNested,RhsNested>> MatrixType;
  ...
  static EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE void scaleAndAddTo(Dest& dst, const Lhs& lhs, const Rhs& rhs, const Scalar& alpha)
  {
    ...
    internal::gemv_dense_selector<Side,
                            (i32(MatrixType::Flags)&RowMajorBit) ? RowMajor : ColMajor,
...
template<i32 Traversal, i32 UnrollingIndex, typename Lhs, typename Rhs, typename RetScalar>
struct etor_product_coeff_impl;

template<i32 StorageOrder, i32 UnrollingIndex, typename Lhs, typename Rhs, typename Packet, i32 LoadMode>
struct etor_product_packet_impl;

template<typename Lhs, typename Rhs, i32 ProductTag>
    ...
    : evaluator_base<Product<Lhs, Rhs, LazyProduct> >
{
  ...
  enum {
    ...
    CoeffReadCost = InnerSize==0 ? NumTraits<Scalar>::ReadCost
                  : InnerSize == Dynamic ? HugeCost
                    : InnerSize * (NumTraits<Scalar>::MulCost + i32(LhsCoeffReadCost) + i32(RhsCoeffReadCost))
    ...
    LhsAlignment = plain_enum_min(LhsEtorType::Alignment, LhsVecPacketSize*i32(sizeof(typename LhsNestedCleaned::Scalar))),
    RhsAlignment = plain_enum_min(RhsEtorType::Alignment, RhsVecPacketSize*i32(sizeof(typename RhsNestedCleaned::Scalar))),
    ...
    Flags = ((i32(LhsFlags) | i32(RhsFlags)) & HereditaryBits & ~RowMajorBit)
          | (EvalToRowMajor ? RowMajorBit : 0)
          // TODO enable vectorization for mixed types
          | (SameType && (CanVectorizeLhs || CanVectorizeRhs) ? PacketAccessBit : 0)
          | (XprType::IsVectorAtCompileTime ? LinearAccessBit : 0),

    LhsOuterStrideBytes = i32(LhsNestedCleaned::OuterStrideAtCompileTime) * i32(sizeof(typename LhsNestedCleaned::Scalar)),
    RhsOuterStrideBytes = i32(RhsNestedCleaned::OuterStrideAtCompileTime) * i32(sizeof(typename RhsNestedCleaned::Scalar)),

    Alignment = bool(CanVectorizeLhs) ? (LhsOuterStrideBytes<=0 || (i32(LhsOuterStrideBytes) % plain_enum_max(1, LhsAlignment))!=0 ? 0 : LhsAlignment)
              : bool(CanVectorizeRhs) ? (RhsOuterStrideBytes<=0 || (i32(RhsOuterStrideBytes) % plain_enum_max(1, RhsAlignment))!=0 ? 0 : RhsAlignment)
              : 0,
    ...
    CanVectorizeInner =    SameType
                        && LhsRowMajor
                        && (!RhsRowMajor)
                        && (i32(LhsFlags) & i32(RhsFlags) & ActualPacketAccessBit)
                        && (i32(InnerSize) % packet_traits<Scalar>::size == 0)
  };
  ...
  template<i32 LoadMode, typename PacketType>
  EIGEN_DEVICE_FUNC EIGEN_STRONG_INLINE
  const PacketType packet(Index row, Index col) const
  {
    PacketType res;
    typedef etor_product_packet_impl<bool(i32(Flags)&RowMajorBit) ? RowMajor : ColMajor,
                                     Unroll ? i32(InnerSize) : Dynamic,
...
template<i32 UnrollingIndex, typename Lhs, typename Rhs, typename Packet, i32 LoadMode>
...
template<typename Lhs, typename Rhs, typename Packet, i32 LoadMode>
...
* Triangular products
***************************************************************************/
template<i32 Mode, bool LhsIsTriangular,
...
***************************************************************************/
template <typename Lhs, i32 LhsMode, bool LhsIsVector,
          typename Rhs, i32 RhsMode, bool RhsIsVector>
...
template<typename MatrixType, typename DiagonalType, typename Derived, i32 ProductOrder>
...
public:
  enum {
    CoeffReadCost = i32(NumTraits<Scalar>::MulCost) + i32(evaluator<MatrixType>::CoeffReadCost) + i32(evaluator<DiagonalType>::CoeffReadCost),
    ...
    ScalarAccessOnDiag_ =  !((i32(StorageOrder_) == ColMajor && i32(ProductOrder) == OnTheLeft)
                           ||(i32(StorageOrder_) == RowMajor && i32(ProductOrder) == OnTheRight)),
    SameTypes_ = is_same<typename MatrixType::Scalar, typename DiagonalType::Scalar>::value,
    // FIXME currently we need same types, but in the future the next rule should be the one
    //Vectorizable_ = bool(i32(MatrixFlags)&PacketAccessBit) && ((!_PacketOnDiag) || (SameTypes_ && bool(i32(DiagFlags)&PacketAccessBit))),
    Vectorizable_ =   bool(i32(MatrixFlags)&PacketAccessBit)
                  &&  SameTypes_
                  && (SameStorageOrder_ || (MatrixFlags&LinearAccessBit)==LinearAccessBit)
                  && (ScalarAccessOnDiag_ || (bool(i32(DiagFlags)&PacketAccessBit))),
    LinearAccessMask_ = (MatrixType::RowsAtCompileTime==1 || MatrixType::ColsAtCompileTime==1) ? LinearAccessBit : 0,
    Flags = ((HereditaryBits|LinearAccessMask_) & (u32)(MatrixFlags)) | (Vectorizable_ ? PacketAccessBit : 0),
...
protected:
  ...
  EIGEN_STRONG_INLINE PacketType packet_impl(Index row, Index col, Index id, internal::false_type) const
  {
    enum {
      ...
      DiagonalPacketLoadMode = plain_enum_min(LoadMode,((InnerSize%16) == 0) ? i32(Aligned16) : i32(evaluator<DiagonalType>::Alignment)) // FIXME hardcoded 16!!
    };
    return internal::pmul(m_matImpl.template packet<LoadMode,PacketType>(row, col),
...
// diagonal * dense
template<typename Lhs, typename Rhs, i32 ProductKind, i32 ProductTag>
  ...
  : diagonal_product_evaluator_base<Rhs, typename Lhs::DiagonalVectorType, Product<Lhs, Rhs, LazyProduct>, OnTheLeft>
{
  ...
  EIGEN_STRONG_INLINE PacketType packet(Index row, Index col) const
  {
    ...
    return this->template packet_impl<LoadMode,PacketType>(row,col, row,
                                 std::conditional_t<i32(StorageOrder)==RowMajor, internal::true_type, internal::false_type>());
  }

  template<i32 LoadMode,typename PacketType>
  EIGEN_STRONG_INLINE PacketType packet(Index idx) const
  {
    return packet<LoadMode,PacketType>(i32(StorageOrder)==ColMajor?idx:0,i32(StorageOrder)==ColMajor?0:idx);
  }
#endif
};
  ...
  : diagonal_product_evaluator_base<Lhs, typename Rhs::DiagonalVectorType, Product<Lhs, Rhs, LazyProduct>, OnTheRight>
{
  ...
  EIGEN_STRONG_INLINE PacketType packet(Index row, Index col) const
  {
    return this->template packet_impl<LoadMode,PacketType>(row,col, col,
                                 std::conditional_t<i32(StorageOrder)==ColMajor, internal::true_type, internal::false_type>());
  }
...
/** \internal
  ...
  */
template<typename ExpressionType, i32 Side, bool Transposed, typename ExpressionShape>
struct permutation_matrix_product;

template<typename ExpressionType, i32 Side, bool Transposed>
...
template<typename Lhs, typename Rhs, i32 ProductTag, typename MatrixShape>
