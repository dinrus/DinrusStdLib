...
template<typename Visitor, typename Derived, i32 UnrollCount, bool Vectorize=((Derived::PacketAccess!=0) && functor_traits<Visitor>::PacketAccess)>
struct visitor_impl;

template<typename Visitor, typename Derived, i32 UnrollCount>
...
template<typename Visitor, typename Derived, i32 UnrollSize>
...
void DenseBase<Derived>::visit(Visitor& visitor) const
{
  ...
  enum {
    unroll =  SizeAtCompileTime != Dynamic
           && SizeAtCompileTime * i32(ThisEvaluator::CoeffReadCost) + (SizeAtCompileTime-1) * i32(internal::functor_traits<Visitor>::Cost) <= EIGEN_UNROLLING_LIMIT
  };
  return internal::visitor_impl<Visitor, ThisEvaluator, unroll ? i32(SizeAtCompileTime) : Dynamic>::run(thisEval, visitor);
}
...
template<typename Scalar, i32 NaNPropagation, bool is_min=true>
...
template<typename Scalar, i32 NaNPropagation>
...
template <typename Derived, bool is_min, i32 NaNPropagation>
...
template<typename Scalar, bool is_min, i32 NaNPropagation>
