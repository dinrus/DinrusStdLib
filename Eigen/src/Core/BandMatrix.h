...
class BandMatrixBase : public EigenBase<Derived>
{
  ...
  public:
    ...
    {
      EIGEN_STATIC_ASSERT((i32(Options) & i32(RowMajor)) == 0, THIS_METHOD_IS_ONLY_FOR_COLUMN_MAJOR_MATRICES);
      Index start = 0;
    ...
    template<i32 Index> struct DiagonalIntReturnType {
      enum {
        ReturnOpposite = (i32(Options) & i32(SelfAdjoint)) && (((Index) > 0 && Supers == 0) || ((Index) < 0 && Subs == 0)),
    ...
    template<i32 N> inline typename DiagonalIntReturnType<N>::Type diagonal()
    {
      return typename DiagonalIntReturnType<N>::BuildType(coeffs(), supers()-N, (std::max)(0,N), 1, diagonalLength(N));
    }

    /** \returns a vector expression of the \a N -th sub or super diagonal */
    template<i32 N> inline const typename DiagonalIntReturnType<N>::Type diagonal() const
    {
      return typename DiagonalIntReturnType<N>::BuildType(coeffs(), supers()-N, (std::max)(0,N), 1, diagonalLength(N));
    }
...
/**
  ...
  *
  * \tparam Scalar_ Numeric type, i.e. float, double, i32
...
template<typename Scalar_, i32 Rows_, i32 Cols_, i32 Supers_, i32 Subs_, i32 Options_>
struct traits<BandMatrix<Scalar_,Rows_,Cols_,Supers_,Subs_,Options_> >
{
  ...
  typedef Matrix<Scalar, DataRowsAtCompileTime, ColsAtCompileTime, i32(Options) & i32(RowMajor) ? RowMajor : ColMajor> CoefficientsType;
};

template<typename Scalar_, i32 Rows, i32 Cols, i32 Supers, i32 Subs, i32 Options>
...
template<typename CoefficientsType_,i32 Rows_, i32 Cols_, i32 Supers_, i32 Subs_,i32 Options_>
...
/**
  ...
  *
  * \tparam Scalar Numeric type, i.e. float, double, i32
  * \tparam Size Number of rows and cols, or \b Dynamic
  * \tparam Options Can be 0 or \b SelfAdjoint
  *
  * \sa class BandMatrix
  */
template<typename Scalar, i32 Size, i32 Options>
