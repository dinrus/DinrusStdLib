...
namespace internal {
template<typename XprType, i32 BlockRows, i32 BlockCols, bool InnerPanel>
struct traits<Block<XprType, BlockRows, BlockCols, InnerPanel> > : traits<XprType>
{
  ...
  enum{
    ...
    MaxRowsAtCompileTime = BlockRows==0 ? 0
                         : RowsAtCompileTime != Dynamic ? i32(RowsAtCompileTime)
                         : i32(traits<XprType>::MaxRowsAtCompileTime),
    MaxColsAtCompileTime = BlockCols==0 ? 0
                         : ColsAtCompileTime != Dynamic ? i32(ColsAtCompileTime)
                         : i32(traits<XprType>::MaxColsAtCompileTime),

    XprTypeIsRowMajor = (i32(traits<XprType>::Flags)&RowMajorBit) != 0,
    ...
    InnerStrideAtCompileTime = HasSameStorageOrderAsXprType
                             ...
                             : i32(outer_stride_at_compile_time<XprType>::ret),
...
template<typename XprType, i32 BlockRows=Dynamic, i32 BlockCols=Dynamic, bool InnerPanel = false,
         bool HasDirectAccess = internal::has_direct_access<XprType>::ret> class BlockImpl_dense;

} // end namespace internal

template<typename XprType, i32 BlockRows, i32 BlockCols, bool InnerPanel, typename StorageKind> class BlockImpl;
...
/** \class Block
  ...
  * type of DenseBase::block(Index,Index,Index,Index) and DenseBase::block<i32,i32>(Index,Index) and
  ...
  */
template<typename XprType, i32 BlockRows, i32 BlockCols, bool InnerPanel> class Block
...
template<typename XprType, i32 BlockRows, i32 BlockCols, bool InnerPanel, bool HasDirectAccess> class BlockImpl_dense
