...
template<typename Lhs, typename Rhs, i32 Option, typename StorageKind> class ProductImpl;

namespace internal {

template<typename Lhs, typename Rhs, i32 Option>
...
/** \class Product
  ...
  *
  */
template<typename Lhs_, typename Rhs_, i32 Option>
...
template<typename Lhs, typename Rhs, i32 Option, i32 ProductTag = internal::product_type<Lhs,Rhs>::ret>
...
template<typename Lhs, typename Rhs, i32 Option, typename StorageKind>
