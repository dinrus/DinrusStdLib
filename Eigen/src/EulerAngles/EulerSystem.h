...
namespace Eigen
{
  ...
  namespace internal
  {
    ...
    template <i32 Num, bool IsPositive = (Num > 0)>
    struct Abs
    {
      enum { value = Num };
    };
  ...
  /** \class EulerSystem
    ...
    */
  template <i32 _AlphaAxis, i32 _BetaAxis, i32 _GammaAxis>
  class EulerSystem
  {
    public:
    ...
    static constexpr i32 AlphaAxis = _AlphaAxis;
    
    /** The second rotation axis */
    static constexpr i32 BetaAxis = _BetaAxis;
    
    /** The third rotation axis */
    static constexpr i32 GammaAxis = _GammaAxis;
