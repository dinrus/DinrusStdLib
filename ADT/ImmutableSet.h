...
#include <drx/ADT/FoldingSet.h>
#include <drx/ADT/IntrusiveRefCntPtr.h>
...
private:
  ...
  static u32 computeDigest(ImutAVLTree *L, ImutAVLTree *R,
                                value_type_ref V) {
    u32 digest = 0;
  ...
  u32 computeDigest() {
    ...
    u32 X = computeDigest(getLeft(), getRight(), getValue());
    digest = X;
    markedCachedDigest();
    return X;
  }
