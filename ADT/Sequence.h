...
/// `seq` supports both integral (e.g., `i32`, `char`, `u32`) and enum
...
///
/// ```
/// for (i32 x : seq_inclusive(0, 3))
///   outs() << x << " ";
/// ```
///
/// Prints: `0 1 2 3 `.
///
/// Подобно `seq` and `seq_inclusive`, the `enum_seq` and
...
#include <drx/llvm/Support/MathExtras.h> // AddOverflow / SubOverflow
