...
#include <drx/llvm/Support/raw_ostream.h>
...
public:
  ...
  FixedPointSemantics(unsigned Width, unsigned Scale, bool IsSigned,
      ...
      : FixedPointSemantics(Width, Lsb{-static_cast<i32>(Scale)}, IsSigned,
  ...
  bool isValidLegacySema() const {
    return LsbWeight <= 0 && static_cast<i32>(Width) >= -LsbWeight;
  }
  unsigned getWidth() const { return Width; }
  unsigned getScale() const { assert(isValidLegacySema()); return -LsbWeight; }
  i32 getLsbWeight() const { return LsbWeight; }
  i32 getMsbWeight() const {
...
private:
  ...
  signed i32 LsbWeight    : LsbWeightBitWidth;
  unsigned IsSigned       : 1;
...
inline hash_code hash_value(const FixedPointSemantics &Val) {
  return hash_value(bit_cast<u32>(Val));
}
...
public:
  ...
  APFixedPoint(u64 Val, const FixedPointSemantics &Sema)
  ...
  i32 getLsbWeight() const { return Sema.getLsbWeight(); }
  i32 getMsbWeight() const { return Sema.getMsbWeight(); }
  ...
  i32 compare(const APFixedPoint &Other) const;
