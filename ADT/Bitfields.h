...
/// behavior when it comes to вне диапазона values.
...
/// layout/storage as well as protection against вне диапазона values.
///
/// Usage example
/// -------------
/// \code{.cpp}
...
///  enum class SuitEnum : u8 { CLUBS, DIAMONDS, HEARTS, SPADES };
...
///  using SignedValue = Bitfield::Element<i32, 3, 5>;
...
template <> struct ResolveUnderlyingType<bool, false> {
  ...
  /// std::conditional.
  using type = std::conditional_t<sizeof(bool) == 1, u8, void>;
};
