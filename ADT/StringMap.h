...
#include <drx/ADT/StringMapEntry.h>
#include <drx/ADT/iterator.h>
#include <drx/llvm/Support/AllocatorBase.h>
...
protected:
  ...
  i32 FindKey(StringRef Key) const;
...
public:
  ...
  DerivedTy operator++(i32) { // Post-increment
    DerivedTy Tmp(Ptr);
    ++*this;
    return Tmp;
  }
