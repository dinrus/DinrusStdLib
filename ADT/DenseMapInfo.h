...
template <> struct DenseMapInfo<u8> {
  static inline u8 getEmptyKey() { return ~0; }
  static inline u8 getTombstoneKey() { return ~0 - 1; }
  static unsigned getHashValue(u8k &Val) { return Val * 37U; }

  static bool isEqual(u8k &LHS, u8k &RHS) {
    return LHS == RHS;
  }
};

// Provide DenseMapInfo for u16s.
template <> struct DenseMapInfo<u16> {
  static inline u16 getEmptyKey() { return 0xFFFF; }
  static inline u16 getTombstoneKey() { return 0xFFFF - 1; }
  static unsigned getHashValue(u16k &Val) { return Val * 37U; }

  static bool isEqual(u16k &LHS, u16k &RHS) {
    return LHS == RHS;
  }
};
...
template<> struct DenseMapInfo<unsigned long> {
  ...
  static unsigned getHashValue(u64k& Val) {
    return (unsigned)(Val * 37UL);
  }

  static bool isEqual(u64k& LHS, u64k& RHS) {
    return LHS == RHS;
  }
};

// Provide DenseMapInfo for unsigned long longs.
template<> struct DenseMapInfo<unsigned z64> {
  static inline unsigned z64 getEmptyKey() { return ~0ULL; }
  static inline unsigned z64 getTombstoneKey() { return ~0ULL - 1ULL; }

  static unsigned getHashValue(zu64k& Val) {
    return (unsigned)(Val * 37ULL);
  }

  static bool isEqual(zu64k& LHS,
                      zu64k& RHS) {
    return LHS == RHS;
  }
};
...
template<> struct DenseMapInfo<i32> {
  static inline i32 getEmptyKey() { return 0x7fffffff; }
  static inline i32 getTombstoneKey() { return -0x7fffffff - 1; }
  static unsigned getHashValue(i32k& Val) { return (unsigned)(Val * 37U); }

  static bool isEqual(i32k& LHS, i32k& RHS) {
    return LHS == RHS;
  }
};
...
template<> struct DenseMapInfo<z64> {
  static inline z64 getEmptyKey() { return 0x7fffffffffffffffLL; }
  static inline z64 getTombstoneKey() { return -0x7fffffffffffffffLL-1; }

  static unsigned getHashValue(z64k& Val) {
    return (unsigned)(Val * 37ULL);
  }

  static bool isEqual(z64k& LHS,
                      z64k& RHS) {
    return LHS == RHS;
  }
};
