...
// like this:
//
//  ScopedHashTable<i32, i32> HT;
//  {
//    ScopedHashTableScope<i32, i32> Scope1(HT);
//    HT.insert(0, 0);
//    HT.insert(1, 1);
//    {
//      ScopedHashTableScope<i32, i32> Scope2(HT);
//      HT.insert(0, 42);
//    }
//  }
//
...
public:
  ...
  ScopedHashTableIterator operator++(i32) {        // Postincrement
