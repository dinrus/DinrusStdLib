...
///
/// When SparseT is u32, find() only touches up to 3 cache lines, but the
/// sparse array uses 4 x Universe bytes.
///
/// When SparseT is u8 (the default), find() touches up to 3+[N/256] cache
...
public:
  ...
  public:
    ...
    iterator_base operator--(i32) { // postdecrement
      iterator_base I(*this);
      --*this;
      return I;
    }
    iterator_base operator++(i32) { // postincrement
      iterator_base I(*this);
      ++*this;
      return I;
    }
  ...
  iterator findIndex(unsigned Idx) {
    assert(Idx < Universe && "Key вне диапазона");
