...
#include <drx/llvm/Support/AlignOf.h>
...
public:
  ...
  bool isPointerIntoBucketsArray(ukk Ptr) const {
  ...
  ukk getPointerIntoBucketsArray() const { return getBuckets(); }
...
protected:
  ...
  void copyFrom(
    ...
    if (std::is_trivially_copyable<KeyT>::value &&
      ...
      memcpy(reinterpret_cast<uk >(getBuckets()), other.getBuckets(),
...
public:
  ...
  DenseMapIterator operator++(i32) {  // Postincrement
    assert(isHandleInSync() && "invalid iterator access!");
