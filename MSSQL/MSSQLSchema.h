#define BIT(x)                    COLUMN("bit", i32, x, 0, 0)
#define BIT_ARRAY(x, items)       COLUMN_ARRAY("bit", i32, x, 0, 0, items)
#define BIT_(x)                   COLUMN_("bit", i32, x, 0, 0)
#define BIT_ARRAY_(x, items)      COLUMN_ARRAY_("bit", i32, x, 0, 0, items)
...
#define TXT(x, n)               COLUMN(MsSqlTextType(n), Txt, x, n, 0)
#define TXT_ARRAY(x, n, items)  COLUMN_ARRAY(MsSqlTextType(n), Txt, x, n, 0, items)
#define TXT_(x, n)              COLUMN_(MsSqlTextType(n), Txt, x, n, 0)
#define TXT_ARRAY_(x, n, items) COLUMN_ARRAY_(MsSqlTextType(n), Txt, x, n, 0, items)

#define LONGRAW(x)                 COLUMN("varbinary(max)", Txt, x, 0, 0)
#define LONGRAW_(x)                COLUMN_("varbinary(max)", Txt, x, 0, 0)

#define BLOB(x)                    COLUMN("varbinary(max)", Txt, x, 0, 0)
#define BLOB_(x)                   COLUMN_("varbinary(max)", Txt, x, 0, 0)
