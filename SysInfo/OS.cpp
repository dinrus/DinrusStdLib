...
bool GetOsInfo(Txt &kernel, Txt &kerVersion, Txt &kerArchitecture, Txt &distro,
               Txt &distVersion, Txt &desktop, Txt &deskVersion)
{
    ...
    case PROCESSOR_ARCHITECTURE_AMD64:  kerArchitecture = "64 бита";            break;
    case PROCESSOR_ARCHITECTURE_IA64:   kerArchitecture = "Itanium 64 бита";    break;
    case PROCESSOR_ARCHITECTURE_INTEL:  kerArchitecture = "32 бита";            break;
    default:                            kerArchitecture = "Неизвестна";
    }
    ...
    kerVersion = Format("%d.%d", static_cast<i32>(osvi.dwMajorVersion), static_cast<i32>(osvi.dwMinorVersion));
    kernel = "Windows";

    
    
    if (VER_TARGET_WIN32_NT == osvi.dwPlatformId && osvi.dwMajorVersion > 4) {
        if (osvi.dwMajorVersion >= 10 && osvi.dwMinorVersion >22000){  kernel.Cat(" 11"); }
            ...
            if (pGPI(osvi.dwMajorVersion, osvi.dwMinorVersion, 0, 0, &dwType)) {
                ...
                case PRODUCT_DATACENTER_EVALUATION_SERVER:  distro = "Server Datacenter (пробная установка)"; break;
                case PRODUCT_DATACENTER_SERVER:         distro = "Server Datacenter (полная установка)"; break;
                case PRODUCT_DATACENTER_SERVER_CORE:    distro = "Server Datacenter (установка ядра)"; break;
                case PRODUCT_DATACENTER_SERVER_CORE_V:  distro = "Server Datacenter without Hyper-V (установка ядра)"; break;
                case PRODUCT_DATACENTER_SERVER_V:       distro = "Server Datacenter without Hyper-V (полная установка)"; break;
                case PRODUCT_ENTERPRISE:                distro = "Enterprise"; break;
                case PRODUCT_ENTERPRISE_E:              distro = "Не поддерживается"; break;
                case PRODUCT_ENTERPRISE_N_EVALUATION:   distro = "Enterprise N (пробная установка)"; break;
                case PRODUCT_ENTERPRISE_N:              distro = "Enterprise N"; break;
                case PRODUCT_ENTERPRISE_EVALUATION:     distro = "Server Enterprise (пробная установка)"; break;
                case PRODUCT_ENTERPRISE_SERVER:         distro = "Server Enterprise (полная установка)"; break;
                case PRODUCT_ENTERPRISE_SERVER_CORE:    distro = "Server Enterprise (установка ядра)"; break;
                case PRODUCT_ENTERPRISE_SERVER_CORE_V:  distro = "Server Enterprise without Hyper-V (установка ядра)"; break;
                case PRODUCT_ENTERPRISE_SERVER_IA64:    distro = "Server Enterprise for Itanium-based Systems"; break;
                case PRODUCT_ENTERPRISE_SERVER_V:       distro = "Server Enterprise without Hyper-V (полная установка)"; break;
                ...
                case PRODUCT_HOME_BASIC_E:              distro = "Не поддерживается"; break;
                case PRODUCT_HOME_BASIC_N:              distro = "Home Basic N"; break;
                case PRODUCT_HOME_PREMIUM:              distro = "Home Premium"; break;
                case PRODUCT_HOME_PREMIUM_E:            distro = "Не поддерживается"; break;
                ...
                case PRODUCT_MULTIPOINT_STANDARD_SERVER:        distro = "Windows MultiPoint Server Standard (полная установка)"; break;
                case PRODUCT_MULTIPOINT_PREMIUM_SERVER: distro = "Windows MultiPoint Server Premium (полная установка)"; break;
                case PRODUCT_PROFESSIONAL:              distro = "Professional"; break;
                case PRODUCT_PROFESSIONAL_E:            distro = "Не поддерживается"; break;
                ...
                case PRODUCT_SMALLBUSINESS_SERVER_PREMIUM_CORE: distro = "Small Business Server Premium (установка ядра)"; break;
                case PRODUCT_SOLUTION_EMBEDDEDSERVER:           distro = "Windows MultiPoint Server"; break;
                case PRODUCT_STANDARD_EVALUATION_SERVER:        distro = "Server Standard (пробная установка)"; break;
                case PRODUCT_STANDARD_SERVER:           distro = "Server Standard"; break;
                case PRODUCT_STANDARD_SERVER_CORE:      distro = "Server Standard (установка ядра)"; break;
                case PRODUCT_STANDARD_SERVER_V:         distro = "Server Standard without Hyper-V"; break;
                case PRODUCT_STANDARD_SERVER_CORE_V:    distro = "Server Standard without Hyper-V (установка ядра)"; break;
                case PRODUCT_STANDARD_SERVER_SOLUTIONS: distro = "Server Solutions Premium"; break;
                case PRODUCT_STANDARD_SERVER_SOLUTIONS_CORE:    distro = "Server Solutions Premium (установка ядра)"; break;
                case PRODUCT_STARTER:                   distro = "Starter"; break;
                case PRODUCT_STARTER_E:                 distro = "Не поддерживается"; break;
                ...
                case PRODUCT_STORAGE_ENTERPRISE_SERVER_CORE:        distro = "Storage Server Enterprise (установка ядра)"; break;
                case PRODUCT_STORAGE_EXPRESS_SERVER:                distro = "Storage Server Express"; break;
                case PRODUCT_STORAGE_EXPRESS_SERVER_CORE:           distro = "Storage Server Express (установка ядра)"; break;
                case PRODUCT_STORAGE_STANDARD_EVALUATION_SERVER:    distro = "Storage Server Standard (пробная установка)"; break;
                case PRODUCT_STORAGE_STANDARD_SERVER:               distro = "Storage Server Standard"; break;
                case PRODUCT_STORAGE_STANDARD_SERVER_CORE:          distro = "Storage Server Standard (установка ядра)"; break;
                case PRODUCT_STORAGE_WORKGROUP_EVALUATION_SERVER:   distro = "Storage Server Workgroup (пробная установка)"; break;
                case PRODUCT_STORAGE_WORKGROUP_SERVER:              distro = "Storage Server Workgroup"; break;
                case PRODUCT_STORAGE_WORKGROUP_SERVER_CORE:         distro = "Storage Server Workgroup (установка ядра)"; break;
                case PRODUCT_UNDEFINED:         distro = "Неизвестный продукт"; break;
                case PRODUCT_ULTIMATE:          distro = "Ultimate"; break;
                case PRODUCT_ULTIMATE_E:        distro = "Не поддерживается"; break;
                case PRODUCT_ULTIMATE_N:        distro = "Ultimate N"; break;
                case PRODUCT_WEB_SERVER:        distro = "Web Server (полная установка)"; break;
                case PRODUCT_WEB_SERVER_CORE:   distro = "Web Server (установка ядра)"; break;
                }
            }
        ...
        kerVersion.Cat(Format(" (Build %d)", static_cast<i32>(osvi.dwBuildNumber)));
...
static bool GetOsInfoCheckRelease(Txt &distro, Txt &distVersion) {
    TxtParse release;
...
bool GetOsInfo(Txt &kernel, Txt &kerVersion, Txt &kerArchitecture, Txt &distro, Txt &distVersion, Txt &desktop, Txt &deskVersion)
{
    ...
    if (0 == uname(&buf)) {
        kernel = buf.sysname;
        kerVersion = Txt(buf.release) + " " + Txt(buf.version);
    ...
    if (GetEnv("GNOME_DESKTOP_SESSION_ID").GetCount() || GetEnv("GNOME_KEYRING_SOCKET").GetCount()) {
        desktop = "gnome";
        TxtParse gnomeVersion = Sys("gnome-about --version");
        ...
        desktop = "kde";
        TxtParse konsole = Sys("konsole --version");
        konsole.GoAfter("KDE", ":");
        ...
        desktop = "mate";
        TxtParse mateVersion = Sys("mate-about --version");
        while (true) {
            Txt str = mateVersion.GetText();
            if (atof(str) > 0) {
                deskVersion = str;
                break;
            } else if (str.IsEmpty())
        ...
        Txt str = GetEnv("CINNAMON_VERSION");
        if (!str.IsEmpty()) {
            desktop = "cinnamon";
            deskVersion = str;
        } else {
            TxtParse desktopStr = ToLower(Sys("xprop -root"));
            if (desktopStr.Find("lxde") >= 0 || ToLower(GetEnv("DESKTOP_SESSION")) == "lxde") {
                ...
                TxtParse xfceVersion = Sys(Format("%s-about --version", desktop));
                while (true) {
                    Txt str = xfceVersion.GetText();
                    if (atof(str) > 0) {
                        deskVersion = str;
                        break;
                    } else if (str.IsEmpty())
    ...
    if (GetOsInfoCheckRelease(distro, distVersion))
        ...
        distro = "fedora";
        TxtParse strFile = LoadFile_Safe("/etc/fedora-release");
        ...
        TxtParse strFile = LoadFile_Safe("/etc/SuSE-release");
        ...
        distro = "slackware";
        TxtParse strFile = LoadFile_Safe("/etc/slackware-version");
        strFile.GetText();
        distVersion = strFile.GetText();
